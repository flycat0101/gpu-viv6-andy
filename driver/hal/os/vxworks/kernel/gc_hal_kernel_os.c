    ...
    )
{
    ...
    mmuMdl = (PVX_MDL)mmu->pageTablePhysical;
#endif
    ...
    )
{
    ...
    do
    {
        semaphore = semBCreate(SEM_Q_FIFO, 1);
    ...
    )
{
    ...
    do
    {
        thread = taskSpawn("Vivante", 102,
                         8,0x20000, (FUNCPTR)ThreadFunction, ThreadParameter, 0, 0, 0, 0, 0, 0, 0, 0, 0);
        if (IS_ERR(thread))
        {
