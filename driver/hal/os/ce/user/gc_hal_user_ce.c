    ...
    )
{
    ...
    {
        CacheRangeFlush(bitmap.dsBm.bmBits,
            bitmap.dsBm.bmWidthBytes * bitmap.dsBm.bmHeight,
            CACHE_SYNC_DISCARD | CACHE_SYNC_L2_WRITEBACK | CACHE_SYNC_L2_DISCARD);
    }
#endif
                     ...
                     )
{
    ...
    return gcoOS_LoadLibrary(gcvNULL, MSTR(LIBEGL), Handle);
}
