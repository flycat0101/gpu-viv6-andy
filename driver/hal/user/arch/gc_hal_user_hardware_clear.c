    ...
    )
{
 ...
 14:14))) );    gcmENDSTATEBATCH_NEW(reserve, memory);
};
 ...
 17:16) - (0 ? 17:16) + 1) == 32) ? ~0 : (~(~0 << ((1 ? 17:16) - (0 ? 17:16) + 1))))))) << (0 ?
 17:16))) );    gcmENDSTATEBATCH_NEW(reserve, memory);
};
