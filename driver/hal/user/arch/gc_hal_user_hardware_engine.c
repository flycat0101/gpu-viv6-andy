...
)
{
    ...
    static const gctUINT32 extModuleXlate[] =
    {
        /* NN MODULE */
        0x0,
        /* TP MODULE */
    ...
    static const gctUINT32 numExtModuleXlate[] =
    {
        /* NN MODULE */
        EXT_MODULE_NEURAL_NET_COUNTER_NUM,
        /* TP MODULE */
        EXT_MODULE_TENSOR_PROCESSOR_COUNTER_NUM,
    };
    ...
    gcmASSERT(Hardware->features[gcvFEATURE_PROBE] || Hardware->features[gcvFEATURE_TP_NN_PROBE]);
 ...
 ~0U : (~(~0U << ((1 ? 15:0) - (0 ? 15:0) + 1))))))) << (0 ? 15:0))); );
    gcmENDSTATEBATCH_NEW(reserve, memory);
        ...
        /* Extend modules: NN and TP. */
        if (gcoHAL_IsFeatureAvailable(gcvNULL, gcvFEATURE_TP_NN_PROBE))
        {
            address += MODULE_PROBE_NUMBER * (gctUINT32)(1 << clusterIDWidth) * gcmSIZEOF(gctUINT32);
            for (module = 0; module < gcvEXTCOUNTER_COUNT; module++)
            {
                offset = 0;
                for (j = 0; j < module; j++)
                {
                    offset += numExtModuleXlate[j];
                }

                for (j = 0; j < numExtModuleXlate[module]; j++)
                {
                    gctUINT32 tempAddrs;
                    switch (Cmd)
                    {
 ...
 15:0) + 1) == 32) ?
 ~0U : (~(~0U << ((1 ? 15:0) - (0 ? 15:0) + 1))))))) << (0 ? 15:0)));};
    gcmSETCTRLSTATE_NEW(stateDelta, reserve, memory, 0x0E55, ((((gctUINT32) (0)) & ~(((gctUINT32) (((gctUINT32) ((((1 ?
 25:24) - (0 ?
 25:24) + 1) == 32) ?
 ~0U : (~(~0U << ((1 ?
 25:24) - (0 ?
 ...
 19:16) - (0 ?
 19:16) + 1))))))) << (0 ?
 19:16))) | (((gctUINT32) ((gctUINT32) (extModuleXlate[module]) & ((gctUINT32) ((((1 ?
 19:16) - (0 ?
 19:16) + 1) == 32) ?
 ~0U : (~(~0U << ((1 ?
 19:16) - (0 ?
 ...
 ~0U : (~(~0U << ((1 ? 15:0) - (0 ? 15:0) + 1))))))) << (0 ? 15:0))); );
    gcmENDSTATEBATCH_NEW(reserve, memory);
                    ...
                    case gcvPROBECMD_END:
                        /* pass address to store counter */
                        tempAddrs = address + (j + offset) * (gctUINT32)(1 << clusterIDWidth) * 4 * gcmSIZEOF(gctUINT32);
                        gcmASSERT((address & 0xf) == 0);
...
)
{
 ...
 27:27) - (0 ?
 27:27) + 1))))))) << (0 ?
 27:27))) | (((gctUINT32) ((gctUINT32) (1) & ((gctUINT32) ((((1 ?
 27:27) - (0 ?
 27:27) + 1) == 32) ?
 ~0U : (~(~0U << ((1 ? 27:27) - (0 ? 27:27) + 1))))))) << (0 ? 27:27))) |
                ((((gctUINT32) (0)) & ~(((gctUINT32) (((gctUINT32) ((((1 ?
 ...
 28:28) - (0 ?
 28:28) + 1))))))) << (0 ?
 28:28))) | (((gctUINT32) ((gctUINT32) (1) & ((gctUINT32) ((((1 ?
 28:28) - (0 ?
 28:28) + 1) == 32) ?
