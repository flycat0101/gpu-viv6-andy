...
define PINFO
PINFO DESCRIPTION="OpenVX12 kernel libraries"
endef

NAME=libOvx12VXCBinary
...
EXTRA_INCVPATH += $(driver_root)/driver/khronos/libOpenVX/libkernel/libovx12/$(GPU_CONFIG)
endif

# from libCL (trunk/driver/khronos/libCL/makefile.linux)
# Core
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libOpenVX/libkernel/libovx12/ovx12_vxc_binary_interface.o

EXTRA_SRCVPATH += $(driver_root)/driver/khronos/libOpenVX/libkernel/libovx12
