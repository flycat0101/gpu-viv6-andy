...
define PINFO
PINFO DESCRIPTION="Vivante HAL arch vg kernel"
endef
...
# from libhalarchkernel (trunk/hal/kernel/archvg/Makefile.linux)


EXTRA_INCVPATH += $(driver_root)/hal/kernel/archvg
EXTRA_INCVPATH += $(driver_root)/hal/kernel/archvg/inc
EXTRA_INCVPATH += $(driver_root)/arch/GC350/cmodel/inc

SOURCE_OBJECTS += $(driver_root)/hal/kernel/archvg/gc_hal_kernel_hardware_command_vg.o
SOURCE_OBJECTS += $(driver_root)/hal/kernel/archvg/gc_hal_kernel_hardware_vg.o

EXTRA_SRCVPATH += $(driver_root)/hal/kernel/archvg
