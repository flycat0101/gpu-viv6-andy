...
define PINFO
PINFO DESCRIPTION="Vivante HAL os user"
endef
...
# from libhalosuser (trunk/hal/os/qnx/user/Makefile.linux)
SOURCE_OBJECTS += $(driver_root)/hal/os/qnx/user/gc_hal_user_debug.o
SOURCE_OBJECTS += $(driver_root)/hal/os/qnx/user/gc_hal_user_math.o
SOURCE_OBJECTS += $(driver_root)/hal/os/qnx/user/gc_hal_user_os.o
