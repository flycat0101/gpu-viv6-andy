...
3) The options
   ...
   To enable/disable an option, set <OPTION>=<value> in the command line.
    ...
    VIVANTE_ENABLE_3D        1        Enable driver support for 3D core; default value;
                             0        Disable driver support for 3D core;

    VIVANTE_ENABLE_2D        1        Enable driver support for 2D core; default value;
                             0        Disable driver support for 2D core;

    VIVANTE_ENABLE_VG        1        Enable driver support for 2D VG core;
                                      galcore.ko, libGAL.so, and libEGL.so have
                                      2D VG support; and build 2D VG driver only;
                                      don't build 3D VG driver.
                             0        Excluded 2D VG HAL/EGL support; default value;
