@REM #########################################################################
@REM #
@REM #  Copyright (c) 2005 - 2015 by Vivante Corp.  All rights reserved.
@REM #
...
echo copy gc_hal_eglplatform.h ...
copy /y %AQROOT%\hal\inc\gc_hal_eglplatform.h %VIVANTE_SDK_DIR%\inc\HAL\
echo copy gc_hal_eglplatform_type.h ...
copy /y %AQROOT%\hal\inc\gc_hal_eglplatform_type.h %VIVANTE_SDK_DIR%\inc\HAL\
...
copy /y %AQROOT%\sdk\inc\gc_vdk_hal.h %VIVANTE_SDK_DIR%\inc\gc_vdk_hal.h
