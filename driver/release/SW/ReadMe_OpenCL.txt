...
====================
  ...
  1) Make sure you have installed Vivante standard GAL driver package;
     ...
     tar xzf VIVANTE_GAL_Unified_Src_drv_<version>.tgz -C <PROJECTS_DIR>

  3) Install Vivante OpenCL driver add-on: VIVANTE_GAL_Unified_Src_drv_OCL-addon_<version>.tgz.

     cd <PROJECTS_DIR>
     tar zxvf VIVANTE_GAL_Unified_Src_drv_OCL-addon_<version>.tgz
