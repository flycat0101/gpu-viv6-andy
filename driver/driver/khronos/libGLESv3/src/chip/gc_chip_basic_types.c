    ...
    )
{
    ...
    gcmONERROR(gcChipUtilConvertGLEnum(_BooleanNames,
    ...
    )
{
    ...
    gcChipUtilGetFromBoolArray(&Variable, 1, Value, Type);
    gcmFOOTER_NO();
}
...
{
    gcmHEADER_ARG("Variable=%d Value=0x%x Type=0x%04x", Variable, Value, Type);
    gcChipUtilGetFromIntArray(&Variable, 1, Value, Type);
    gcmFOOTER_NO();
}
...
{
    gcmHEADER_ARG("Variable=%d Value=0x%x Type=0x%04x", Variable, Value, Type);
    gcChipUtilGetFromFixedArray(&Variable, 1, Value, Type);
    gcmFOOTER_NO();
}
    ...
    )
{
    ...
    gcChipUtilGetFromFloatArray(&Variable, 1, Value, Type);
    gcmFOOTER_NO();
}
    ...
    )
{
    ...
    gcChipUtilGetFromEnumArray(&Variable, 1, Value, Type);
    gcmFOOTER_NO();
}
    ...
    )
{
    ...
    gcChipUtilGetFromMutableArray(&Variable, VariableType, 1, Value, Type);
    gcmFOOTER_NO();
}
    ...
    )
{
    ...
    for (i = 0; i < Count; i++)
    {
        ...
        {
        case glvINT:
            gcChipUtilGetFromInt(Variables[i].i, value, Type);
            break;

        case glvFIXED:
            gcChipUtilGetFromFixed(Variables[i].x, value, Type);
            break;

        case glvFLOAT:
            gcChipUtilGetFromFloat(Variables[i].f, value, Type);
            break;
    ...
    )
{
    gcmHEADER_ARG("Variable=0x%x Value=0x%x Type=0x%04x",
                    Variable, Value, Type);
    gcChipUtilGetFromMutantArray(Variable, 1, Value, Type);
    gcmFOOTER_NO();
}
    ...
    )
{
    GLboolean result;
    gcmHEADER_ARG("Variable=0x%x Type=0x%04x", Variable, Type);
    gcChipUtilGetFromMutable(Variable, Type, &result, glvBOOL);
    ...
    )
{
    GLint result;
    gcmHEADER_ARG("Variable=0x%x Type=0x%04x", Variable, Type);
    gcChipUtilGetFromMutable(Variable, Type, &result, glvINT);
    gcmFOOTER_ARG("return=%d", result);
    return result;
}
    ...
    )
{
    GLfixed result;
    gcmHEADER_ARG("Variable=0x%x Type=0x%04x", Variable, Type);
    gcChipUtilGetFromMutable(Variable, Type, &result, glvFIXED);
    ...
    )
{
    GLfloat result;
    gcmHEADER_ARG("Variable=0x%x Type=0x%04x", Variable, Type);
    gcChipUtilGetFromMutable(Variable, Type, &result, glvFLOAT);
    gcmFOOTER_ARG("return=%f", result);
    return result;
}
    ...
    )
{
    GLboolean result;
    gcmHEADER_ARG("Variable=0x%x", Variable);
    gcChipUtilGetFromMutant(Variable, &result, glvBOOL);
    gcmFOOTER_ARG("return=%d", result);
    return result;
}
    ...
    )
{
    GLint result;
    gcmHEADER_ARG("Variable=0x%x", Variable);
    gcChipUtilGetFromMutant(Variable, &result, glvINT);
    gcmFOOTER_ARG("return=%d", result);
    return result;
}
    ...
    )
{
    GLfixed result;
    gcmHEADER_ARG("Variable=0x%x", Variable);
    gcChipUtilGetFromMutant(Variable, &result, glvFIXED);
    gcmFOOTER_ARG("return=0x%08x", result);
    return result;
}
    ...
    )
{
    GLfloat result;
    gcmHEADER_ARG("Variable=0x%x", Variable);
    gcChipUtilGetFromMutant(Variable, &result, glvFLOAT);
    gcmFOOTER_ARG("return=%f", result);
    return result;
}
...
void
gcChipUtilCosFloat(
    const gltFRACTYPE Var,
    gltFRACTYPE * Result)
{
   /* Convert to randians. */
   GLfloat radians = Var * glvFLOATPIOVER180;
    ...
    case glvFIXED:
        {
            ...
            /* Compute cos. */
            GLfixed cosine = gcChipUtilCosX(radians);

            /* Set the value. */
            gcChipUtilSetFixedMutant(Result, cosine);
        }
        break;
    ...
    case glvFLOAT:
        {
            ...
            /* Set the value. */
            gcChipUtilSetFloatMutant(Result, cosine);
        }
        break;
    ...
    case glvFIXED:
        {
            ...
            /* Set the value. */
            gcChipUtilSetFixedVector4(Result, x, y, z, w);
        }
        break;
    ...
    case glvFLOAT:
        {
            ...
            /* Set the value. */
            gcChipUtilSetFloatVector4(Result, x, y, z, w);
        }
        break;
    ...
    )
{
    ...
    gcChipUtilGetFromMatrix(Matrix, values, glvFLOAT);
    ...
    )
{
    ...
    gcChipUtilGetFromVector3(Vector, values, glvFLOAT);
    ...
    )
{
    ...
    gcChipUtilGetFromVector4(Vector, values, glvFLOAT);
    ...
    )
{
    ...
    gcChipUtilGetFromMutant(Mutant, &value, glvFLOAT);
