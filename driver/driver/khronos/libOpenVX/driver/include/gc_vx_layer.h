...
enum vxnne_kernel_e
{
    ...
    VXNNE_KERNEL_TENSOR_COPY = 14,
    VXNNE_KERNEL_TENSOR_RESHUFFLE = 15,
    VXNNE_KERNEL_TENSOR_TRANSPOSE = 16,
    VXNNE_KERNEL_RPN_SOFTMAX = 17,
    VXNNE_KERNEL_RPN_REGRESSION = 18,
    VXNNE_KERNEL_RPN_NMS = 19,
    VXNNE_KERNEL_TENSOR_CONVFORMAT = 20,
    VXNNE_KERNEL_ACTIVATION_SOFTRELU = 21,
    VXNNE_KERNEL_RPN_RETRIEVE = 22,
    VXNNE_KERNEL_RPN_SORT = 23,
    VXNNE_KERNEL_TENSOR2ROW = 24,
    VXNNE_KERNEL_GEMM = 25,
    VXNNE_KERNEL_L2NORM_SUMSQRT = 26,
    VXNNE_KERNEL_L2NORM_SUMSCALE = 27,
    VXNNE_KERNEL_L2NORM = 26,
    VXNNE_KERNEL_TENSOR_LSTMLAYER = 29,
    VXNNE_KERNEL_TENSOR_LSTMUNIT = 30,
    VXNNE_KERNEL_AVGPOOLING_INT16 = 31,
    VXNNE_KERNEL_AVGPOOLING_UINT8 = 32,
    VXNNE_KERNEL_ACTIVATION_UINT8 = 33,
    VXNNE_KERNEL_TF_AVGPOOLING = 34,
    VXNNE_KERNEL_ROIPOOL = 35,
    VXNNE_KERNEL_L2POOLING = 36,
    VXNNE_KERNEL_DEPTH2SPACE = 37,
    VXNNE_KERNEL_RNN = 38,
    VXNNE_KERNEL_TENSOR_SCALE = 39,
    VXNNE_KERNEL_ROIRECT2ROILIST = 40,
    VXNNE_KERNEL_SVDF = 41,
    VXNNE_KERNEL_FLOOR = 42,
    VXNNE_KERNEL_DEPTHWISE_CONV = 43,
    VXNNE_KERNEL_TENSOR_REVERSE = 44,
    VXNNE_KERNEL_TENSOR_LSTMUNIT_PROJECTION = 45,
    VXNNE_KERNEL_TENSOR_LSTMUNIT_HIDDENOUT = 46,
    VXNNE_KERNEL_TENSOR_PAD = 47,
    VXNNE_KERNEL_EMBEDDINGLUT = 48,
    VXNNE_KERNEL_HASHLUT = 49,
    VXNNE_KERNEL_TENSOR_ADD = 50,
    VXNNE_KERNEL_TENSOR_MUL = 51,
