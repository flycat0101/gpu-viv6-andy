...
typedef struct _vx_address_param_s
{
    vx_uint8_ptr   logical;
    vx_int32     physical;
}
vx_address_param_s, *vx_address_param;
...
typedef struct _vx_weight_bias_compress_param_s
{
    ...
    vx_address_param_s                       ori_address;
...
typedef vx_status (*vx_weight_bias_free_compressed_f)(vx_weights_biases_parameter wb);
...
typedef struct _vx_weights_biases_parameter_s
{
    ...
    vx_weight_bias_free_compressed_f         free_compressed;
...
#define WB_MEMORY_ORG_LOGICAL(wb)             ((wb)->compress_param.ori_address.logical)
#define WB_MEMORY_ORG_PHYSICAL(wb)            ((wb)->compress_param.ori_address.physical)
