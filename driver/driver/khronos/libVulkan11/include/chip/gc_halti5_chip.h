...
enum
{
    ...
    HALTI5_BLIT_3D_UNORM_FLOAT_HWDOUBLEROUNDING,
...
enum halti_patch_type
{
    ...
    HALTI5_PATCH_BUF_EXCEED_MAX_WIDTH    = 11,
};
...
enum
{
    ...
    HALTI5_PATCH_BUF_EXCEED_MAX_WIDTH_BIT     = 1 << HALTI5_PATCH_BUF_EXCEED_MAX_WIDTH,
