...
static VkResult androidGetDeviceGroupSurfacePresentModesKHR(
    VkDevice device,
    VkSurfaceKHR surface,
...
static VkResult androidGetPhysicalDevicePresentRectanglesKHR(
    VkPhysicalDevice physicalDevice,
    VkSurfaceKHR surface,
    uint32_t* pRectCount,
    VkRect2D* pRects
    ...
    )
{
    ...
    do
    {
        ...
        surf->supportedUsageFlags       = VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT | VK_IMAGE_USAGE_SAMPLED_BIT;
...
__vkSurfaceOperation __vkAndroidSurfaceOperation =
{
    ...
    androidGetDeviceGroupSurfacePresentModesKHR,
    androidGetPhysicalDevicePresentRectanglesKHR,
