...
VkResult VKAPI_CALL __vk_GetDeviceGroupSurfacePresentModesKHR(
    VkDevice device,
    VkSurfaceKHR surface,
...
{
    __vkSurfaceOperation *operation = __GetSurfaceOperation(surface);
    return operation->GetDeviceGroupSurfacePresentModesKHR(device, surface, pModes);
}

VkResult VKAPI_CALL __vk_GetPhysicalDevicePresentRectanglesKHR(
    VkPhysicalDevice physicalDevice,
    VkSurfaceKHR surface,
    uint32_t* pRectCount,
    VkRect2D* pRects
...
{
    __vkSurfaceOperation *operation = __GetSurfaceOperation(surface);
    return operation->GetPhysicalDevicePresentRectanglesKHR(physicalDevice, surface, pRectCount, pRects);
}
