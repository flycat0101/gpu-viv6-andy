...
static VkResult win32GetDeviceGroupSurfacePresentModesKHR(
    VkDevice device,
    VkSurfaceKHR surface,
...
static VkResult win32GetPhysicalDevicePresentRectanglesKHR(
    VkPhysicalDevice physicalDevice,
    VkSurfaceKHR surface,
    uint32_t* pRectCount,
    VkRect2D* pRects
...
__vkSurfaceOperation __vkWin32SurfaceOperation =
{
    ...
    win32GetDeviceGroupSurfacePresentModesKHR,
    win32GetPhysicalDevicePresentRectanglesKHR,
...
static VkResult win32CreateDisplayMode(
    VkPhysicalDevice physicalDevice,
