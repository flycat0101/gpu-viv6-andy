...
static VkResult dpyGetDeviceGroupSurfacePresentModesKHR(
    VkDevice                                    device,
    VkSurfaceKHR                                surface,
    VkDeviceGroupPresentModeFlagsKHR*           pModes)
{
    ...
    if (dpy->GetDeviceGroupSurfacePresentModesKHR)
    {
        return dpy->GetDeviceGroupSurfacePresentModesKHR(device, surface, pModes);
    }

    return VK_ERROR_INCOMPATIBLE_DISPLAY_KHR;
}

static VkResult dpyGetPhysicalDevicePresentRectanglesKHR(
    VkPhysicalDevice                            physicalDevice,
    VkSurfaceKHR                                surface,
    uint32_t*                                   pRectCount,
    VkRect2D*                                   pRects)
{
    ...
    if (dpy->GetPhysicalDevicePresentRectanglesKHR)
    {
        return dpy->GetPhysicalDevicePresentRectanglesKHR(physicalDevice, surface, pRectCount, pRects);
    }
...
__vkSurfaceOperation __vkDisplaySurfaceOperation =
{
    ...
    dpyGetDeviceGroupSurfacePresentModesKHR,
    dpyGetPhysicalDevicePresentRectanglesKHR,
    dpyCreateSwapchain,
};
