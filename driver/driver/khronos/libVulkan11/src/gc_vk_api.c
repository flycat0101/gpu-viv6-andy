...
VKAPI_ATTR void VKAPI_CALL vkCmdWaitEvents(VkCommandBuffer commandBuffer, uint32_t eventCount, const VkEvent* pEvents, VkPipelineStageFlags srcStageMask, VkPipelineStageFlags destStageMask, uint32_t memoryBarrierCount, const VkMemoryBarrier* pMemoryBarriers, uint32_t bufferMemoryBarrierCount, const VkBufferMemoryBarrier* pBufferMemoryBarriers, uint32_t imageMemoryBarrierCount, const VkImageMemoryBarrier* pImageMemoryBarriers)
{
...
VKAPI_ATTR void VKAPI_CALL vkCmdPipelineBarrier(VkCommandBuffer commandBuffer, VkPipelineStageFlags srcStageMask, VkPipelineStageFlags destStageMask, VkDependencyFlags dependencyFlags, uint32_t memoryBarrierCount, const VkMemoryBarrier* pMemoryBarriers, uint32_t bufferMemoryBarrierCount, const VkBufferMemoryBarrier* pBufferMemoryBarriers, uint32_t imageMemoryBarrierCount, const VkImageMemoryBarrier* pImageMemoryBarriers)
{
...
VKAPI_ATTR VkResult VKAPI_CALL vkEnumerateInstanceVersion(uint32_t* pApiVersion)
{
    ...
    return __vkApiDispatchTable.EnumerateInstanceVersion(pApiVersion);
}

VKAPI_ATTR VkResult VKAPI_CALL vkBindBufferMemory2(VkDevice device, uint32_t bindInfoCount, const VkBindBufferMemoryInfo* pBindInfos)
{
    return __vkApiDispatchTable.BindBufferMemory2(device, bindInfoCount, pBindInfos);
}
...
{
    return __vkApiDispatchTable.BindImageMemory2(device, bindInfoCount, pBindInfos);
}
...
{
    __vkApiDispatchTable.GetDeviceGroupPeerMemoryFeatures(device, heapIndex, localDeviceIndex, remoteDeviceIndex, pPeerMemoryFeatures);
}
...
{
    __vkApiDispatchTable.CmdSetDeviceMask(commandBuffer, deviceMask);
}
...
{
    __vkApiDispatchTable.CmdDispatchBase(commandBuffer, baseGroupX, baseGroupY, baseGroupZ, groupCountX, groupCountY, groupCountZ);
}
...
{
    return __vkApiDispatchTable.EnumeratePhysicalDeviceGroups(instance, pPhysicalDeviceGroupCount, pPhysicalDeviceGroupProperties);
}
...
{
    __vkApiDispatchTable.GetImageMemoryRequirements2(device, pInfo, pMemoryRequirements);
}
...
{
    __vkApiDispatchTable.GetBufferMemoryRequirements2(device, pInfo, pMemoryRequirements);
}
...
{
    __vkApiDispatchTable.GetImageSparseMemoryRequirements2(device, pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
}
...
{
    __vkApiDispatchTable.GetPhysicalDeviceFeatures2(physicalDevice, pFeatures);
}
...
{
    __vkApiDispatchTable.GetPhysicalDeviceProperties2(physicalDevice, pProperties);
}
...
{
    __vkApiDispatchTable.GetPhysicalDeviceFormatProperties2(physicalDevice, format, pFormatProperties);
}
...
{
    return __vkApiDispatchTable.GetPhysicalDeviceImageFormatProperties2(physicalDevice, pImageFormatInfo, pImageFormatProperties);
}
...
{
    __vkApiDispatchTable.GetPhysicalDeviceQueueFamilyProperties2(physicalDevice, pQueueFamilyPropertyCount, pQueueFamilyProperties);
}
...
{
    __vkApiDispatchTable.GetPhysicalDeviceMemoryProperties2(physicalDevice, pMemoryProperties);
}
...
{
    __vkApiDispatchTable.GetPhysicalDeviceSparseImageFormatProperties2(physicalDevice,pFormatInfo, pPropertyCount, pProperties);
}
...
{
    __vkApiDispatchTable.TrimCommandPool(device, commandPool, flags);
}
...
{
    __vkApiDispatchTable.GetDeviceQueue2(device, pQueueInfo, pQueue);
}

VKAPI_ATTR VkResult VKAPI_CALL vkCreateSamplerYcbcrConversion(VkDevice device, const VkSamplerYcbcrConversionCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSamplerYcbcrConversion* pYcbcrConversion)
{
    return __vkApiDispatchTable.CreateSamplerYcbcrConversion(device, pCreateInfo, pAllocator, pYcbcrConversion);
}
...
{
    __vkApiDispatchTable.DestroySamplerYcbcrConversion(device, ycbcrConversion, pAllocator);
}
...
{
    return __vkApiDispatchTable.CreateDescriptorUpdateTemplate(device, pCreateInfo, pAllocator, pDescriptorUpdateTemplate);
}
...
{
    __vkApiDispatchTable.DestroyDescriptorUpdateTemplate(device, descriptorUpdateTemplate, pAllocator);
}
...
{
    __vkApiDispatchTable.UpdateDescriptorSetWithTemplate(device, descriptorSet, descriptorUpdateTemplate, pData);
}
...
{
    __vkApiDispatchTable.GetPhysicalDeviceExternalBufferProperties(physicalDevice, pExternalBufferInfo, pExternalBufferProperties);
}
...
{
    __vkApiDispatchTable.GetPhysicalDeviceExternalFenceProperties(physicalDevice, pExternalFenceInfo, pExternalFenceProperties);
}
...
{
    __vkApiDispatchTable.GetPhysicalDeviceExternalSemaphoreProperties(physicalDevice, pExternalSemaphoreInfo, pExternalSemaphoreProperties);
}
...
{
    __vkApiDispatchTable.GetDescriptorSetLayoutSupport(device, pCreateInfo, pSupport);
}
...
{
    return __vkApiDispatchTable.GetDeviceGroupPresentCapabilitiesKHR(device, pDeviceGroupPresentCapabilities);
}

VKAPI_ATTR VkResult VKAPI_CALL vkGetDeviceGroupSurfacePresentModesKHR(VkDevice device, VkSurfaceKHR surface, VkDeviceGroupPresentModeFlagsKHR* pModes)
{
    return  __vkApiDispatchTable.GetDeviceGroupSurfacePresentModesKHR(device, surface, pModes);
}

VKAPI_ATTR VkResult VKAPI_CALL vkGetPhysicalDevicePresentRectanglesKHR(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, uint32_t* pRectCount, VkRect2D* pRects)
{
    return __vkApiDispatchTable.GetPhysicalDevicePresentRectanglesKHR(physicalDevice, surface, pRectCount, pRects);
}

VKAPI_ATTR VkResult VKAPI_CALL vkAcquireNextImage2KHR(VkDevice device, const VkAcquireNextImageInfoKHR* pAcquireInfo, uint32_t* pImageIndex)
{
    return __vkApiDispatchTable.AcquireNextImage2KHR(device, pAcquireInfo, pImageIndex);
}
