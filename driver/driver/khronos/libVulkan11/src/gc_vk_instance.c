...
VKAPI_ATTR VkResult VKAPI_CALL __vk_EnumerateInstanceVersion(
    ...
    )
{
    if (instance)
    {
        if (strcmp(pName, "vkGetPhysicalDeviceExternalBufferPropertiesKHR") == 0) pName = "vkGetPhysicalDeviceExternalBufferProperties";
        if (strcmp(pName, "vkGetPhysicalDeviceExternalFencePropertiesKHR") == 0) pName = "vkGetPhysicalDeviceExternalFenceProperties";
        if (strcmp(pName, "vkGetPhysicalDeviceExternalSemaphorePropertiesKHR") == 0) pName = "vkGetPhysicalDeviceExternalSemaphoreProperties";
        if (strcmp(pName, "vkGetPhysicalDeviceFeatures2KHR") == 0) pName = "vkGetPhysicalDeviceFeatures2";
        if (strcmp(pName, "vkGetPhysicalDeviceProperties2KHR") == 0) pName = "vkGetPhysicalDeviceProperties2";
        if (strcmp(pName, "vkGetPhysicalDeviceFormatProperties2KHR") == 0) pName = "vkGetPhysicalDeviceFormatProperties2";
        if (strcmp(pName, "vkGetPhysicalDeviceImageFormatProperties2KHR") == 0) pName = "vkGetPhysicalDeviceImageFormatProperties2";
        if (strcmp(pName, "vkGetPhysicalDeviceQueueFamilyProperties2KHR") == 0) pName = "vkGetPhysicalDeviceQueueFamilyProperties2";
        if (strcmp(pName, "vkGetPhysicalDeviceMemoryProperties2KHR") == 0) pName = "vkGetPhysicalDeviceMemoryProperties2";
        if (strcmp(pName, "vkGetPhysicalDeviceSparseImageFormatProperties2KHR") == 0) pName = "vkGetPhysicalDeviceSparseImageFormatProperties2";
