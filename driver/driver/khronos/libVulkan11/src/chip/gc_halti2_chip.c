    ...
    )
{
    ...
    if (img->formatInfo.bitsPerBlock == 8)
    {
        alignWidth = 32;
        alignHeight = 8;
    }
    ...
    while (partIndex < pLevel->partCount)
    {
        ...
        __VK_ERR_BREAK(__vkComputeClearVal(
    ...
    )
{
 ...
 29:29) - (0 ?
 29:29) + 1))))))) << (0 ?
 29:29))) | (((gctUINT32) ((gctUINT32) (txDesc->fast_filter && ((samplerDesc->halti2.anisoLog == 0) || txDesc->isCubmap) && !devCtx->database->TX_NO_FIXED_FILTER) & ((gctUINT32) ((((1 ?
 29:29) - (0 ?
 29:29) + 1) == 32) ?
 ~0U : (~(~0U << ((1 ? 29:29) - (0 ? 29:29) + 1))))))) << (0 ? 29:29))));
