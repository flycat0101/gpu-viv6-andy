    ...
    )
{
    ...
    if (i < __VK_COUNTOF(s_vkFormatToHwPeDescs))
    {
        ...
        *hwPEDesc = s_vkFormatToHwPeDescs[i].hwDesc;
        ...
        if (is16Bit)
        {
            switch (s_vkFormatToHwPeDescs[i].vkFormat)
            {
            case VK_FORMAT_R16_SINT:
            case VK_FORMAT_R16_SFLOAT:
                hwPEDesc->hwFormat = 0x1A;
                hwPEDesc->hwOutputMode = 0x1;
                break;
            case VK_FORMAT_R16G16_SINT:
            case VK_FORMAT_R16G16_SFLOAT:
                hwPEDesc->hwFormat = 0x1B;
                hwPEDesc->hwOutputMode = 0x1;
                break;
            case VK_FORMAT_R16G16B16A16_SINT:
            case VK_FORMAT_R16G16B16A16_SFLOAT:
                hwPEDesc->hwFormat = 0x1C;
                hwPEDesc->hwOutputMode = 0x1;
                break;
            case VK_FORMAT_R32_SFLOAT:
                hwPEDesc->hwFormat = 0x14;
                hwPEDesc->hwOutputMode = 0x2;
                break;
            default:
                break;
            }
