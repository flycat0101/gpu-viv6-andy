...
__vkExtension g_EnabledExtensions[] =
{
    {VK_KHR_16BIT_STORAGE_EXTENSION_NAME, VK_FALSE},
    {VK_KHR_BIND_MEMORY_2_EXTENSION_NAME, VK_FALSE},
    {VK_KHR_DESCRIPTOR_UPDATE_TEMPLATE_EXTENSION_NAME, VK_FALSE},
    {VK_KHR_DEVICE_GROUP_EXTENSION_NAME, VK_FALSE},
    {VK_KHR_EXTERNAL_MEMORY_EXTENSION_NAME, VK_FALSE},
    {VK_KHR_GET_MEMORY_REQUIREMENTS_2_EXTENSION_NAME, VK_FALSE},
    {VK_KHR_MAINTENANCE1_EXTENSION_NAME, VK_FALSE},
