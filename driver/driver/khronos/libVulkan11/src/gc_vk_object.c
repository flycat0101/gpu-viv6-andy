...
VkResult __vk_DescriptorUpdateTemplateStatFunc(__vkDevContext *devCtx, __vkObject *obj, int32_t flag)
{
//    __vkDescriptorUpdateTemplate *dut = (__vkDescriptorUpdateTemplate *)obj;
...
PFN_ObjectStatFunc __vkObjectStatFuncTable[] = {
    ...
    __vk_DescriptorUpdateTemplateStatFunc, /* __VK_OBJECT_DESCRIPTOR_UPDATE_TEMPLATE */
...
char *__vkObjectNames[] = {
    ...
    "VK_OBJECT_DESCRIPTOR_UPDATE_TEMPLATE"  /* __VK_OBJECT_DESCRIPTOR_UPDATE_TEMPLATE */
