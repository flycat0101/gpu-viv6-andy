...
GLvoid __indirect_glGetColorTable(GLenum target, GLenum format, GLenum type, GLvoid *table)
{
    __GLX_SINGLE_DECLARE_VARIABLES();
    ...
    if (compsize != 0) {
        ...
        if (!buf) {
            ...
            */
            ...
            __glXEmptyImage(gc, 1, width, 1, 1, format, type, buf, table);
            Xfree((char*) buf);
        }
    } else {
        /*
...
GLvoid __indirect_glGetConvolutionFilter(GLenum target, GLenum format, GLenum type,
                GLvoid *image)
{
    __GLX_SINGLE_DECLARE_VARIABLES();
    ...
    if (compsize != 0) {
        ...
        if (!buf) {
            ...
            */
            ...
            __glXEmptyImage(gc, 2, width, height, 1, format, type, buf, image);
            Xfree((char*) buf);
        }
    } else {
        /*
...
GLvoid __indirect_glGetSeparableFilter(GLenum target, GLenum format, GLenum type,
              GLvoid *row, GLvoid *column, GLvoid *span)
{
    ...
    if (compsize != 0) {
        ...
        widthsize = __glXImageSize(width,1,1,format, type);
        heightsize = __glXImageSize(height,1,1,format, type);
        ...
        if (!rowBuf) {
            ...
            __glXEmptyImage(gc, 1, width, 1, 1, format, type, rowBuf, row);
            Xfree((char*) rowBuf);
        }
        ...
        if (!colBuf) {
            ...
            __glXEmptyImage(gc, 1, height, 1, 1, format, type, colBuf, column);
            Xfree((char*) colBuf);
        }
    } else {
        /*
...
GLvoid __indirect_glGetHistogram(GLenum target, GLboolean reset, GLenum format,
    ...
    if (compsize != 0) {
        ...
        if (!buf) {
            ...
            */
            width = (int)reply.width;
            __GLX_SINGLE_GET_CHAR_ARRAY(((char*)buf),(long)compsize);
            __glXEmptyImage(gc, 1, width, 1, 1, format, type, buf, values);
            Xfree((char*) buf);
        }
    } else {
        /*
...
GLvoid __indirect_glGetMinmax(GLenum target, GLboolean reset, GLenum format, GLenum type,
         GLvoid *values)
{
    __GLX_SINGLE_DECLARE_VARIABLES();
    ...
    if (compsize != 0) {
        ...
        if (!buf) {
            ...
            */
            __GLX_SINGLE_GET_CHAR_ARRAY(((char*)buf),(long)compsize);
            __glXEmptyImage(gc, 1, 2, 1, 1, format, type, buf, values);
            Xfree((char*) buf);
        }
    } else {
        /*
