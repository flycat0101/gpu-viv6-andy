...
** and format.
*/
GLint __glXImageSize(GLsizei width, GLsizei height, GLsizei depth,
...
*/
static GLvoid FillBitmap(__GLXcontext *gc, GLint width, GLint height,
...
** ALIGNMENT = 1.
*/
GLvoid __glXFillImage(__GLXcontext *gc, GLint dim, GLint width, GLint height,
...
*/
static GLvoid EmptyBitmap(__GLXcontext *gc, GLint width, GLint height,
...
** Named __glXEmptyImage() because it is the opposite of __glXFillImage().
*/
/* ARGSUSED */
GLvoid __glXEmptyImage(__GLXcontext *gc, GLint dim, GLint width, GLint height,
            GLint depth, GLenum format, GLenum type,
