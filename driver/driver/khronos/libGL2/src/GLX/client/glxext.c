...
/* Zero mean legacy X desktop. Non-zero means Unity2d or Unity3d desktop */
...
*/
static __GLdispatchTable *__glIndirectDispatchTab = NULL;
/*
...
int __glXCloseDisplay(Display *dpy, XExtCodes *codes)
{
    ...
    if (dpy == gc->currentDpy) {
        ...
        _glapi_set_dispatch((GLvoid *)__glNopDispatchTab);  /* no-op functions */
...
__GLXdisplayPrivate *__glXInitialize(Display* dpy)
{
    ...
    */
    ...
    _glapi_set_dispatch((GLvoid *)__glNopDispatchTab);
    ...
    if (gc == oldGC) {
        ...
        */
        ...
        if (gc) {
            ...
            if (!gc->isDirect) {
                if (!__glIndirectDispatchTab) {
                    __glIndirectDispatchTab = __glXNewIndirectAPI();
                }
                _glapi_set_dispatch((GLvoid *)__glIndirectDispatchTab);
            }
