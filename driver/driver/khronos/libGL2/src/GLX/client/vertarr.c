...
#define __GL_VERTEX_FUNC(NAME, let) \
    case GL_##NAME: \
      if (size == 2) \
    vertexPointer->proc = (GLvoid (*)(const GLvoid *))glVertex2##let##v; \
      else if (size == 3) \
    vertexPointer->proc = (GLvoid (*)(const GLvoid *))glVertex3##let##v; \
      else if (size == 4) \
    vertexPointer->proc = (GLvoid (*)(const GLvoid *))glVertex4##let##v; \
      break

#define __GL_NORMAL_FUNC(NAME, let) \
    case GL_##NAME: \
      normalPointer->proc = (GLvoid (*)(const GLvoid *))glNormal3##let##v; \
      break

#define __GL_COLOR_FUNC(NAME, let) \
    case GL_##NAME: \
      if (size == 3) \
    colorPointer->proc = (GLvoid (*)(const GLvoid *))glColor3##let##v; \
      else if (size == 4)\
    colorPointer->proc = (GLvoid (*)(const GLvoid *))glColor4##let##v; \
      break

#define __GL_INDEX_FUNC(NAME, let) \
    case GL_##NAME: \
      indexPointer->proc = (GLvoid (*)(const GLvoid *))glIndex##let##v; \
      break

#define __GL_TEXTURE_FUNC(NAME, let) \
    case GL_##NAME: \
      if (size == 1) \
    texCoordPointer->proc = (GLvoid (*)(const GLvoid *))glTexCoord1##let##v; \
      else if (size == 2) \
    texCoordPointer->proc = (GLvoid (*)(const GLvoid *))glTexCoord2##let##v; \
      else if (size == 3) \
    texCoordPointer->proc = (GLvoid (*)(const GLvoid *))glTexCoord3##let##v; \
      else if (size == 4) \
    texCoordPointer->proc = (GLvoid (*)(const GLvoid *))glTexCoord4##let##v; \
      break
...
GLvoid __glXInitVertexArrayState(__GLXcontext *gc)
{
...
GLvoid __indirect_glVertexPointer(GLint size, GLenum type, GLsizei stride,
...
GLvoid __indirect_glColorPointer(GLint size, GLenum type, GLsizei stride,
            const GLvoid *pointer)
{
    __GLXcontext *gc = __glXGetCurrentContext();
...
GLvoid __indirect_glTexCoordPointer(GLint size, GLenum type, GLsizei stride,
               const GLvoid *pointer)
{
    __GLXcontext *gc = __glXGetCurrentContext();
...
GLvoid __indirect_glEdgeFlagPointer(GLsizei stride, const GLboolean *pointer)
{
    ...
    /* Choose appropriate api proc */
    edgeFlagPointer->proc = (GLvoid (*)(const GLvoid *))glEdgeFlagv;
...
GLvoid __indirect_glInterleavedArrays(GLenum format, GLsizei stride, const GLvoid *pointer)
{
    ...
    __indirect_glDisableClientState(GL_EDGE_FLAG_ARRAY);
    __indirect_glDisableClientState(GL_INDEX_ARRAY);
    if (tEnable) {
...
GLvoid __indirect_glDrawElements(GLenum mode, GLsizei count, GLenum type,
...
GLvoid __indirect_glDrawRangeElements(GLenum mode, GLuint start, GLuint end,
