...
#undef __GLVVT_FUNC
#define __GLVVT_FUNC(func) _vvvvvvv_gl##func
...
GLvoid APIENTRY __GLVVT_FUNC(EdgeFlagPointer)(GLsizei stride, const GLboolean *pointer)
{
...
#define glFunc(func) _vvvvvvv_gl##func
__GLdispatchTable glVVT_DispatchTable =
{
    __GL_API_ENTRIES(glFunc)
};
