...
** handle the data.  Any pixel store modes not done by the __glXFillImage
...
*/
static GLvoid SendLargeImage(__GLXcontext *gc, GLint compsize, GLint dim,
...
*/
static GLvoid SendLargeNULLImage(__GLXcontext *gc, GLint compsize,
                   GLint width, GLint height, GLint depth,
                   GLenum format, GLenum type, const GLvoid *src,
                   GLubyte *pc, GLubyte *modes)
{
...
GLvoid __indirect_glPolygonStipple(const GLubyte *mask)
{
    ...
    compsize = __glXImageSize(32, 32, 1, GL_COLOR_INDEX, GL_BITMAP);
...
GLvoid __indirect_glBitmap(GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig,
          GLfloat xmove, GLfloat ymove, const GLubyte *bitmap)
{
    __GLX_DECLARE_VARIABLES();

    compsize = __glXImageSize(width, height, 1, GL_COLOR_INDEX, GL_BITMAP);
...
GLvoid __indirect_glTexImage1D(GLenum target, GLint level, GLint components,
          ...
          const GLvoid *image)
{
    ...
    if (target == GL_PROXY_TEXTURE_1D) {
        ...
        compsize = __glXImageSize(width, 1, 1, format, type);
    }
...
GLvoid __indirect_glTexImage2D(GLenum target, GLint level, GLint components,
          ...
          GLenum type, const GLvoid *image)
{
    ...
    if (target == GL_PROXY_TEXTURE_2D ||
        ...
        compsize = __glXImageSize(width, height, 1, format, type);
    }
    cmdlen = __GLX_PAD(__GLX_TEXIMAGE_CMD_HDR_SIZE + compsize);
    __GLX_LOAD_VARIABLES();
    if (!gc->currentDpy) return;
...
GLvoid __indirect_glDrawPixels(GLsizei width, GLsizei height, GLenum format, GLenum type,
          const GLvoid *image)
{
    __GLX_DECLARE_VARIABLES();
...
static GLvoid __glx_TexSubImage1D2D(GLshort opcode, GLenum target, GLint level,
...
GLvoid __indirect_glTexSubImage1D(GLenum target, GLint level, GLint xoffset,
...
GLvoid __indirect_glTexSubImage2D(GLenum target, GLint level, GLint xoffset,
...
GLvoid __indirect_glColorTable(GLenum target, GLenum internalformat, GLsizei width,
...
GLvoid __indirect_glColorSubTable(GLenum target, GLsizei start, GLsizei count,
             GLenum format, GLenum type, const GLvoid *table)
{
    __GLX_DECLARE_VARIABLES();

    compsize = __glXImageSize(count, 1, 1, format, type);
...
static GLvoid __glx_ConvolutionFilter1D2D(GLshort opcode, GLint dim,
            GLenum target,
...
GLvoid __indirect_glConvolutionFilter1D(GLenum target, GLenum internalformat,
...
GLvoid __indirect_glConvolutionFilter2D(GLenum target, GLenum internalformat,
...
GLvoid __indirect_glSeparableFilter2D(GLenum target, GLenum internalformat,
                GLsizei width, GLsizei height, GLenum format,
                ...
                const GLvoid *column)
{
    ...
    compsize = __glXImageSize(width, 1, 1, format, type);
    compsize2 = __glXImageSize(height, 1, 1, format, type);
...
GLvoid __indirect_glTexImage3D(GLenum target, GLint level, GLint internalformat,
          ...
          GLenum format, GLenum type, const GLvoid *image)
{
    ...
    if ((target == GL_PROXY_TEXTURE_3D) || (image == NULL)) {
        ...
        compsize = __glXImageSize(width, height, depth, format, type);
    }
...
GLvoid __indirect_glTexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset,
