...
GLvoid APIENTRY __glim_Fogfv(GLenum pname, const GLfloat *pv)
{
...
GLvoid APIENTRY __glim_Fogf(GLenum pname, GLfloat f)
{
    GLfloat tmpf[4];
   __GL_SETUP_NOT_IN_BEGIN();
...
GLvoid APIENTRY __glim_Fogiv(GLenum pname, const GLint *pv)
{
    GLfloat tmpf[4];
    __GL_SETUP_NOT_IN_BEGIN();
...
GLvoid APIENTRY __glim_Fogi(GLenum pname, GLint i)
{
    GLfloat tmpf[4];
    __GL_SETUP_NOT_IN_BEGIN();
