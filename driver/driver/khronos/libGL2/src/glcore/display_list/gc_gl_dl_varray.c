...
GLvoid APIENTRY __gllc_DrawElements(GLenum mode, GLsizei count, GLenum type, const GLvoid *elemIndices)
{
    __GL_SETUP();
    __GLdlistOp *dlop;
    __GLvertexArrayState *pV = &gc->clientState.vertexArray;
    ...
    if (gc->dlist.mode == GL_COMPILE_AND_EXECUTE) {
        (*gc->immediateDispatchTable.dispatch.DrawElements)(mode, count, type, elemIndices);
    }
...
GLvoid APIENTRY __gllc_DrawArrays(GLenum mode, GLint first, GLsizei count)
{
    __GL_SETUP();
    __GLdlistOp *dlop;
    __GLvertexArrayState *pV = &gc->clientState.vertexArray;
...
GLvoid APIENTRY __gllc_DrawRangeElements(GLenum mode, GLuint start, GLuint end,
                            GLsizei count, GLenum type, const GLvoid *elemIndices)
{
    ...
    __gllc_DrawElements(mode, count, type, elemIndices);
}

GLvoid APIENTRY __gllc_MultiDrawElements(GLenum mode, const GLsizei *count,
                            GLenum type, const GLvoid **indices, GLsizei primcount)
{
    GLint i;
    for (i = 0; i < primcount; i++) {
        if (count[i] > 0)
            __gllc_DrawElements(mode, count[i], type, indices[i]);
    }
}

GLvoid APIENTRY __gllc_MultiDrawArrays(GLenum mode, GLint *first, GLsizei *count, GLsizei primcount)
{
    GLint i;
    for (i = 0; i < primcount; i++)
    {
        if (count[i] > 0)
            __gllc_DrawArrays(mode, first[i], count[i]);
    }
}

GLvoid APIENTRY __gllc_ArrayElement(GLint element)
{
    __GL_SETUP();
    ...
    if (gc->dlist.mode == GL_COMPILE_AND_EXECUTE) {
        (*gc->immediateDispatchTable.dispatch.ArrayElement)(element);
    }
    ...
    while (loop) {
        ...
        {
        case __GL_V2F_TAG:
            (*gc->listCompileDispatchTable.dispatch.Vertex2fv)(bufptr);
            bufptr += 2;
            loop = GL_FALSE;
            break;
        case __GL_V3F_TAG:
            (*gc->listCompileDispatchTable.dispatch.Vertex3fv)(bufptr);
            bufptr += 3;
            loop = GL_FALSE;
            break;
        case __GL_V4F_TAG:
            (*gc->listCompileDispatchTable.dispatch.Vertex4fv)(bufptr);
            bufptr += 4;
            loop = GL_FALSE;
            break;
        case __GL_C3F_TAG:
            (*gc->listCompileDispatchTable.dispatch.Color3fv)(bufptr);
            bufptr += 3;
            break;
        case __GL_C4F_TAG:
            (*gc->listCompileDispatchTable.dispatch.Color4fv)(bufptr);
            bufptr += 4;
            break;
        case __GL_C4UB_TAG:
            (*gc->listCompileDispatchTable.dispatch.Color4ubv)((GLubyte *)bufptr);
            bufptr += 1;
            break;
        case __GL_N3F_TAG:
            (*gc->listCompileDispatchTable.dispatch.Normal3fv)(bufptr);
            bufptr += 3;
            break;
        case __GL_TC2F_TAG:
            (*gc->listCompileDispatchTable.dispatch.TexCoord2fv)(bufptr);
            bufptr += 2;
            break;
        ...
        case __GL_TC2F_U7_TAG:
            ...
            (*gc->listCompileDispatchTable.dispatch.MultiTexCoord2fv)(index, bufptr);
            bufptr += 2;
            break;
        case __GL_TC3F_TAG:
            (*gc->listCompileDispatchTable.dispatch.TexCoord3fv)(bufptr);
            bufptr += 3;
            break;
        ...
        case __GL_TC3F_U7_TAG:
            ...
            (*gc->listCompileDispatchTable.dispatch.MultiTexCoord3fv)(index, bufptr);
            bufptr += 3;
            break;
        case __GL_TC4F_TAG:
            (*gc->listCompileDispatchTable.dispatch.TexCoord4fv)(bufptr);
            bufptr += 4;
            break;
        ...
        case __GL_TC4F_U7_TAG:
            ...
            (*gc->listCompileDispatchTable.dispatch.MultiTexCoord4fv)(index, bufptr);
            bufptr += 4;
            break;
        case __GL_EDGEFLAG_TAG:
            (*gc->listCompileDispatchTable.dispatch.EdgeFlag)(edgeflag);
            break;
        case __GL_SC3F_TAG:
            (*gc->listCompileDispatchTable.dispatch.SecondaryColor3fv)(bufptr);
            bufptr += 3;
            break;
        case __GL_FOG1F_TAG:
            (*gc->listCompileDispatchTable.dispatch.FogCoordfv)(bufptr);
            bufptr += 1;
            break;
        ...
        case __GL_AT4F_I15_TAG:
            ...
            (*gc->listCompileDispatchTable.dispatch.VertexAttrib4fv)(index, bufptr);
            bufptr += 4;
            break;
