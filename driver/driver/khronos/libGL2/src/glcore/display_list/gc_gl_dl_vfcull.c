...
GLvoid APIENTRY __glim_CallList_Cache(GLuint list);
GLvoid APIENTRY __glim_CallLists_Cache(GLsizei n, GLenum type, const GLvoid *lists);
...
const GLubyte *__glle_Primitive(const GLubyte *PC)
{
    __GL_SETUP();
...
__GL_INLINE GLvoid __glConcatListCacheEnd(__GLcontext *gc)
{
    ...
    gc->immediateDispatchTable.dispatch.CallList = __glim_CallList;
    gc->immediateDispatchTable.dispatch.CallLists = __glim_CallLists;
}
        ...
        */
        ...
        if (listConcatDraw)
        {
            ...
            if (listConcatDraw) {
                ...
                gc->immediateDispatchTable.dispatch.CallList = __glim_CallList_Cache;
                gc->immediateDispatchTable.dispatch.CallLists = __glim_CallLists_Cache;
...
GLvoid APIENTRY __glim_CallList_Cache(GLuint list)
{
    ...
    if(dbg_logAPIFilter)
        dbgLogFullApi("__glim_CallList_Cache",DT_GLuint, list, DT_GLnull);
#endif
...
#if (defined(_DEBUG) || defined(DEBUG))
    if(dbg_logAPIFilter)
        dbgLogFullApi("__glim_CallLists_Cache", DT_GLsizei, n, DT_GLenum, type, DT_GLvoid_ptr, lists, DT_GLnull);
#endif
