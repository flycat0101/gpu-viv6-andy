...
GLuint APIENTRY __glim_GenLists(GLsizei range)
{
    ...
    if(dbg_logAPIFilter)
        dbgLogFullApi("__glim_GenLists", DT_GLsizei, range, DT_GLnull);
#endif
...
GLvoid APIENTRY __glim_ListBase(GLuint base)
{
    __GL_SETUP_NOT_IN_BEGIN();

#if (defined(_DEBUG) || defined(DEBUG))
    if(dbg_logAPIFilter)
        dbgLogFullApi("__glim_ListBase", DT_GLuint, base, DT_GLnull);
#endif

    gc->state.list.listBase = base;
}

GLvoid APIENTRY __glim_DeleteLists(GLuint list, GLsizei range)
{
    GLuint i;
    __GL_SETUP_NOT_IN_BEGIN();
...
#if (defined(_DEBUG) || defined(DEBUG))
    if(dbg_logAPIFilter)
        dbgLogFullApi("__glim_DeleteLists", DT_GLuint, list, DT_GLsizei, range, DT_GLnull);
#endif
...
GLvoid APIENTRY __glim_NewList(GLuint list, GLenum mode)
{
    __GL_SETUP_NOT_IN_BEGIN();

#if (defined(_DEBUG) || defined(DEBUG))
    if(dbg_logAPIFilter)
        dbgLogFullApi("__glim_NewList", DT_GLuint, list, DT_GLenum, mode, DT_GLnull);
#endif
...
GLvoid APIENTRY __glim_EndList(GLvoid)
{
...
#if (defined(_DEBUG) || defined(DEBUG))
    if(dbg_logAPIFilter)
        dbgLogFullApi("__glim_EndList", DT_GLnull);
#endif
...
*/
GLvoid APIENTRY __glim_CallList(GLuint list)
{
    __GL_SETUP();

#if (defined(_DEBUG) || defined(DEBUG))
    if(dbg_logAPIFilter)
        dbgLogFullApi("__glim_CallList", DT_GLuint, list, DT_GLnull);
#endif
...
*/
GLvoid APIENTRY __glim_CallLists(GLsizei n, GLenum type, const GLvoid *lists)
{
    __GL_SETUP();
    GLuint list, base;
    GLint i;
...
#if (defined(_DEBUG) || defined(DEBUG))
    if(dbg_logAPIFilter)
        dbgLogFullApi("__glim_CallLists", DT_GLsizei, n, DT_GLenum, type, DT_GLvoid_ptr, lists, DT_GLnull);
#endif
...
*/
GLvoid APIENTRY __gllc_CallList(GLuint list)
{
    __GLdlistOp *dlop;
...
#if (defined(_DEBUG) || defined(DEBUG))
    if(dbg_logAPIFilter)
        dbgLogFullApi("__gllc_CallList", DT_GLuint, list, DT_GLnull);
#endif
...
GLvoid APIENTRY __gllc_CallLists(GLsizei n, GLenum type, const GLvoid *lists)
{
    __GLdlistOp *dlop;
...
#if (defined(_DEBUG) || defined(DEBUG))
    if(dbg_logAPIFilter)
        dbgLogFullApi("__gllc_CallLists", DT_GLsizei, n, DT_GLenum, type, DT_GLvoid_ptr, lists, DT_GLnull);
#endif

    if (gc->dlist.mode == GL_COMPILE_AND_EXECUTE) {
        __glim_CallLists(n, type, lists);
    }
...
#if (defined(_DEBUG) || defined(DEBUG))
    if(dbg_logAPIFilter)
        dbgLogFullApi("__glle_CallList", DT_GLubyte_ptr, PC, DT_GLnull);
#endif
...
#if (defined(_DEBUG) || defined(DEBUG))
    if(dbg_logAPIFilter)
        dbgLogFullApi("__glle_CallLists", DT_GLubyte_ptr, PC, DT_GLnull);
#endif
