...
{
    __glUpdateHitFlag(gc, v->winPos.z);
}
...
GLvoid APIENTRY __glim_SelectBuffer(GLsizei bufferLength, GLuint *buffer)
{
...
GLvoid APIENTRY __glim_InitNames(GLvoid)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
GLvoid APIENTRY __glim_LoadName(GLuint name)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
GLvoid APIENTRY __glim_PopName(GLvoid)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
GLvoid APIENTRY __glim_PushName(GLuint name)
{
    __GL_SETUP_NOT_IN_BEGIN();
