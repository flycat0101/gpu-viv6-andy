...
__GL_INLINE GLvoid __glVertex2fv(GLfloat *v)
{
    __GL_SETUP();
    GLfloat *current;
...
__GL_INLINE GLvoid __glVertex3fv(GLfloat *v)
{
    __GL_SETUP();
    GLfloat *current;
...
__GL_INLINE GLvoid __glVertex4fv(GLfloat *v)
{
    __GL_SETUP();
    GLuint *current;
    GLuint *iv = (GLuint *)v;
...
GLvoid APIENTRY __glim_Vertex2f(GLfloat x, GLfloat y)
{
...
GLvoid APIENTRY __glim_Vertex2fv(const GLfloat *v)
{
#if (defined(_DEBUG) || defined(DEBUG))
    if(dbg_logAPIFilter)
    ...
    __glVertex2fv( (GLfloat *)v );
}

GLvoid APIENTRY __glim_Vertex2d(GLdouble x, GLdouble y)
{
    GLfloat fv[2];
...
GLvoid APIENTRY __glim_Vertex2dv(const GLdouble *v)
{
    GLfloat fv[2];
...
GLvoid APIENTRY __glim_Vertex2i(GLint x, GLint y)
{
    GLfloat fv[2];
...
GLvoid APIENTRY __glim_Vertex2iv(const GLint *v)
{
    GLfloat fv[2];
...
GLvoid APIENTRY __glim_Vertex2s(GLshort x, GLshort y)
{
    GLfloat fv[2];
...
GLvoid APIENTRY __glim_Vertex2sv(const GLshort *v)
{
    GLfloat fv[2];
...
GLvoid APIENTRY __glim_Vertex3f(GLfloat x, GLfloat y, GLfloat z)
{
    GLfloat fv[3];
...
GLvoid APIENTRY __glim_Vertex3fv(const GLfloat *v)
{
#if (defined(_DEBUG) || defined(DEBUG))
    if(dbg_logAPIFilter)
    ...
    __glVertex3fv( (GLfloat *)v );
}

GLvoid APIENTRY __glim_Vertex3d(GLdouble x, GLdouble y, GLdouble z)
{
    GLfloat fv[3];
...
GLvoid APIENTRY __glim_Vertex3dv(const GLdouble *v)
{
    GLfloat fv[3];
...
GLvoid APIENTRY __glim_Vertex3i(GLint x, GLint y, GLint z)
{
    GLfloat fv[3];
...
GLvoid APIENTRY __glim_Vertex3iv(const GLint *v)
{
    GLfloat fv[3];
...
GLvoid APIENTRY __glim_Vertex3s(GLshort x, GLshort y, GLshort z)
{
    GLfloat fv[3];
...
GLvoid APIENTRY __glim_Vertex3sv(const GLshort *v)
{
    GLfloat fv[3];
...
GLvoid APIENTRY __glim_Vertex4f(GLfloat x, GLfloat y, GLfloat z, GLfloat w)
{
    GLfloat fv[4];
...
GLvoid APIENTRY __glim_Vertex4fv(const GLfloat *v)
{
#if (defined(_DEBUG) || defined(DEBUG))
    if(dbg_logAPIFilter)
    ...
    __glVertex4fv( (GLfloat *)v );
}

GLvoid APIENTRY __glim_Vertex4d(GLdouble x, GLdouble y, GLdouble z, GLdouble w)
{
    GLfloat fv[4];
...
GLvoid APIENTRY __glim_Vertex4dv(const GLdouble *v)
{
    GLfloat fv[4];
...
GLvoid APIENTRY __glim_Vertex4i(GLint x, GLint y, GLint z, GLint w)
{
    GLfloat fv[4];
...
GLvoid APIENTRY __glim_Vertex4iv(const GLint *v)
{
    GLfloat fv[4];
...
GLvoid APIENTRY __glim_Vertex4s(GLshort x, GLshort y, GLshort z, GLshort w)
{
    GLfloat fv[4];
...
GLvoid APIENTRY __glim_Vertex4sv(const GLshort *v)
{
    GLfloat fv[4];
