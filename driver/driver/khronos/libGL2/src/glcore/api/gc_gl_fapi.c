...
__GL_INLINE GLvoid __glFogCoordfv(GLfloat *fc)
{
    __GL_SETUP();
...
GLvoid APIENTRY __glim_FogCoordd(GLdouble coord)
{
    GLfloat fv[1];
...
GLvoid APIENTRY __glim_FogCoorddv(const GLdouble *coord)
{
    GLfloat fv[1];
...
GLvoid APIENTRY __glim_FogCoordf(GLfloat coord)
{
#if (defined(_DEBUG) || defined(DEBUG))
    if(dbg_logAPIFilter)
...
GLvoid APIENTRY __glim_FogCoordfv(const GLfloat *coord)
{
#if (defined(_DEBUG) || defined(DEBUG))
    if(dbg_logAPIFilter)
