...
#define _GC_OBJ_ZONE    gcdZONE_GL40_BUFFER
...
#ifdef OPENGL40
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_A16),             /* __GL_FMT_A16 */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_A32),             /* __GL_FMT_A24 */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_L16),             /* __GL_FMT_L16 */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_L32),             /* __GL_FMT_L24 */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_A8R8G8B8),             /* __GL_FMT_I8 */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_A16R16G16B16),             /* __GL_FMT_I16 */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_A32R32G32B32),             /* __GL_FMT_I24 */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_A32B32G32R32F),             /* __GL_FMT_I32F */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_A4L4),             /* __GL_FMT_LA4 */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_A16L16),             /* __GL_FMT_LA16 */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_R5G6B5),             /* __GL_FMT_BGR565 */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_A4R4G4B4),             /* __GL_FMT_BGRA4444 */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_A1R5G5B5),             /* __GL_FMT_BGRA5551 */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_A16R16G16B16),             /* __GL_FMT_RGBA16 */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_A2R10G10B10),             /* __GL_FMT_BGRA1010102 */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_UNKNOWN),             /* __GL_FMT_ZHIGH24 */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_UNKNOWN),             /* __GL_FMT_ZHIGH24S8 */
    __GL_INITIALIZE_FORMAT_MAP_INFO_DEFAULT(gcvSURF_UNKNOWN),             /* __GL_FMT_COMPRESSED_LUMINANCE_LATC1 */
...
{
    return __glChipFmtMapInfo[devFmt].requestFormat;
}
...
GLboolean createDisplayBuffer(__GLcontext * gc, GLboolean bOnScreen,  gcoSURF *renderTarget)
{
    ...
    devFmt = pformatInfo->drvFormat;

    hwFormat = getHWFormat(devFmt);
...
GLboolean createRenderBuffer(__GLcontext *gc, glsCHIPBUFFERCREATE *chipCreateInfo, gcoSURF *retSurf)
{
    __GLdrawableBuffer *drawableBuf;
    gceSTATUS status = gcvSTATUS_OK;
    GLvoid *chipRenderBuffer = NULL;
    gceSURF_FORMAT hwFormat;
    gcoSURF renderTarget = gcvNULL;
    GLuint bufSize = 0;
    ...
    /* to do */
    hwFormat = getHWFormat(drawableBuf->deviceFormatInfo->drvFormat);
