...
GLvoid APIENTRY __glim_GetMaterialfv(__GLcontext *gc, GLenum face, GLenum pname, GLfloat *result)
{
...
GLvoid APIENTRY __glim_GetMaterialiv(__GLcontext *gc, GLenum face, GLenum pname, GLint *result)
{
    __GLmaterialState *mat;
    __GL_SETUP_NOT_IN_BEGIN(gc);
