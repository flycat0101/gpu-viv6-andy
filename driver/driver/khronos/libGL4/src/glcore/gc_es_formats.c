...
static __GLformatInfo *__gl4GetFormatInfo(GLenum internalFormat)
{

    GLuint returnFormat = __GL_FMT_MAX;
    GLuint baseFmt = __GL_FMT_RGBA8;
    ...
    switch(internalFormat)
    {
        ...
        case GL_LUMINANCE4:
        case GL_LUMINANCE8:
                returnFormat = __GL_FMT_L8;
            break;

        case GL_LUMINANCE12:
        case GL_LUMINANCE16:
                returnFormat = __GL_FMT_L16;
            break;

        case GL_LUMINANCE32UI_EXT:
            returnFormat = __GL_FMT_RGBA32UI;
            break;
        case GL_LUMINANCE32I_EXT:
            returnFormat = __GL_FMT_RGBA32I;
            break;
        case GL_LUMINANCE16UI_EXT:
            returnFormat = __GL_FMT_RGBA16UI;
            break;
        case GL_LUMINANCE16I_EXT:
            returnFormat = __GL_FMT_RGBA16I;
            break;
        case GL_LUMINANCE8UI_EXT:
            returnFormat = __GL_FMT_RGBA8UI;
            break;
        case GL_LUMINANCE8I_EXT:
            returnFormat = __GL_FMT_RGBA8I;
            break;

        case GL_LUMINANCE32F_ARB:
                returnFormat = __GL_FMT_L32F;
            break;
        ...
        case GL_COMPRESSED_LUMINANCE_LATC1_EXT:
                returnFormat = __GL_FMT_COMPRESSED_LUMINANCE_LATC1;
            break;

        case GL_COMPRESSED_SIGNED_LUMINANCE_LATC1_EXT:
                returnFormat = __GL_FMT_COMPRESSED_SIGNED_LUMINANCE_LATC1;
            break;
#ifdef GL_S3_S3TC_EX
        ...
        case GL_COMPRESSED_LUMINANCE_ALPHA_LATC2_EXT:
                returnFormat = __GL_FMT_COMPRESSED_LUMINANCE_ALPHA_LATC2;
            break;

        case GL_COMPRESSED_SIGNED_LUMINANCE_ALPHA_LATC2_EXT:
                returnFormat = __GL_FMT_COMPRESSED_SIGNED_LUMINANCE_ALPHA_LATC2;
            break;

        case GL_LUMINANCE4_ALPHA4:
                returnFormat = __GL_FMT_LA4;
            break;
        ...
        case GL_LUMINANCE8_ALPHA8:
                returnFormat = __GL_FMT_LA8;
            break;

        case GL_LUMINANCE12_ALPHA4:
        case GL_LUMINANCE12_ALPHA12:
        case GL_LUMINANCE16_ALPHA16:
                returnFormat = __GL_FMT_LA16;
            break;
        ...
        case GL_LUMINANCE_ALPHA32F_ARB:
            returnFormat = __GL_FMT_RGBA32F;
            break;

        case GL_LUMINANCE_ALPHA16F_ARB:
            returnFormat = __GL_FMT_RGBA16F;
            break;

        case GL_R3_G3_B2:
        case GL_RGB4:
        case GL_RGB5:
            returnFormat = __GL_FMT_BGR565;
            break;
        ...
        case GL_RGB32F_ARB:
                returnFormat = __GL_FMT_RGB32F;
            break;

        case GL_BGRA8_VIVPRIV:
            returnFormat = __GL_FMT_BGRA;
            break;
        ...
        case GL_RGB32UI_EXT:
            returnFormat = __GL_FMT_RGB32UI;
            break;
        case GL_RGB32I_EXT:
            returnFormat = __GL_FMT_RGB32I;
            break;
        case GL_RGB16UI_EXT:
            returnFormat = __GL_FMT_RGBA16UI;
            break;
        ...
        case GL_R11F_G11F_B10F_EXT:
            returnFormat = __GL_FMT_R11F_G11F_B10F;
            break;

        case GL_RGBA2:
        case GL_RGBA4:
            returnFormat = __GL_FMT_BGRA4444;
            break;
        ...
        case GL_RGBA12:
        case GL_RGBA16:
            returnFormat = __GL_FMT_RGBA16;
            break;

        case GL_RGB5_A1:
            returnFormat = __GL_FMT_BGRA5551;
            break;
        case GL_RGB10_A2:
            returnFormat = __GL_FMT_BGRA1010102;
            break;
        ...
        case GL_COMPRESSED_ALPHA_ARB:
            returnFormat = __GL_FMT_A8;
            break;

        case GL_ALPHA12:
        case GL_ALPHA16:
            returnFormat = __GL_FMT_A16;
            break;
        ...
        case GL_INTENSITY4:
        case GL_INTENSITY8:
                returnFormat = __GL_FMT_I8;
            break;

        case GL_INTENSITY12:
        case GL_INTENSITY16:
        case GL_COMPRESSED_INTENSITY_ARB:
                returnFormat = __GL_FMT_I16;
            break;
        ...
        case GL_COMPRESSED_RGB_S3TC_DXT1_EXT:
                returnFormat = __GL_FMT_COMPRESSED_RGB_S3TC_DXT1_EXT;
            break;

        case GL_COMPRESSED_RGBA_S3TC_DXT1_EXT:
                returnFormat = __GL_FMT_COMPRESSED_RGBA_S3TC_DXT1_EXT;
            break;
#ifdef GL_S3_S3TC_EX
        case GL_COMPRESSED_RGB4_ALPHA4_S3TC:
#endif
        case GL_COMPRESSED_RGBA_S3TC_DXT3_EXT:
                returnFormat = __GL_FMT_COMPRESSED_RGBA_S3TC_DXT3_EXT;
            break;
#ifdef GL_S3_S3TC_EX
...
#endif
                returnFormat = __GL_FMT_COMPRESSED_RGBA_S3TC_DXT5_EXT;
            break;

        case GL_COMPRESSED_RED_RGTC1_EXT:
                returnFormat = __GL_FMT_COMPRESSED_RED_RGTC1;
            break;

        case GL_COMPRESSED_SIGNED_RED_RGTC1_EXT:
                returnFormat = __GL_FMT_COMPRESSED_SIGNED_RED_RGTC1;
            break;

        case GL_COMPRESSED_RED_GREEN_RGTC2_EXT:
                returnFormat = __GL_FMT_COMPRESSED_RED_GREEN_RGTC2;
            break;

       case GL_COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT:
                returnFormat = __GL_FMT_COMPRESSED_SIGNED_RED_GREEN_RGTC2;
            break;

        case GL_DEPTH_COMPONENT16:
            returnFormat = __GL_FMT_Z16;
            break;

        case GL_DEPTH_COMPONENT:
            returnFormat = __GL_FMT_Z24;
            break;
        ...
        case GL_COMPRESSED_SLUMINANCE_ALPHA:
                returnFormat = __GL_FMT_SRGB_ALPHA;
            break;
        case GL_COMPRESSED_SRGB_S3TC_DXT1_EXT:
                returnFormat = __GL_FMT_COMPRESSED_SRGB_S3TC_DXT1;
            break;
        case GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT:
                returnFormat = __GL_FMT_COMPRESSED_SRGB_ALPHA_S3TC_DXT1;
            break;
        case GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT:
                returnFormat = __GL_FMT_COMPRESSED_SRGB_ALPHA_S3TC_DXT3;
            break;
        case GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT:
                returnFormat = __GL_FMT_COMPRESSED_SRGB_ALPHA_S3TC_DXT5;
            break;

        case GL_RGB9_E5_EXT:
                returnFormat = __GL_FMT_RGB9_E5;
            break;
        case GL_DEPTH24_STENCIL8_EXT:
            returnFormat = __GL_FMT_Z24S8;
            break;
        default:
#if defined(_MSC_VER)
            returnFormat = baseFmt;
    ...
    return &__glFormatInfoTable[returnFormat];
}
#endif

static __GLformatInfo* __glESGetFormatInfo(GLenum internalFormat)
{
...
__GLformatInfo* __glGetFormatInfo(GLenum internalFormat)
{
    ...
    __GLformatInfo *pformatInfo = (__GLformatInfo *)gcvNULL;


    pformatInfo = __glESGetFormatInfo(internalFormat);
#if defined(OPENGL40) && defined(DRI_PIXMAPRENDER_GL)
/* When GL4 works well, let 's merge __gl4GetFormatInfo into __glESGetFormatInfo */
    if ( pformatInfo == (&__glFormatInfoTable[__GL_FMT_MAX]) )
        return __gl4GetFormatInfo(internalFormat);
#endif
