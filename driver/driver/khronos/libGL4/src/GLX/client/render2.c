...
GLvoid __indirect_glMap1d(GLenum target, GLdouble u1, GLdouble u2, GLint stride,
...
GLvoid __indirect_glMap1f(GLenum target, GLfloat u1, GLfloat u2, GLint stride,
...
GLvoid __indirect_glMap2d(GLenum target, GLdouble u1, GLdouble u2, GLint ustr, GLint uord,
...
GLvoid __indirect_glMap2f(GLenum target, GLfloat u1, GLfloat u2, GLint ustr, GLint uord,
