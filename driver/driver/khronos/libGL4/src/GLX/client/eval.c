...
GLvoid __glFillMap1f(GLint k, GLint order, GLint stride,
...
GLvoid __glFillMap1d(GLint k, GLint order, GLint stride,
...
GLvoid __glFillMap2f(GLint k, GLint majorOrder, GLint minorOrder,
...
GLvoid __glFillMap2d(GLint k, GLint majorOrder, GLint minorOrder,
           GLint majorStride, GLint minorStride,
