...
** dependent methods.
*/
extern GLvoid *driCreateDisplay(Display *dpy, __DRIdisplay *pdisp);
extern __DRIscreen *__glXFindDRIScreen(Display *dpy, int scrn);

extern GLvoid DRI_glXUseXFont( Font font, int first, int count, int listbase );
...
struct __GLXcontextRec {
    ...
    */
    GLvoid (*fillImage)(__GLXcontext*, GLint, GLint, GLint, GLint, GLenum,
    ...
    */
    ...
    /**
     * Pointer to the next __GLXcontextRec in the displayPrivate->contextList.
     */
...
extern GLvoid __glFreeAttributeState(__GLXcontext *);
...
struct __GLXdisplayPrivateRec {
    ...
    */
    ...
    /*
    ** Linked list for all __GLXcontext created for this display.
    ** Used for final resource clean up.
    */
    __GLXcontext *contextList;
};

GLvoid __glXFreeContext(__GLXdisplayPrivate *, __GLXcontext*);

extern GLubyte *__glXFlushRenderBuffer(__GLXcontext*, GLubyte*);

extern GLvoid __glXSendLargeCommand(__GLXcontext *, const GLvoid *, GLint,
                  const GLvoid *, GLint);
...
#if defined( PTHREADS )
extern GLvoid __glXSetCurrentContext(__GLXcontext *c);
extern __GLXcontext *__glXGetCurrentContext(GLvoid);
#else
...
#define __glXMutexLock()    pthread_mutex_lock(&__glXmutex)
#define __glXMutexUnlock()  pthread_mutex_unlock(&__glXmutex)
#else
#define __glXMutexLock()
#define __glXMutexUnlock()
#endif
...
extern GLint __glXImageSize(GLsizei, GLsizei, GLsizei, GLenum, GLenum);
...
** sent data.
*/
extern GLvoid __glXFillImage(__GLXcontext*, GLint, GLint, GLint, GLint, GLenum,
              GLenum, const GLvoid*, GLubyte*, GLubyte*);

/* Copy map data with a stride into a packed buffer */
extern GLvoid __glFillMap1f(GLint, GLint, GLint, const GLfloat *, GLubyte *);
extern GLvoid __glFillMap1d(GLint, GLint, GLint, const GLdouble *, GLubyte *);
extern GLvoid __glFillMap2f(GLint, GLint, GLint, GLint, GLint,
              const GLfloat *, GLfloat *);
extern GLvoid __glFillMap2d(GLint, GLint, GLint, GLint, GLint,
...
*/
extern GLvoid __glXEmptyImage(__GLXcontext*, GLint, GLint, GLint, GLint, GLenum,
...
*/
extern GLvoid __glXInitVertexArrayState(__GLXcontext*);

/*
** Inform the Server of the major and minor numbers and of the client
** libraries extension string.
*/
extern GLvoid __glXClientInfo (  Display *dpy, int opcode );
...
extern GLvoid _XFlush(Display*);
extern Status _XReply(Display*, xReply*, int, Bool);
extern GLvoid _XRead(Display*, GLvoid*, long);
extern GLvoid _XSend(Display*, const GLvoid*, long);
#endif

/*
#define INDIRECT_SUPPORT 1
*/

#define GLX_PREFIX(function)  function

extern GLvoid __glXInitializeVisualConfigFromTags( __GLcontextModes *config,
...
#define GLX_ALIAS_VOID(real_func, proto_args, args, aliased_func) \
        GLX_ALIAS(GLvoid, real_func, proto_args, args, aliased_func)
#else
#define GLX_ALIAS(return_type, real_func, proto_args, args, aliased_func) \
        return_type  real_func  proto_args \
        { return aliased_func args ; }
#define GLX_ALIAS_VOID(real_func, proto_args, args, aliased_func) \
        GLvoid  real_func  proto_args \
        { aliased_func args ; }
#endif /* __GNUC__ */
