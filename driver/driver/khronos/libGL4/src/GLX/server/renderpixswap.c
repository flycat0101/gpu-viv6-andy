...
GLvoid __glXDispSwap_PolygonStipple(GLbyte *pc)
{
...
GLvoid __glXDispSwap_Bitmap(GLbyte *pc)
{
...
GLvoid __glXDispSwap_TexImage1D(GLbyte *pc)
{
...
GLvoid __glXDispSwap_TexImage2D(GLbyte *pc)
{
    __GLXdispatchTexImageHeader *hdr = (__GLXdispatchTexImageHeader *) pc;
    __GLX_DECLARE_SWAP_VARIABLES;
...
GLvoid __glXDispSwap_TexImage3D(GLbyte *pc)
{
...
GLvoid __glXDispSwap_DrawPixels(GLbyte *pc)
{
...
GLvoid __glXDispSwap_TexSubImage1D(GLbyte *pc)
{
...
GLvoid __glXDispSwap_TexSubImage2D(GLbyte *pc)
{
    __GLXdispatchTexSubImageHeader *hdr = (__GLXdispatchTexSubImageHeader *) pc;
    __GLX_DECLARE_SWAP_VARIABLES;
...
GLvoid __glXDispSwap_TexSubImage3D(GLbyte *pc)
{
...
GLvoid __glXDispSwap_ColorTable(GLbyte *pc)
{
...
GLvoid __glXDispSwap_ColorSubTable(GLbyte *pc)
{
...
GLvoid __glXDispSwap_ConvolutionFilter1D(GLbyte *pc)
{
...
GLvoid __glXDispSwap_ConvolutionFilter2D(GLbyte *pc)
{
    __GLXdispatchConvolutionFilterHeader *hdr =
                (__GLXdispatchConvolutionFilterHeader *) pc;
    __GLX_DECLARE_SWAP_VARIABLES;
...
GLvoid __glXDispSwap_SeparableFilter2D(GLbyte *pc)
{
    __GLXdispatchConvolutionFilterHeader *hdr =
                (__GLXdispatchConvolutionFilterHeader *) pc;
