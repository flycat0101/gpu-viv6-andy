...
GLvoid __glXDispSwap_Map1f(GLbyte *pc)
{
    GLint order, k;
...
GLvoid __glXDispSwap_Map2f(GLbyte *pc)
{
...
GLvoid __glXDispSwap_Map1d(GLbyte *pc)
{
...
GLvoid __glXDispSwap_Map2d(GLbyte *pc)
{
...
GLvoid __glXDispSwap_CallLists(GLbyte *pc)
{
    GLenum type;
    GLsizei n;
    __GLX_DECLARE_SWAP_VARIABLES;
...
static GLvoid swapArray(GLint numVals, GLenum datatype,
...
GLvoid __glXDispSwap_DrawArrays(GLbyte *pc)
{
...
GLvoid __glXDispSwap_DrawArraysEXT(GLbyte *pc)
{
