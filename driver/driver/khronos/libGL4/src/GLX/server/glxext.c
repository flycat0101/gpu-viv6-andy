...
GLvoid GlxWrapInitVisuals(miInitVisualsProcPtr *);
GLvoid GlxSetVisualConfigs(int nconfigs,
                         __GLXvisualConfig *configs, GLvoid **privates);
...
*/
static GLvoid ResetExtension(ExtensionEntry* extEntry)
{
...
*/
static GLvoid ResetClientState(int clientIndex)
{
...
*/
GLvoid __glXResetLargeCommandStatus(__GLXclientState *cl)
{
...
*/
GLvoid __glXErrorCallBack(__GLcontextInterface *gc, GLenum code)
{
...
*/
GLvoid __glXClearErrorOccured(GLvoid)
{
...
*/
GLboolean __glXErrorOccured(GLvoid)
{
    return errorOccured;
}
...
*/
GLvoid GlxExtensionInit(GLvoid)
{
...
GLvoid __glXFlushContextCache(GLvoid)
{
    __glXLastContext = 0;
}
...
GLvoid __glXNoSuchRenderOpcode(GLbyte *pc)
{
    return;
}
