...
*/
static GLvoid wrapPositionWindow(int screen)
{
...
GLvoid __glXHyperpipeInit(int screen, __GLXHyperpipeExtensionFuncs *funcs)
{
...
GLvoid __glXSwapBarrierInit(int screen, __GLXSwapBarrierExtensionFuncs *funcs)
{
...
GLvoid __glXScreenInit(GLint numscreens)
{
    GLint i,j;
...
GLvoid __glXScreenReset(GLvoid)
{
  int i;
