...
extern GLvoid __glXFlushContextCache(GLvoid);

extern GLvoid __glXNoSuchRenderOpcode(GLbyte*);
extern int __glXNoSuchSingleOpcode(__GLXclientState*, GLbyte*);
extern GLvoid __glXErrorCallBack(__GLcontextInterface *gc, GLenum code);
extern GLvoid __glXClearErrorOccured(GLvoid);
extern GLboolean __glXErrorOccured(GLvoid);
extern GLvoid __glXResetLargeCommandStatus(__GLXclientState*);
...
extern GLvoid GlxExtensionInit(GLvoid);

extern Bool __glXCoreType(GLvoid);
...
typedef struct {
    GLvoid * (* queryHyperpipeNetworkFunc)(int, int *, int *);
    GLvoid * (* queryHyperpipeConfigFunc)(int, int, int *, int *);
    int    (* destroyHyperpipeConfigFunc)(int, int);
    GLvoid * (* hyperpipeConfigFunc)(int, int, int *, int *, GLvoid *);
} __GLXHyperpipeExtensionFuncs;

extern GLvoid __glXHyperpipeInit(int screen, __GLXHyperpipeExtensionFuncs *funcs);
...
extern GLvoid __glXSwapBarrierInit(int screen, __GLXSwapBarrierExtensionFuncs *funcs);
