...
GLvoid __glXDisp_PolygonStipple(GLbyte *pc)
{
...
GLvoid __glXDisp_Bitmap(GLbyte *pc)
{
...
GLvoid __glXDisp_TexImage1D(GLbyte *pc)
{
...
GLvoid __glXDisp_TexImage2D(GLbyte *pc)
{
    __GLXdispatchTexImageHeader *hdr = (__GLXdispatchTexImageHeader *) pc;
...
GLvoid __glXDisp_TexImage3D(GLbyte *pc)
{
...
GLvoid __glXDisp_DrawPixels(GLbyte *pc)
{
...
GLvoid __glXDisp_TexSubImage1D(GLbyte *pc)
{
...
GLvoid __glXDisp_TexSubImage2D(GLbyte *pc)
{
    __GLXdispatchTexSubImageHeader *hdr = (__GLXdispatchTexSubImageHeader *) pc;
...
GLvoid __glXDisp_TexSubImage3D(GLbyte *pc)
{
...
GLvoid __glXDisp_ColorTable(GLbyte *pc)
{
...
GLvoid __glXDisp_ColorSubTable(GLbyte *pc)
{
...
GLvoid __glXDisp_ConvolutionFilter1D(GLbyte *pc)
{
...
GLvoid __glXDisp_ConvolutionFilter2D(GLbyte *pc)
{
   __GLXdispatchConvolutionFilterHeader *hdr =
                 (__GLXdispatchConvolutionFilterHeader *) pc;
...
GLvoid __glXDisp_SeparableFilter2D(GLbyte *pc)
{
   __GLXdispatchConvolutionFilterHeader *hdr =
                (__GLXdispatchConvolutionFilterHeader *) pc;
