...
GLvoid __glXDisp_Map1f(GLbyte *pc)
{
    GLint order, k;
...
GLvoid __glXDisp_Map2f(GLbyte *pc)
{
...
GLvoid __glXDisp_Map1d(GLbyte *pc)
{
    GLint order, k;
#ifdef __GLX_ALIGN64
    GLint compsize;
...
GLvoid __glXDisp_Map2d(GLbyte *pc)
{
...
GLvoid __glXDisp_CallLists(GLbyte *pc)
{
    GLenum type;
    GLsizei n;
...
GLvoid __glXDisp_DrawArrays(GLbyte *pc)
{
...
GLvoid __glXDisp_DrawArraysEXT(GLbyte *pc)
{
