...
** Dispatch tables.
*/
typedef GLvoid (*__GLXdispatchRenderProcPtr)(GLbyte *);
...
extern GLvoid __glXSwapMakeCurrentReply(ClientPtr client,
                      xGLXMakeCurrentReply *reply);
extern GLvoid __glXSwapIsDirectReply(ClientPtr client,
                   xGLXIsDirectReply *reply);
extern GLvoid __glXSwapQueryVersionReply(ClientPtr client,
                       xGLXQueryVersionReply *reply);
extern GLvoid __glXSwapQueryContextInfoEXTReply(ClientPtr client,
                          xGLXQueryContextInfoEXTReply *reply,
                          int *buf);
extern GLvoid glxSwapQueryExtensionsStringReply(ClientPtr client,
                xGLXQueryExtensionsStringReply *reply, char *buf);
extern GLvoid glxSwapQueryServerStringReply(ClientPtr client,
