...
{
    HALNativeDisplayType display = gcvNULL;
    gcoOS_GetDisplay(&display, gcvNULL);
    ...
    )
{
    ...
    if (Surface->openVG)
    {
            ...
            (info->type != gcvSURF_BITMAP))
        {
            ...
            status = gcoOS_SetWindowFormat((HALNativeDisplayType) Display->hdc,
                                           (HALNativeWindowType) win,
                                           gcvSURF_BITMAP,
                                           format);
    ...
    )
{
    ...
    info->hdc          = (HALNativeDisplayType) Display->hdc;
