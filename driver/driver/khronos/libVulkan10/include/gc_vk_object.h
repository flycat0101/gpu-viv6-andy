...
#define  __VK_OBJECT_DISPLAY_MODE_KHR       (__VK_OBJECT_TYPE_BASE + __VK_DEV_OBJECT_COUNT + 5)
#define  __VK_OBJECT_TYPE_DEBUG_CB_EXT      (__VK_OBJECT_TYPE_BASE + __VK_DEV_OBJECT_COUNT + 6)
