    ...
    )
{
 ...
 29:29) - (0 ?
 29:29) + 1))))))) << (0 ?
 29:29))) | (((gctUINT32) ((gctUINT32) (txDesc->fast_filter && ((samplerDesc->halti3.anisoLog == 0) || txDesc->isCubmap)) & ((gctUINT32) ((((1 ?
 29:29) - (0 ?
 29:29) + 1) == 32) ?
 ~0U : (~(~0U << ((1 ? 29:29) - (0 ? 29:29) + 1))))))) << (0 ? 29:29))));
    ...
    )
{
    ...
    if (srcRes->isImage)
    {
        ...
        __VK_MEMCOPY(&tmpFormatInfo, &g_vkFormatInfoTable[pSrcImg->formatInfo.residentImgFormat], sizeof(tmpFormatInfo));
    ...
    else
    {
        ...
        tmpBufView.formatInfo = g_vkFormatInfoTable[pDstImg->createInfo.format];
    ...
    )
{
    ...
    if (dstRes->isImage)
    {
        ...
        __VK_MEMCOPY(&tmpFormatInfo, &g_vkFormatInfoTable[pDstImg->formatInfo.residentImgFormat], sizeof(tmpFormatInfo));
