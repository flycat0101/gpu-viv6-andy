    ...
    )
{
    glmENTER2(glmARGFLOAT, Value, glmARGUINT, Invert)
    {
        ...
        context->multisampleStates.coverageValue = glmFLOATCLAMP_0_TO_1(Value);
    ...
    )
{
    glmENTER2(glmARGFIXED, Value, glmARGUINT, Invert)
    {
        ...
        /* Convert to float */
        value = glmFLOATCLAMP_0_TO_1(glmFIXED2FLOAT(Value));

        context->multisampleStates.coverageValue = value;
        context->multisampleStates.coverageInvert = Invert;
    }
    glmLEAVE();
}
