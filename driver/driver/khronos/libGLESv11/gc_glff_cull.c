    ...
    )
{
    ...
    if ((Context->drawYInverted) && (mode != gcvCULL_NONE))
    {
    ...
    )
{
    ...
    if(Context->reprogramCulling)
    {
        status = _ProgramCulling(Context);
        Context->reprogramCulling = gcvFALSE;
    }
    ...
    case GL_CCW:
        ...
        if(Context->drawYInverted)
        {
            Context->hashKey.hashClockwiseFront =
                Context->cullStates.clockwiseFront = (FrontFace == GL_CW);
        }
        else
        {
...
/*******************************************************************************
**
**  glfFlushCullingStates
**
**  Flush culling states.
**
**  INPUT:
**
**      Context
...
gceSTATUS glfFlushCullingStates(
    glsCONTEXT_PTR Context
    )
{
    GLenum result;
    ...
    /* Flush culling. */
    result = glmTRANSLATEGLRESULT(_ProgramCulling(Context));
