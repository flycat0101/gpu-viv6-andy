    ...
    )
{
    ...
    gctFLOAT * pattern;
    gctFLOAT length;
    vgmENTERSUBAPI(_InitializeStrokeParameters);
    if (count == 0)
    {
        status = gcvSTATUS_OK;
        break;
    ...
    gcmERR_GOTO(gcoOS_Allocate(StrokeConversion->os,count * gcmSIZEOF(gctFLOAT),(gctPOINTER *) &pattern));
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_InitializeStrokeParameters);
    return status;
}
...
{
    gceSTATUS status = gcvSTATUS_OK;
    vgmENTERSUBAPI(_InitStrokeConversion);
    ...
    gcmERR_BREAK(_InitializeStrokeParameters(Context, StrokeConversion));

    vgmLEAVESUBAPI(_InitStrokeConversion);
    return status;
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(_CheckScaleAndBias);
    /* Get the matrix. */
    ...
    vgmLEAVESUBAPI(_CheckScaleAndBias);
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(_CheckInputPath);
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_CheckInputPath);
    return status;
}
#endif
...
{
    gceSTATUS status = gcvSTATUS_OK;
    vgmENTERSUBAPI(_AddSubPath);

    gcmERR_BREAK(_CAllocateSubPath(StrokeConversion->subPathMemPool, SubPath));
...
{
    vgmENTERSUBAPI(_SetPointTangent);
    if (Dx == 0.0f)
    {
        if (Dy == 0.0f)
        {
    ...
    vgmLEAVESUBAPI(_SetPointTangent);
}
    ...
    )
{
    ...
    vgsPOINT_PTR point;
    vgmENTERSUBAPI(_AddPointToSubPathWDelta);
    gcmERR_BREAK(_AllocatePoint(StrokeConversion->pointMemPool, &point));
    ...
    gcmASSERT(lastPoint);
    _SetPointTangent(Context, lastPoint, DX, DY);
    ...
    vgmLEAVESUBAPI(_AddPointToSubPathWDelta);
    return status;
}
    ...
    )
{
    ...
    vgsPOINT_PTR lastPoint = SubPath->lastPoint;
    vgsPOINT_PTR point;
    vgmENTERSUBAPI(_AddPointToSubPath);
    ...
    else
    {
        ...
        status = _AddPointToSubPathWDelta(Context, StrokeConversion, X, Y, dX, dY, SubPath, FlattenFlag);
    }


    vgmLEAVESUBAPI(_AddPointToSubPath);
    return status;
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(_FlattenQuadBezier);
    ...
    */
    ...
    gcmERR_GOTO(_AddPointToSubPath(Context, StrokeConversion, X1, Y1, SubPath, vgcFLATTEN_START));
        ...
        */
        ...
        if (ratioX > 1.0e-6f && ratioY > 1.0e-6f)
        {
            ...
            for (i = 1; i < n; i++)
            {
                ...
                gcmERR_GOTO(_AddPointToSubPathWDelta(Context, StrokeConversion, x, y, dx, dy, SubPath, vgcFLATTEN_MIDDLE));
        ...
        else
        {
            for (i = 1; i < n; i++)
            {
                ...
                /* Add a point to subpath. */
                gcmERR_GOTO(_AddPointToSubPath(Context, StrokeConversion, x, y, SubPath, vgcFLATTEN_MIDDLE));
            }
        }
    }
    ...
    gcmERR_GOTO(_AddPointToSubPath(Context, StrokeConversion, X2, Y2, SubPath, vgcFLATTEN_END));
    ...
    gcmERR_GOTO(_AddPointToSubPath(Context, StrokeConversion, X2, Y2, SubPath, vgcFLATTEN_NO));
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_FlattenQuadBezier);
    return status;
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(_FlattenCubicBezier);
    VGSL_STAT_COUNTER_INCREASE(vgStrokeCurveCount);
    ...
    */
    ...
    {
        gcmERR_GOTO(_AddPointToSubPath(Context, StrokeConversion, X2, Y2, SubPath, vgcFLATTEN_START));
    }
    else
    {
        gcmERR_GOTO(_AddPointToSubPath(Context, StrokeConversion, X3, Y3, SubPath, vgcFLATTEN_START));
    }
    point1 = SubPath->lastPoint;
    /* Change the point1's coordinates back to P0. */
    point1->x = X0;
    ...
    gcmERR_GOTO(_AddPointToSubPath(Context, StrokeConversion, X3, Y3, SubPath, vgcFLATTEN_END));
    ...
    gcmERR_GOTO(_AddPointToSubPath(Context, StrokeConversion, X3, Y3, SubPath, vgcFLATTEN_NO));
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_FlattenCubicBezier);
    return status;
}
    ...
    )
{
    ...
    /* Add a subpath. */
    gcmERR_GOTO(_AddSubPath(Context, StrokeConversion, &subPath));
    ...
    while (currentPath)
    {
            ...
            (*dataPointer != gcvVGCMD_MOVE))
        {
            ...
            gcmERR_GOTO(_AddPointToSubPath(Context, StrokeConversion, sx, sy, subPath, vgcFLATTEN_NO));
        }
        ...
        while (size > 0)
        {
            ...
            case gcvVGCMD_MOVE:        /* Indicate the beginning of a new sub-path. */
                    ...
                    && prevCommand != gcvVGCMD_CLOSE)
                {
                    ...
                    /* Add first point to subpath. */
                    gcmERR_GOTO(_AddPointToSubPath(Context, StrokeConversion, x0, y0, subPath, vgcFLATTEN_NO));
                }
            ...
            case gcvVGCMD_QUAD:
                ...
                else if ((ox == x0 && oy == y0) || (x0 == x1 && y0 == y1))
                {
                    ...
                    /* Add a point to subpath. */
                    gcmERR_GOTO(_AddPointToSubPath(
                        Context, StrokeConversion, x1, y1, subPath, vgcFLATTEN_NO
                        ));
                }
                else
                {
                    gcmERR_GOTO(_FlattenQuadBezier(
                        Context, StrokeConversion, ox, oy, x0, y0, x1, y1, subPath
                        ));
                }
            ...
            case gcvVGCMD_CUBIC:
                ...
                {
                    gcmERR_GOTO(_FlattenCubicBezier(
                        Context, StrokeConversion, ox, oy, x0, y0, x1, y1, x2, y2, subPath
                        ));
                }
...
{
    vgmENTERSUBAPI(_IsAngleSpanAcute);
    vgmLEAVESUBAPI(_IsAngleSpanAcute);
    ...
    )
{
    ...
    vgmENTERSUBAPI(_ConvertCircleArc);
    /* Converting. */
    gcmASSERT(PointList);
    gcmASSERT(StartX != CenterX || StartY != CenterY);
    theta1 = _Angle(Context, StartX - CenterX, StartY - CenterY, Radius);
    if (HalfCircle)
    {
        thetaSpan = FLOAT_PI;
        segs = 4;
    ...
    else
    {
        ...
        thetaSpan = _Angle(Context, EndX - CenterX, EndY - CenterY, Radius) - theta1;
        if (thetaSpan == 0.0f)
        {
    ...
    while (segs-- > 0)
    {
        ...
        controlY = CenterY + _Sine(theta2) * controlRatio;
        ...
        /* Add control point. */
        gcmERR_GOTO(_AllocatePoint(StrokeConversion->pointMemPool, &point));
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_ConvertCircleArc);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status = gcvSTATUS_OK;
    vgmENTERSUBAPI(_AddStrokeSubPath);
    ...
    vgmLEAVESUBAPI(_AddStrokeSubPath);
    return status;
}
    ...
    )
{
    gceSTATUS status = gcvSTATUS_OK;
    vgsPOINT_PTR point;
    vgmENTERSUBAPI(_AddAPointToRightStrokePointListTail);
    gcmERR_BREAK(_AllocatePoint(StrokeConversion->pointMemPool, &point));
    ...
    vgmLEAVESUBAPI(_AddAPointToRightStrokePointListTail);
    return status;
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(_AddAPointToLeftStrokePointListHead);
    gcmERR_BREAK(_AllocatePoint(StrokeConversion->pointMemPool, &point));
    ...
    vgmLEAVESUBAPI(_AddAPointToLeftStrokePointListHead);
    return status;
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(_AddZeroLengthStrokeSubPath);
    ...
    gcmERR_GOTO(_AddStrokeSubPath(Context, StrokeConversion, &strokeSubPath));
    ...
    if (StrokeConversion->strokeCapStyle == gcvCAP_SQUARE)
    {
        ...
        gcmERR_GOTO(_AllocatePoint(StrokeConversion->pointMemPool, &newPoint));
        ...
        gcmERR_GOTO(_AddAPointToRightStrokePointListTail(Context, StrokeConversion,
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_AddZeroLengthStrokeSubPath);
    return status;
}
    ...
    )
{
    ...
    vgsSUBPATH_PTR strokeSubPath;
    vgsPOINT_PTR newPoint;
    vgmENTERSUBAPI(_StartANewStrokeSubPath);
    gcmERR_GOTO(_AddStrokeSubPath(Context, StrokeConversion, &strokeSubPath));
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_StartANewStrokeSubPath);
    return status;
}
...
{
    gceSTATUS status = gcvSTATUS_OK;
    vgmENTERSUBAPI(_EndAStrokeSubPath);

    /* Add points for end of line. */
    gcmERR_BREAK(_AddAPointToRightStrokePointListTail(Context, StrokeConversion, X + Dx, Y + Dy));
    gcmERR_BREAK(_AddAPointToLeftStrokePointListHead(Context, StrokeConversion, X - Dx, Y - Dy));
    ...
    vgmLEAVESUBAPI(_EndAStrokeSubPath);
    return status;
}
...
{
    vgmENTERSUBAPI(_GetNextDashLength);
    ...
    *DashLength = StrokeConversion->strokeDashPattern[*DashIndex];
    ...
    vgmLEAVESUBAPI(_GetNextDashLength);
}
...
{
    gceSTATUS status = gcvSTATUS_OK;
    vgmENTERSUBAPI(_DrawSwingPieArea);
    ...
    if (StrokeConversion->swingCounterClockwise)
    {
...
#endif
        {
            ...
            gcmERR_GOTO(_AddAPointToLeftStrokePointListHead(Context, StrokeConversion,
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_DrawSwingPieArea);
    return status;
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(_AdjustJointPoint);
    ...
    vgmLEAVESUBAPI(_AdjustJointPoint);
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(_ProcessLineJoint);
    ...
    if (cosTheta > FLOAT_ANGLE_EPSILON_COS)
    {
        ...
        if (StrokeConversion->swingHandling != vgcSWING_NO)
        {
            ...
            gcmERR_GOTO(_DrawSwingPieArea(Context, StrokeConversion, Point->prev, gcvTRUE));
        }

        /* Add the new stroke points. */
        gcmERR_GOTO(_AddAPointToRightStrokePointListTail(Context, StrokeConversion, X1, Y1));
        gcmERR_GOTO(_AddAPointToLeftStrokePointListHead(Context, StrokeConversion, X2, Y2));
        if (StrokeConversion->swingHandling != vgcSWING_NO)
        {
    ...
    if (counterClockwise)
    {
        if (StrokeConversion->swingHandling != vgcSWING_NO)
        {
            ...
            if (_IsAngleSpanAcute(Context, StrokeConversion->swingStrokeDeltaX,
            ...
            && minLengthSquare <= PrevLength * PrevLength)
        {
            ...
            _AdjustJointPoint(Context, Point, StrokeConversion->leftStrokePoint, X2, Y2, ratio);
        }
        ...
        else
        {
            if (StrokeConversion->swingHandling == vgcSWING_NO)
            {
                ...
                gcmERR_GOTO(_AddAPointToLeftStrokePointListHead(Context, StrokeConversion, prevPoint->x, prevPoint->y));
        ...
        case gcvJOIN_MITER:
            if (ratio <= StrokeConversion->strokeMiterLimitSquare)
            {
                ...
                _AdjustJointPoint(Context, Point, StrokeConversion->lastRightStrokePoint, X1, Y1, ratio);
                break;
            }
    ...
    else
    {
        ...
        else
        {
            if (StrokeConversion->swingHandling == vgcSWING_NO)
            {
                ...
                /* Add extra start stroke point for swing out pie area. */
                gcmERR_GOTO(_AddAPointToRightStrokePointListTail(Context, StrokeConversion, prevPoint->x, prevPoint->y));
...
endCheck:
    ...
    if (StrokeConversion->swingHandling != vgcSWING_NO)
    {
        ...
        {
            /* Draw the swing area (pie area). */
            gcmERR_GOTO(_DrawSwingPieArea(Context, StrokeConversion, Point, gcvFALSE));
        }
        else
        {
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_ProcessLineJoint);
    return status;
}
...
{
    gceSTATUS status = gcvSTATUS_OK;
    vgmENTERSUBAPI(_CloseAStrokeSubPath);


    /* Handle line joint style for the first/last point in closed path. */
    gcmERR_BREAK(_ProcessLineJoint(
        Context,
    ...
    vgmLEAVESUBAPI(_CloseAStrokeSubPath);
    return status;
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(_CreateStrokePath);
    ...
    for (subPath = StrokeConversion->subPathList; subPath; subPath = subPath->next)
    {
        ...
        if (nextPoint == gcvNULL)
        {
            if (!dashing || ((dashIndex & 0x1) == 0))
            {
                ...
                gcmERR_GOTO(_AddZeroLengthStrokeSubPath(Context, StrokeConversion, point));
            }
            continue;
        }
        ...
        /* Set addEndCap. */
        addEndCap = dashing ? gcvTRUE: (subPath->closed ? gcvFALSE : gcvTRUE);
        ...
        if (dashing)
        {
            ...
            do
            {
                if ((dashIndex & 0x1) == 0)
                {
                    gcmERR_GOTO(_StartANewStrokeSubPath(
                        Context,
                        StrokeConversion,
                        x, y,
                        dx, dy, addEndCap,
                ...
                if (deltaLength >= FLOAT_EPSILON)
                {
                    ...
                    {
                        gcmASSERT(drawing);
                        gcmERR_GOTO(_EndAStrokeSubPath(
                                        Context,
                                        StrokeConversion,
                                        x, y,
                                        dx, dy
                    ...
                    _GetNextDashLength(Context, StrokeConversion, &dashIndex, &dashLength);
             ...
             point = nextPoint, nextPoint = point->next)
        {
            ...
            if (!dashing)
            {
                ...
                gcmERR_GOTO(_ProcessLineJoint(
                    Context, StrokeConversion, point,
                    length, prevLength, swingHandling,
                    point->x + dx, point->y + dy,
                    point->x - dx, point->y - dy
                    ));
        ...
        if (StrokeConversion->swingHandling != vgcSWING_NO)
        {
            ...
            /* Draw the swing area (pie area). */
            gcmERR_GOTO(_DrawSwingPieArea(Context, StrokeConversion, subPath->lastPoint, gcvFALSE));
        }
        ...
        if (subPath->closed)
        {
            if (! dashing || drawing)
            {
                ...
                {
                    /* Handle line joint style for the first/last point in closed path. */
                    gcmERR_GOTO(_CloseAStrokeSubPath(
                        Context, StrokeConversion, point,
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_CreateStrokePath);
    return status;
}
    ...
    )
{
    ...
    gctUINT offset = 0;
    vgmENTERSUBAPI(_OutputPath);

    gcmERR_BREAK(gcoOS_Open(os, PATH_LOG_FILENAME, gcvFILE_CREATETEXT, &logFile));
...
{
    vgmENTERSUBAPI(_SetPointTangent_I);
    if (Dx == FIXED_ZERO)
    {
        if (Dy == FIXED_ZERO)
        {
    ...
    vgmLEAVESUBAPI(_SetPointTangent_I);
}
    ...
    )
{
    ...
    vgsPOINT_I_PTR point;
    vgmENTERSUBAPI(_AddPointToSubPathWDelta_I);

    gcmERR_BREAK(_AllocatePoint(StrokeConversion->pointMemPool, (vgsPOINT_PTR *) &point));
    ...
    /* Calculate tangent for lastPoint. */
    gcmASSERT(lastPoint);
    _SetPointTangent_I(Context, lastPoint, DX, DY);
    ...
    vgmLEAVESUBAPI(_AddPointToSubPathWDelta_I);
    return status;
}
    ...
    )
{
    ...
    vgsPOINT_I_PTR lastPoint = SubPath->lastPoint;
    vgsPOINT_I_PTR point;
    vgmENTERSUBAPI(_AddPointToSubPath_I);
    ...
    else
    {
        ...
        status = _AddPointToSubPathWDelta_I(Context, StrokeConversion, X, Y, dX, dY, SubPath, FlattenFlag);
    }

    vgmLEAVESUBAPI(_AddPointToSubPath_I);
    return status;
}
    ...
    )
{
    ...
    vgsPOINT_I_PTR lastPoint;
    vgsPOINT_I_PTR point;
    vgmENTERSUBAPI(_FastAddPointToSubPathWDelta_I);
    /* Check for degenerated line. */
    ...
    vgmLEAVESUBAPI(_FastAddPointToSubPathWDelta_I);
    return status;
}
    ...
    )
{
    gceSTATUS status = gcvSTATUS_OK;
    vgsPOINT_I_PTR lastPoint = SubPath->lastPoint;
    vgmENTERSUBAPI(_FastAddPointToSubPath_I);
    if (lastPoint == gcvNULL)
    {
        vgsPOINT_I_PTR point;
    ...
    {
        status = _FastAddPointToSubPathWDelta_I(Context, StrokeConversion,
            X, Y, X - lastPoint->x, Y - lastPoint->y, SubPath);
        break;
    }

    vgmLEAVESUBAPI(_FastAddPointToSubPath_I);
    return status;
}
#endif
    ...
    )
{
    ...
    vgmENTERSUBAPI(_FlattenQuadBezier_I);
    if (delta1 == FIXED_ZERO)
    {
        ...
        else
        {
            /* Degenerated Bezier curve.  Becomes a line. */
            /* Add a point to subpath. */
            status = _AddPointToSubPath_I(Context, StrokeConversion, X2, Y2, SubPath, vgcFLATTEN_NO);
            break;
        }
    }
    ...
    */
    ...
    gcmASSERT(point0);
    /* First add P1 to calculate incoming tangent, which is saved in P0. */
    gcmERR_GOTO(_AddPointToSubPath_I(Context, StrokeConversion, X1, Y1, SubPath, vgcFLATTEN_START));
    point1 = SubPath->lastPoint;
    /* Change the point1's coordinates back to P0. */
    point1->x = X0;
    point1->y = Y0;
    ...
    if (n == 2)
    {
        ...
        x = (X0 + X1 + X1 + X2) >> 2;
        y = (Y0 + Y1 + Y1 + Y2) >> 2;
        gcmERR_GOTO(_AddPointToSubPath_I(Context, StrokeConversion, x, y, SubPath, vgcFLATTEN_MIDDLE));
    }
    else if (n > 1)
    {
        ...
        */
        ...
        for (i = 1; i < n; i++)
        {
            ...
            /* Add a point to subpath. */
            gcmERR_GOTO(_AddPointToSubPathWDelta_I(Context, StrokeConversion,
    ...
    /* Add point 2 separately to avoid cumulative errors. */
    gcmERR_GOTO(_AddPointToSubPath_I(Context, StrokeConversion, X2, Y2, SubPath, vgcFLATTEN_END));
    ...
    /* Add P2 to calculate outgoing tangent. */
    gcmERR_GOTO(_AddPointToSubPath_I(Context, StrokeConversion, X2, Y2, SubPath, vgcFLATTEN_NO));
    point1 = SubPath->lastPoint;
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_FlattenQuadBezier_I);
    return status;
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(_FlattenCubicBezier_I);
    ...
    */
    ...
    {
        gcmERR_GOTO(_AddPointToSubPath_I(Context, StrokeConversion, X2, Y2, SubPath, vgcFLATTEN_START));
    }
    else
    {
        gcmERR_GOTO(_AddPointToSubPath_I(Context, StrokeConversion, X3, Y3, SubPath, vgcFLATTEN_START));
    }
    point1 = SubPath->lastPoint;
    /* Change the point1's coordinates back to P0. */
    point1->x = X0;
    ...
    /* Add point 3 separately to avoid cumulative errors. */
    gcmERR_GOTO(_AddPointToSubPath_I(Context, StrokeConversion, X3, Y3, SubPath, vgcFLATTEN_END));
    ...
    /* Add P3 to calculate outgoing tangent. */
    gcmERR_GOTO(_AddPointToSubPath_I(Context, StrokeConversion, X3, Y3, SubPath, vgcFLATTEN_NO));
    point1 = SubPath->lastPoint;
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_FlattenCubicBezier_I);
    return status;
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(_FastFlattenQuadBezier_I);
    ...
    if (delta1 == FIXED_ZERO)
    {
        ...
        else
        {
            /* Degenerated Bezier curve.  Becomes a line. */
            /* Add a point to subpath. */
            status = _FastAddPointToSubPath_I(Context, StrokeConversion, X2, Y2, SubPath);
            break;
        }
    }
    else if (delta2 == FIXED_ZERO)
  ...
  AddLines:
    ...
    if (n == 2)
    {
        ...
        x = (X0 + X1 + X1 + X2) >> 2;
        y = (Y0 + Y1 + Y1 + Y2) >> 2;
        gcmERR_GOTO(_FastAddPointToSubPath_I(Context, StrokeConversion, x, y, SubPath));
    }
    else if (n > 1)
    {
        gctINT dShift, dsquareShift;
        ...
        for (i = 1; i < n; i++)
        {
            ...
            /* Add a point to subpath. */
            gcmERR_GOTO(_FastAddPointToSubPathWDelta_I(Context, StrokeConversion,
                x, y, dx, dy, SubPath));
    ...
    /* Add point 2 separately to avoid cumulative errors. */
    gcmERR_GOTO(_FastAddPointToSubPath_I(Context, StrokeConversion, X2, Y2, SubPath));

ErrorHandler:
    break;

    vgmLEAVESUBAPI(_FastFlattenQuadBezier_I);
    return status;
}
...
{
    gceSTATUS status = gcvSTATUS_OK;
    vgmENTERSUBAPI(_FastFlattenCubicBezier_I);
    {
    gctINT n;
    gctFIXED a1x, a1y, a2x, a2y, a3x, a3y;
    gctINT nShift;
  ...
  AddLines:
    ...
    /* Add point 3 separately to avoid cumulative errors. */
    gcmERR_GOTO(_FastAddPointToSubPath_I(Context, StrokeConversion, X3, Y3, SubPath));

ErrorHandler:
    break;
    }
    vgmLEAVESUBAPI(_FastFlattenCubicBezier_I);
    return status;
}
#endif
...
{
    gceSTATUS status = gcvSTATUS_OK;
    vgmENTERSUBAPI(_GetValueGetter_I);
    /* Select the data picker. */
    switch (DataType)
    {
    case gcePATHTYPE_INT8:
    ...
    vgmLEAVESUBAPI(_GetValueGetter_I);
    return status;
}
    ...
    )
{
    ...
    /* Add a subpath. */
    gcmERR_GOTO(_AddSubPath(Context, StrokeConversion, (vgsSUBPATH_PTR *) &subPath));
    ...
    while (currentPath)
    {
        ...
        /* Select the data picker. */
        gcmERR_GOTO(_GetValueGetter_I(Context, currentPath->data.dataType,
        ...
        {
            /* Add first point to subpath. */
            gcmERR_GOTO(_AddPointToSubPath_I(Context, StrokeConversion, sx, sy, subPath, vgcFLATTEN_NO));
        }
        ...
        while (size > 0)
        {
            ...
            case gcvVGCMD_MOVE:        /* Indicate the beginning of a new sub-path. */
                    ...
                    &&prevCommand != gcvVGCMD_CLOSE)
                {
                    ...
                    /* Add first point to subpath. */
                    gcmERR_GOTO(_AddPointToSubPath_I(Context, StrokeConversion, x0, y0, subPath, vgcFLATTEN_NO));
                }
                else if (subPath->pointCount == 0)
                {
                    /* First command is gcvVGCMD_MOVE. */
            ...
            case gcvVGCMD_QUAD:
                ...
                gcmERR_GOTO(_FlattenQuadBezier_I(
                    Context, StrokeConversion, ox, oy, x0, y0, x1, y1, subPath
                    ));
            ...
            case gcvVGCMD_CUBIC:
                ...
                gcmERR_GOTO(_FlattenCubicBezier_I(
                    Context, StrokeConversion, ox, oy, x0, y0, x1, y1, x2, y2, subPath
                    ));
    ...
    )
{
    ...
    vgmENTERSUBAPI(_FastFlattenPath_I);
    ...
    while (currentPath)
    {
        ...
        {
            /* Add first point to subpath. */
            gcmERR_GOTO(_FastAddPointToSubPath_I(Context, StrokeConversion, sx, sy, subPath));
        }
        ...
        while (size > 0)
        {
            ...
            case gcvVGCMD_MOVE:        /* Indicate the beginning of a new sub-path. */
                    ...
                    &&prevCommand != gcvVGCMD_CLOSE)
                {
                    ...
                    /* Add first point to subpath. */
                    gcmERR_GOTO(_FastAddPointToSubPath_I(Context, StrokeConversion, x0, y0, subPath));
                }
                else if (subPath->pointCount == 0)
                {
                    /* First command is gcvVGCMD_MOVE. */
            ...
            case gcvVGCMD_QUAD:
                ...
                gcmERR_GOTO(_FastFlattenQuadBezier_I(
                    Context, StrokeConversion, ox, oy, x0, y0, x1, y1, subPath
                    ));
            ...
            case gcvVGCMD_CUBIC:
                ...
                gcmERR_GOTO(_FastFlattenCubicBezier_I(
                    Context, StrokeConversion, ox, oy, x0, y0, x1, y1, x2, y2, subPath
                    ));
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_FastFlattenPath_I);
    return status;
}
#endif
    ...
    )
{
    ...
    gctFLOAT one = (gctFLOAT) (1 << (FIXED_FRACTION_BITS - StrokeConversion->internalShiftBits));
    gctFLOAT max;
    vgmENTERSUBAPI(_ConvertParameters);
...
#endif
    vgmLEAVESUBAPI(_ConvertParameters);
}
...
{
    vgmENTERSUBAPI(_IsAngleSpanAcute_I);
    vgmLEAVESUBAPI(_IsAngleSpanAcute_I);
    ...
    )
{
    ...
    vgmENTERSUBAPI(_ConvertCircleArc_I);
    /* Converting. */
    gcmASSERT(PointList);
    gcmASSERT(StartX != CenterX || StartY != CenterY);
    theta1 = _Angle_I(Context, StartX - CenterX, StartY - CenterY, Radius);
    if (HalfCircle)
    {
        thetaSpan = FIXED_PI;
        segs = 4;
    ...
    {
        gcmASSERT(EndX != CenterX || EndY != CenterY);
        thetaSpan = _Angle_I(Context, EndX - CenterX, EndY - CenterY, Radius) - theta1;
    ...
    while (segs-- > 0)
    {
        ...
        /* Add control point. */
        gcmERR_GOTO(_AllocatePoint(StrokeConversion->pointMemPool, (vgsPOINT_PTR *) &point));
...
ErrorHandler:
    break;
    vgmLEAVESUBAPI(_ConvertCircleArc_I);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status = gcvSTATUS_OK;
    vgmENTERSUBAPI(_AddStrokeSubPath_I);

    gcmERR_BREAK(_CAllocateSubPath(StrokeConversion->subPathMemPool, (vgsSUBPATH_PTR *) SubPath));
    ...
    vgmLEAVESUBAPI(_AddStrokeSubPath_I);
    return status;
}
    ...
    )
{
    gceSTATUS status = gcvSTATUS_OK;
    vgsPOINT_I_PTR point;
    vgmENTERSUBAPI(_AddAPointToRightStrokePointListTail_I);
    gcmERR_BREAK(_AllocatePoint(StrokeConversion->pointMemPool, (vgsPOINT_PTR *) &point));
    ...
    vgmLEAVESUBAPI(_AddAPointToRightStrokePointListTail_I);
    return status;
}
    ...
    )
{
    gceSTATUS status = gcvSTATUS_OK;
    vgsPOINT_I_PTR point;
    vgmENTERSUBAPI(_AddAPointToLeftStrokePointListHead_I);
    gcmERR_BREAK(_AllocatePoint(StrokeConversion->pointMemPool, (vgsPOINT_PTR *) &point));
    ...
    vgmLEAVESUBAPI(_AddAPointToLeftStrokePointListHead_I);
    return status;
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(_AddZeroLengthStrokeSubPath_I);
    ...
    gcmERR_GOTO(_AddStrokeSubPath_I(Context, StrokeConversion, &strokeSubPath));
    ...
    if (StrokeConversion->strokeCapStyle == gcvCAP_SQUARE || StrokeConversion->useFastMode)
    {
        ...
        gcmERR_GOTO(_AllocatePoint(StrokeConversion->pointMemPool, (vgsPOINT_PTR *) &newPoint));
        ...
        gcmERR_GOTO(_AddAPointToRightStrokePointListTail_I(Context, StrokeConversion,
            Point->x + dx - dy, Point->y + dx + dy));
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_AddZeroLengthStrokeSubPath_I);
    return status;
}
    ...
    )
{
    ...
    vgsSUBPATH_I_PTR strokeSubPath;
    vgsPOINT_I_PTR newPoint;
    vgmENTERSUBAPI(_StartANewStrokeSubPath_I);
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_StartANewStrokeSubPath_I);
    return status;
}
...
{
    gceSTATUS status = gcvSTATUS_OK;
    vgmENTERSUBAPI(_EndAStrokeSubPath_I);

      /* Add points for end of line. */
    gcmERR_BREAK(_AddAPointToRightStrokePointListTail_I(Context, StrokeConversion,
                                        X + Dx, Y + Dy));
    gcmERR_BREAK(_AddAPointToLeftStrokePointListHead_I(Context, StrokeConversion,
                                        X - Dx, Y - Dy));
    ...
    /*gcmERR_BREAK(_CheckStrokeSubPath(StrokeConversion->lastStrokeSubPath));*/

    vgmLEAVESUBAPI(_EndAStrokeSubPath_I);
    return status;
}
...
{
    vgmENTERSUBAPI(_GetNextDashLength_I);
    (*DashIndex)++;
    if (*DashIndex == StrokeConversion->strokeDashPatternCount)
    {
        *DashIndex = 0;
    ...
    *DashLength = StrokeConversion->strokeDashPattern[*DashIndex];
    vgmLEAVESUBAPI(_GetNextDashLength_I);
}
...
{
    gceSTATUS status = gcvSTATUS_OK;
    vgmENTERSUBAPI(_DrawSwingPieArea_I);
    ...
    /*gcmONERROR(_CheckLastStrokeSubPathPartial(StrokeConversion));*/
    ...
    if (StrokeConversion->swingCounterClockwise)
    {
...
#endif
        {
            ...
            gcmERR_GOTO(_AddAPointToLeftStrokePointListHead_I(Context, StrokeConversion,
                CenterPoint->x, CenterPoint->y));
            endPoint = StrokeConversion->leftStrokePoint;
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_DrawSwingPieArea_I);
    return status;
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(_AdjustJointPoint_I);
    ...
    vgmLEAVESUBAPI(_AdjustJointPoint_I);
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(_ProcessLineJoint_I);
    ...
    if (cosTheta >= FIXED_ANGLE_EPSILON_COS)
    {
        ...
        if (StrokeConversion->swingHandling != vgcSWING_NO)
        {
            /* Begin to swing to the opposite direction. */
            /* Draw the swing area (pie area). */
            gcmERR_GOTO(_DrawSwingPieArea_I(Context, StrokeConversion, Point->prev, gcvTRUE));
        }

        /* Add the new stroke points. */
        gcmERR_GOTO(_AddAPointToRightStrokePointListTail_I(Context, StrokeConversion, X1, Y1));
        gcmERR_GOTO(_AddAPointToLeftStrokePointListHead_I(Context, StrokeConversion, X2, Y2));
        if (StrokeConversion->swingHandling != vgcSWING_NO)
        {
            gcmASSERT(Point->flattenFlag == vgcFLATTEN_END);
            StrokeConversion->swingCount++;
    ...
    if (counterClockwise)
    {
        if (StrokeConversion->swingHandling != vgcSWING_NO)
        {
            ...
            if (_IsAngleSpanAcute_I(Context, StrokeConversion->swingStrokeDeltaX,
                                    StrokeConversion->swingStrokeDeltaY,
                                    deltaX, deltaY))
            {
                /* Continue swinging. */
        ...
        {
            /* Adjust leftStrokePoint to the intersection point. */
            _AdjustJointPoint_I(Context, Point, StrokeConversion->leftStrokePoint, X2, Y2, ratio);
        }
        else if (StrokeConversion->swingHandling == vgcSWING_NO && Point->flattenFlag == vgcFLATTEN_NO)
        {
            /* Add the point to avoid incorrect sharp angle. */
        ...
        else
        {
            if (StrokeConversion->swingHandling == vgcSWING_NO)
            {
                ...
                /* Add extra start stroke point for swing out pie area. */
                gcmERR_GOTO(_AddAPointToLeftStrokePointListHead_I(Context, StrokeConversion, prevPoint->x, prevPoint->y));
        ...
        case gcvJOIN_MITER:
            ...
            {
                /* Adjust lastRightStrokePoint to the outer intersection point. */
                _AdjustJointPoint_I(Context, Point, StrokeConversion->lastRightStrokePoint, X1, Y1, ratio);
                break;
            }
            /* Else use Bevel join style. */
        case gcvJOIN_BEVEL:
    ...
    else
    {
        ...
        else
        {
            if (StrokeConversion->swingHandling == vgcSWING_NO)
            {
                ...
                /* Add extra start stroke point for swing out pie area. */
                gcmERR_GOTO(_AddAPointToRightStrokePointListTail_I(Context, StrokeConversion, prevPoint->x, prevPoint->y));
...
endCheck:
    ...
    if (StrokeConversion->swingHandling != vgcSWING_NO)
    {
        ...
        {
            /* Draw the swing area (pie area). */
            gcmERR_GOTO(_DrawSwingPieArea_I(Context, StrokeConversion, Point, gcvFALSE));
        }
        else
        {
            /* Check if center line will move too far. */
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_ProcessLineJoint_I);
    return status;
}
...
{
    gceSTATUS status = gcvSTATUS_OK;
    vgmENTERSUBAPI(_CloseAStrokeSubPath_I);

    /* Handle line joint style for the first/last point in closed path. */
    /* Handle line joint style for the first/last point in closed path. */
    gcmERR_BREAK(_ProcessLineJoint_I(
        Context, StrokeConversion, Point,
        Length, PrevLength, SwingHandling,
        firstStrokePoint->x, firstStrokePoint->y,
        lastStrokePoint->x, lastStrokePoint->y
    ...
    /*gcmERROR_RETURN(_CheckStrokeSubPath(StrokeConversion->lastStrokeSubPath));*/
    vgmLEAVESUBAPI(_CloseAStrokeSubPath_I);
    return status;
}
    ...
    )
{
    ...
    gctBOOL addEndCap;
    gctBOOL needToHandleSwing = gcvTRUE /* (StrokeConversion->strokeCapStyle == gcvCAP_BUTT) */;
    vgmENTERSUBAPI(_CreateStrokePath_I);
    ...
    for (subPath = StrokeConversion->subPathList; subPath; subPath = subPath->next)
    {
        ...
        if (nextPoint == gcvNULL)
        {
            if (!dashing || ((dashIndex & 0x1) == 0))
            {
                /* Single point (zero-length) subpath. */
                /* Note that one-MOVE_TO subpaths are removed during parsing. */
                gcmERR_GOTO(_AddZeroLengthStrokeSubPath_I(Context, StrokeConversion, point));
            }
            continue;
        }
        ...
        if (dashing)
        {
            ...
            do
            {
                if ((dashIndex & 0x1) == 0)
                {
                    gcmERR_GOTO(_StartANewStrokeSubPath_I(
                        Context,
                        StrokeConversion,
                        x, y,
                        dx, dy, addEndCap,
                ...
                if (deltaLength >= FIXED_EPSILON)
                {
                    ...
                    {
                        gcmASSERT(drawing);
                        gcmERR_GOTO(_EndAStrokeSubPath_I(
                            Context,
                            StrokeConversion,
                            x, y,
                            dx, dy
                    ...
                    _GetNextDashLength_I(Context, StrokeConversion, &dashIndex, &dashLength);
                    firstLength = deltaLength;
                }
            ...
            point = nextPoint, nextPoint = point->next)
        {
            ...
            {
                /* Handle line joint style. */
                gcmERR_GOTO(_ProcessLineJoint_I(
                    Context,
                    StrokeConversion, point,
                    length, prevLength, swingHandling,
                    point->x + dx, point->y + dy,
        ...
        if (StrokeConversion->swingHandling != vgcSWING_NO)
        {
            gcmASSERT(StrokeConversion->swingHandling == vgcSWING_NO);
            /* Draw the swing area (pie area). */
            gcmERR_GOTO(_DrawSwingPieArea_I(Context, StrokeConversion, subPath->lastPoint, gcvFALSE));
        }
        ...
        if (subPath->closed)
        {
            if (! dashing || drawing)
            {
                ...
                {
                    /* Handle line joint style for the first/last point in closed path. */
                    gcmERR_GOTO(_CloseAStrokeSubPath_I(
                        Context,
                        StrokeConversion, point,
                        firstLength, prevLength, swingHandling,
                        strokeSubPath->pointList, strokeSubPath->lastPoint
...
ErrorHandler:
    break;
    vgmLEAVESUBAPI(_CreateStrokePath_I);
    return status;
}
    ...
    )
{
    ...
    gctFIXED Dx, Dy;
    vgmENTERSUBAPI(_FastSetPointTangent_I);
    ...
    vgmLEAVESUBAPI(_FastSetPointTangent_I);
}
    ...
    )
{
...
#endif
    vgmENTERSUBAPI(_FastCreateStrokePath_I);
...
#if vgvSTROKE_COPY_OPTIMIZE
    gcmERR_GOTO(vgsPATHWALKER_StartSubpath(
        Context, &stroke, vgmCOMMANDSIZE(2, gctUINT32), gcePATHTYPE_INT32
        ));
#else
    gcmERR_GOTO(vgsPATHWALKER_StartSubpath(
        Context, &stroke, vgmCOMMANDSIZE(2, gctFLOAT), gcePATHTYPE_FLOAT
        ));
#endif

    /* Add to the MRU list. */
    vgsPATHSTORAGE_UpdateMRU(Context, Context->strokeStorage, stroke.tail);
#endif
    ...
    for (subPath = StrokeConversion->subPathList; subPath; subPath = subPath->next)
    {
        ...
        if (nextPoint == gcvNULL)
        {
            ...
            {
                /* Add new command. */
                gcmERR_GOTO(vgsPATHWALKER_WriteCommand(
                    Context, &stroke, gcvVGCMD_MOVE
                    ));
        ...
        /* Process first line. */
        _FastSetPointTangent_I(Context, point);
        /* No need to use 64-bit. */
        ...
        /*
        gcmERR_GOTO(_CopyStrokeSubPath_I(
            Context, StrokeConversion,
...
endOfSubPath:
...
#if gcvUSE_FAST_COPY
    /* Close the path. */
    vgsPATHWALKER_CloseSubpath(Context, &stroke);
    ...
    if (strokePath != gcvNULL)
    {
        ...
        gcmERR_GOTO(gcoVG_FinalizePath(Context->vg, &strokePath->data));
...
ErrorHandler:
    break;
    vgmLEAVESUBAPI(_FastCreateStrokePath_I);
    return status;
}
#endif
    ...
    )
{
    ...
    vgmENTERSUBAPI(_FastProcessLineJoint_I);
    /* First, determine the turn is clockwise or counter-clockwise. */
    ...
    if (cosTheta >= FIXED_MIN_ARC_ANGLE_COS)
    {
        /* Straight line or semi-straight line--no need to handle join. */
        /* Add the new stroke points. */
        gcmERR_GOTO(_AddAPointToRightStrokePointListTail_I(StrokeConversion, X1, Y1));
        gcmERR_GOTO(_AddAPointToLeftStrokePointListHead_I(StrokeConversion, X2, Y2));
    ...
    if (counterClockwise)
    {
        ...
        {
            /* Add the point to avoid incorrect sharp angle. */
            gcmERR_GOTO(_AddAPointToLeftStrokePointListHead_I(StrokeConversion, Point->x, Point->y));
            /* Add the point to form a loop to avoid out-of-bound problem. */
            gcmERR_GOTO(_AddAPointToLeftStrokePointListHead_I(StrokeConversion, X2, Y2));
        }
        else
    ...
    else
    {
        ...
        {
            /* Add the point to avoid incorrect sharp angle. */
            gcmERR_GOTO(_AddAPointToRightStrokePointListTail_I(StrokeConversion, Point->x, Point->y));
            /* Add the point to form a loop to avoid out-of-bound problem. */
            gcmERR_GOTO(_AddAPointToRightStrokePointListTail_I(StrokeConversion, X1, Y1));
        }
        else
...
ErrorHandler:
    break;
    vgmLEAVESUBAPI(_FastProcessLineJoint_I);
    return gcvSTATUS_OK;
}
    ...
    )
{
    ...
    for (subPath = StrokeConversion->subPathList; subPath; subPath = subPath->next)
    {
        ...
        if (nextPoint == gcvNULL)
        {
            /* Single point (zero-length) subpath. */
            /* Note that one-MOVE_TO subpaths are removed during parsing. */
            gcmERR_GOTO(_AddZeroLengthStrokeSubPath_I(StrokeConversion, point));
            continue;
        }
        ...
        for (point = nextPoint, nextPoint = point->next; nextPoint;
             point = nextPoint, nextPoint = point->next)
        {
            gcmERR_GOTO(_AddAPointToRightStrokePointListTail_I(StrokeConversion,
                                point->x + dx, point->y + dy));
            gcmERR_GOTO(_AddAPointToLeftStrokePointListHead_I(StrokeConversion,
                                point->x - dx, point->y - dy));
            ...
            /* Handle line joint style. */
            gcmERR_GOTO(_FastProcessLineJoint_I(
                StrokeConversion, point,
                point->x + dx, point->y + dy,
                point->x - dx, point->y - dy
                ));
        ...
        if (subPath->closed)
        {
            ...
            /*gcmERR_GOTO(_CheckStrokeSubPath(StrokeConversion->lastStrokeSubPath));*/
        }
        else
        {
            /* Add end cap if the subPath is not closed. */
...
ErrorHandler:
    break;
    vgmLEAVESUBAPI(_FastCreateFatStrokePath_I);
    return status;
}
#endif
...
#else
#define VGSL_SETCOORD(X, Y) \
        Stroke->set(Context, Stroke, X); \
        Stroke->set(Context, Stroke, Y)
#endif
...
#endif
    vgmENTERSUBAPI(_CopyStrokeSubPath);
    ...
    while (subPath)
    {
        ...
        for (point = point->next; point; prevPoint = point, point = point->next)
        {
            ...
            else if (point->curveType == vgcCURVE_QUAD_CONTROL)
            {
                /* Add new command. */
                gcmERR_GOTO(vgsPATHWALKER_WriteCommand(
                    Context, Stroke, gcvVGCMD_ARC_QUAD
                    ));
                ...
                Stroke->set(Context, Stroke, point->x);
                Stroke->set(Context, Stroke, point->y);
            ...
            else
            {
                ...
                if (point->curveType == vgcCURVE_ARC_SCCW)
                {
                    ...
                    gcmERR_GOTO(_ConvertCircleArc(Context, StrokeConversion, halfWidth,
                ...
                if (pointList)
                {
                    for (p = pointList; p; p = nextP)
                    {
                        ...
                        Stroke->set(Context, Stroke, p->x);
                        Stroke->set(Context, Stroke, p->y);
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_CopyStrokeSubPath);
    return status;
}
...
#else
#define VGSL_SETCOORD_I(X, Y) \
        Stroke->set(Context, Stroke, FIXED_TO_FLOAT(X)); \
        Stroke->set(Context, Stroke, FIXED_TO_FLOAT(Y))
#endif
    ...
    )
{
    ...
    gctINT_PTR coordinates;
#endif
    vgmENTERSUBAPI(_CopyStrokeSubPath_I);
    /* Copy the stroke to the final buffer. */
    while (subPath)
    {
        /* Create a MOVE_TO command for the first point. */
        ...
        for (point = point->next; point; prevPoint = point, point = point->next)
        {
            ...
            else if (point->curveType == vgcCURVE_QUAD_CONTROL)
            {
                ...
                /* Set the control coordinates. */
                gcmASSERT(point->curveType == vgcCURVE_QUAD_CONTROL);
                Stroke->set(Context, Stroke, FIXED_TO_FLOAT(point->x));
                Stroke->set(Context, Stroke, FIXED_TO_FLOAT(point->y));
            ...
            else
            {
                ...
                {
                    /* Convert an arc to Bezier curves. */
                    gcmERR_GOTO(_ConvertCircleArc_I(Context, StrokeConversion, halfWidth,
                        point->centerX, point->centerY,
                        prevPoint->x, prevPoint->y,
                        point->x, point->y,
                        gcvFALSE, &pointList));
                ...
                for (p = pointList; p; p = nextP)
                {
                    ...
                    /* Set the control coordinates. */
                    gcmASSERT(p->curveType == vgcCURVE_QUAD_CONTROL);
                    Stroke->set(Context, Stroke, FIXED_TO_FLOAT(p->x));
                    Stroke->set(Context, Stroke, FIXED_TO_FLOAT(p->y));
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(_CopyStrokeSubPath_I);
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(_CopyStrokePath);
        ...
        */
        ...
        else
        {
            ...
            gcmERR_BREAK(_CopyStrokeSubPath(
                Context, StrokeConversion, &stroke, subPath
                ));
        }
    ...
    vgmLEAVESUBAPI(_CopyStrokePath);
    /* Return result. */
    return status;
}
    ...
    )
{
    ...
    do
    {
        ...
        /* Initialize memory pools. */
        strokeConversion->os = Context->os;
        _InitMemPool(Context, strokeConversion);
#endif

        /* Construct vgsSTROKECONVERSION_PTR structure. */
        gcmERR_GOTO(_InitStrokeConversion(
            Context, strokeConversion
            ));
        ...
        if (strokeConversion->useFixedPoint)
        {
            ...
            if (strokeConversion->useFastMode)
            {
                gcmERR_GOTO(_FastFlattenPath_I(
                    Context, strokeConversion, Path
                    ));
            }
        ...
        if (strokeConversion->useFixedPoint)
        {
            ...
            if (strokeConversion->useFastMode)
            {
                ...
                gcmERR_GOTO(_FastCreateStrokePath_I(
                    Context,
                    (vgsSTROKECONVERSION_I_PTR) strokeConversion,
                    Path
                    ));
...
#endif
            {
                ...
                {
                    gcmERR_GOTO(_FastCreateFatStrokePath_I(
                        Context,
                        (vgsSTROKECONVERSION_I_PTR) strokeConversion,
                        Path
                        ));
...
#endif
                {
                    gcmERR_GOTO(_CreateStrokePath_I(
                        Context, (vgsSTROKECONVERSION_I_PTR) strokeConversion
                        ));
                }
        ...
        else
        {
            ...
            /* Create sub paths from flattened path for stroke. */
            gcmERR_GOTO(_CreateStrokePath(
                Context, strokeConversion
                ));

#if gcdMOVG
            if (Path->UpdateBoundsDirty && (gcvNULL != strokeConversion->strokeSubPathList))
            {
                gctFLOAT minx, maxx, miny, maxy;
                vgsPOINT_PTR PathPoint = gcvNULL;
                vgsSUBPATH_PTR subPath = gcvNULL;

                minx = strokeConversion->strokeSubPathList->pointList->x;
                maxx = strokeConversion->strokeSubPathList->pointList->x;
                miny = strokeConversion->strokeSubPathList->pointList->y;
                maxy = strokeConversion->strokeSubPathList->pointList->y;

                for (subPath = strokeConversion->strokeSubPathList; subPath; subPath = subPath->next)
                {
                    for (PathPoint = subPath->pointList; PathPoint; PathPoint = PathPoint->next)
                    {
                        if (minx > PathPoint->x)
                        {
                            minx = PathPoint->x;
                ...
                Path->bounds[2] = maxy;
                Path->bounds[3] = miny;
                Path->UpdateBoundsDirty = gcvFALSE;
            }
#endif
...
{
    gceSTATUS status;
     vgmENTERSUBAPI(vgfUpdateStroke);
    do
    {
        ...
        do
        {
            ...
            if ((Path->dashPatternCount != (gctUINT) Context->strokeDashPtrnCount)  ||
                (Path->dashPhaseReset   != (gctBOOL) Context->strokeDashPhaseReset) ||
    ...
    while (gcvFALSE);
    vgmLEAVESUBAPI(vgfUpdateStroke);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status = gcvSTATUS_OK;
    vgmENTERSUBAPI(vgfDestroyStrokeConversion);
    ...
    /* Free memory pools. */
    _CleanupMemPool(Context, StrokeConversion);
    ...
    vgmLEAVESUBAPI(vgfDestroyStrokeConversion);
    return status;
}
