...
{
    vgmENTERSUBAPI(vgmDEFINENORMALIZE_Invalid);
    /* This function should never be called. */
    gcmASSERT(gcvFALSE);
    vgmLEAVESUBAPI(vgmDEFINENORMALIZE_Invalid);
}
...
{
    vgmENTERSUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_CLOSE);
    {
    ...
    vgmLEAVESUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_CLOSE);
}
...
{
    vgmENTERSUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_MOVE);
    {
        /* Get a shortcut to the control coordinates. */
        vgsCONTROL_COORD_PTR coords = Source->coords;

        /* Retrieve the source coordinates. */
        Coordinates[0] = Source->get(Context, Source);
        Coordinates[1] = Source->get(Context, Source);
    ...
    vgmLEAVESUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_MOVE);
}

vgmDEFINENORMALIZE(gcvVGCMD_MOVE_REL)
{
    vgmENTERSUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_MOVE_REL);
    {
        /* Get a shortcut to the control coordinates. */
        vgsCONTROL_COORD_PTR coords = Source->coords;

        /* Retrieve the source coordinates. */
        Coordinates[0] = Source->get(Context, Source) + coords->lastX;
        Coordinates[1] = Source->get(Context, Source) + coords->lastY;
    ...
    vgmLEAVESUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_MOVE_REL);
}
...
{
    vgmENTERSUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_LINE);
    {
        /* Get a shortcut to the control coordinates. */
        vgsCONTROL_COORD_PTR coords = Source->coords;
    ...
    vgmLEAVESUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_LINE);
}

vgmDEFINENORMALIZE(gcvVGCMD_LINE_REL)
{
    vgmENTERSUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_LINE_REL);
    {
        /* Get a shortcut to the control coordinates. */
        vgsCONTROL_COORD_PTR coords = Source->coords;
    ...
    vgmLEAVESUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_LINE_REL);
}
...
{
    vgmENTERSUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_QUAD);
    {
        ...
        /* Retrieve the source coordinates. */
        controlX = Source->get(Context, Source);
        controlY = Source->get(Context, Source);
    ...
    vgmLEAVESUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_QUAD);
}

vgmDEFINENORMALIZE(gcvVGCMD_QUAD_REL)
{
    vgmENTERSUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_QUAD_REL);
    {
        gctFLOAT controlX, controlY;
        gctFLOAT quadToX, quadToY;
        gctFLOAT tempX, tempY;
        ...
        /* Retrieve the source coordinates. */
        controlX = Source->get(Context, Source) + coords->lastX;
        controlY = Source->get(Context, Source) + coords->lastY;
    ...
    vgmLEAVESUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_QUAD_REL);
}
...
{
    vgmENTERSUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_CUBIC);
    {
        /* Get a shortcut to the control coordinates. */
        vgsCONTROL_COORD_PTR coords = Source->coords;
        ...
        Coordinates[0] = Source->get(Context, Source);
        Coordinates[1] = Source->get(Context, Source);
        Coordinates[2] = Source->get(Context, Source);
        Coordinates[3] = Source->get(Context, Source);
        Coordinates[4] = Source->get(Context, Source);
        Coordinates[5] = Source->get(Context, Source);
    ...
    vgmLEAVESUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_CUBIC);
}

vgmDEFINENORMALIZE(gcvVGCMD_CUBIC_REL)
{
    vgmENTERSUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_CUBIC_REL);
    {
        /* Get a shortcut to the control coordinates. */
        vgsCONTROL_COORD_PTR coords = Source->coords;
        ...
        Coordinates[0] = Source->get(Context, Source) + coords->lastX;
        Coordinates[1] = Source->get(Context, Source) + coords->lastY;
        Coordinates[2] = Source->get(Context, Source) + coords->lastX;
        Coordinates[3] = Source->get(Context, Source) + coords->lastY;
        Coordinates[4] = Source->get(Context, Source) + coords->lastX;
        Coordinates[5] = Source->get(Context, Source) + coords->lastY;
    ...
    vgmLEAVESUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_CUBIC_REL);
}
...
{
    vgmENTERSUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_ARC);
    {
    ...
    vgmLEAVESUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_ARC);
}

vgmDEFINENORMALIZE(gcvVGCMD_ARC_REL)
{
    vgmENTERSUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_ARC_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        vgsARCCOORDINATES_PTR arcCoords;
    ...
    vgmLEAVESUBAPI(vgmDEFINENORMALIZE_gcvVGCMD_ARC_REL);
}
...
{
    vgmENTERSUBAPI(vgfGetNormalizationArray);
    {
    ...
    vgmLEAVESUBAPI(vgfGetNormalizationArray);
}
