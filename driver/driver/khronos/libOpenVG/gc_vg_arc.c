        ...
        */
            ...
            ((endX == coords->lastX) && (endY == coords->lastY)))
        {
            ...
            gcmERR_BREAK(vgsPATHWALKER_StartSubpath(
                Context, Destination, vgmCOMMANDSIZE(2, gctFLOAT), gcePATHTYPE_FLOAT
                ));
            ...
            Destination->set(Context, Destination, EndX);
            Destination->set(Context, Destination, EndY);
        }
        else
        {
            ...
            */
            ...
            theta1 = _Angle(Context, 1, 0, (x1Prime - cxPrime) / rx, (y1Prime - cyPrime) / ry);
            theta1 = gcmFMODF(theta1, 2 * vgvPI);

            thetaSpan = _Angle(Context, ( x1Prime - cxPrime) / rx, ( y1Prime - cyPrime) / ry,
            ...
            */
            ...
            /* Allocate a new subpath. */
            gcmERR_BREAK(vgsPATHWALKER_StartSubpath(
                Context, Destination, bufferSize, gcePATHTYPE_FLOAT
                ));
            ...
            while (segs-- > 0)
            {
                ...
                /* Write the command. */
                gcmERR_BREAK(vgsPATHWALKER_WriteCommand(
                    Context, Destination, segmentCommand
                    ));

                /* Set the coordinates. */
                Destination->set(Context, Destination, controlX);
                Destination->set(Context, Destination, controlY);
                Destination->set(Context, Destination, anchorX);
                Destination->set(Context, Destination, anchorY);
            }
        }
