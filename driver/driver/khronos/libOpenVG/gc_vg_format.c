...
{
    vgmENTERSUBAPI(vgfConvertColor);
    /* Clamp the color. */
    vgfClampColor(Context, Source, Target, gcvFALSE);
    ...
    vgmLEAVESUBAPI(vgfConvertColor);
}
...
{
    vgmENTERSUBAPI(vgsPIXELWALKER_Initialize);
    {
        gctINT stride;
        gctUINT bitOffset;
        gctINT y;
    ...
    vgmLEAVESUBAPI(vgsPIXELWALKER_Initialize);
}
...
{
    vgmENTERSUBAPI(vgsPIXELWALKER_NextLine);
    ...
    vgmLEAVESUBAPI(vgsPIXELWALKER_NextLine);
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(vgfGetOpenVGFormat);
    ...
    case gcvSURF_A8B8G8R8:
        if (Premultiplied)
        {
            if (Linear)
            {
                format = VG_lABGR_8888_PRE;
            }
            else
            {
                format = VG_sABGR_8888_PRE;
            }
        }
        else
        {
    ...
    vgmLEAVESUBAPI(vgfGetOpenVGFormat);
    ...
    )
{
    ...
    vgmENTERSUBAPI(vgfGetFormatInfo);
    ...
    vgmLEAVESUBAPI(vgfGetFormatInfo);
    /* Return the format. */
