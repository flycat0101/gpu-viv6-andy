...
{
    gceSTATUS status = gcvSTATUS_OK;
    vgmENTERSUBAPI(_FontDestructor);
    do
    {
        VGint i;
    ...
    while (gcvFALSE);
    vgmLEAVESUBAPI(_FontDestructor);
    return status;
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(vgfReferenceFont);
    do
    {
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(vgfReferenceFont);
    /* Return status. */
    return status;
}
