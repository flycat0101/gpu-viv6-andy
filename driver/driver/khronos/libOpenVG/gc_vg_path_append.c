...
{
    vgmENTERSUBAPI(vgmDEFINEAPPEND_Invalid);
    /* This function should never be called. */
    gcmASSERT(gcvFALSE);
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_Invalid);
...
vgmDEFINEAPPEND(gcvVGCMD_CLOSE)
{
    ...
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_CLOSE);
    do
    {
    ...
    while (gcvFALSE);
    vgmLEAVESUBAPI(vgmDEFINEAPPENDgcvVGCMD_CLOSE);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_MOVE);
    {
        vgsCONTROL_COORD_PTR coords;
    ...
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_MOVE);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_MOVE_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        gctFLOAT moveToX, moveToY;
    ...
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_MOVE_REL);
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_LINE);
    {
        vgsCONTROL_COORD_PTR coords;
    ...
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_LINE);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_LINE_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        gctFLOAT lineToX, lineToY;
    ...
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_LINE_REL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_HLINE_EMUL);
    {
        vgsCONTROL_COORD_PTR coords;
        gctFLOAT lineToX;
    ...
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_HLINE_EMUL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_HLINE_EMUL_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        gctFLOAT lineToX;
    ...
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_HLINE_EMUL_REL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_VLINE_EMUL);
    {
        vgsCONTROL_COORD_PTR coords;
        gctFLOAT lineToY;
    ...
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_VLINE_EMUL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_VLINE_EMUL_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        gctFLOAT lineToY;
    ...
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_VLINE_EMUL_REL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_QUAD);
    {
        vgsCONTROL_COORD_PTR coords;
        ...
        do
        {
            ...
            Destination->set(Context, Destination, quadToX);
            Destination->set(Context, Destination, quadToY);
    ...
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_QUAD);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_QUAD_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        gctFLOAT controlX, controlY;
        gctFLOAT quadToX, quadToY;
    ...
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_QUAD_REL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_CUBIC);
    {
        vgsCONTROL_COORD_PTR coords;
        ...
        do
        {
            ...
            /* Extract the command coordinates. */
            controlX1 = Source->get(Context, Source);
            controlY1 = Source->get(Context, Source);
            controlX2 = Source->get(Context, Source);
            controlY2 = Source->get(Context, Source);
    ...
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_CUBIC);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_CUBIC_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        gctFLOAT controlX1, controlY1;
        gctFLOAT controlX2, controlY2;
    ...
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_CUBIC_REL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_SQUAD_EMUL);
    {
        vgsCONTROL_COORD_PTR coords;
        gctFLOAT controlX, controlY;
        gctFLOAT quadToX, quadToY;
    ...
    vgmLEAVESUBAPI(vgmENTERSUBAPI_vgmDEFINEAPPEND_gcvVGCMD_SQUAD_EMUL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_SQUAD_EMUL_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        gctFLOAT controlX, controlY;
        gctFLOAT quadToX, quadToY;
    ...
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_SQUAD_EMUL_REL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_SCUBIC_EMUL);
    {
        vgsCONTROL_COORD_PTR coords;
        gctFLOAT controlX1, controlY1;
        gctFLOAT controlX2, controlY2;
    ...
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_SCUBIC_EMUL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_SCUBIC_EMUL_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        gctFLOAT controlX1, controlY1;
        gctFLOAT controlX2, controlY2;
    ...
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_SCUBIC_EMUL_REL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_ARC);
    status = _AppendArc(Context, Destination, Source, gcvFALSE);
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_ARC);
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINEAPPEND_gcvVGCMD_ARC_REL);
    status = _AppendArc(Context, Destination, Source, gcvTRUE);
    vgmLEAVESUBAPI(vgmDEFINEAPPEND_gcvVGCMD_ARC_REL);
    return status;
}
...
{
    vgmENTERSUBAPI(vgfGetAppendArray);
    {
    ...
    vgmLEAVESUBAPI(vgfGetAppendArray);
}
