...
{
    vgmENTERSUBAPI(_NormalizeVector);
    {
        double factor
    ...
    vgmLEAVESUBAPI(_NormalizeVector);
}
...
{
    vgmENTERSUBAPI(_NormalizeVectorDifference);
    {
    gctFLOAT vectorX;
    gctFLOAT vectorY;
    ...
    _NormalizeVector(Context, vectorX, vectorY, ResultX, ResultY);
    }
    vgmLEAVESUBAPI(_NormalizeVectorDifference);
}
    ...
    )
{
    ...
    if ((LastX == ControlX) && (LastY == ControlY))
    {
        ...
        {
            _NormalizeVectorDifference(
                Context, LastX, LastY, QuadToX, QuadToY,
                &incomingTangentX, &incomingTangentY
                );

            _NormalizeVectorDifference(
                Context, ControlX, ControlY, QuadToX, QuadToY,
    ...
    {
        _NormalizeVectorDifference(
            Context, LastX, LastY, ControlX, ControlY,
            &incomingTangentX, &incomingTangentY
            );
    ...
    )
{
    ...
    if ((LastX == Control1X) && (LastY == Control1Y))
    {
        if ((Control1X == Control2X) && (Control1Y == Control2Y))
        {
            ...
            {
                _NormalizeVectorDifference(
                    Context, LastX, LastY, CubicToX, CubicToY,
                    &incomingTangentX, &incomingTangentY
                    );
        ...
        {
            _NormalizeVectorDifference(
                Context, LastX, LastY, Control2X, Control2Y,
                &incomingTangentX, &incomingTangentY
                );
            ...
            {
                _NormalizeVectorDifference(
                    Context, Control1X, Control1Y, CubicToX, CubicToY,
                    &outgoingTangentX, &outgoingTangentY
                    );
            }
            else
            {
                _NormalizeVectorDifference(
                    Context, Control2X, Control2Y, CubicToX, CubicToY,
                    &outgoingTangentX, &outgoingTangentY
                    );
            }
        }
    ...
    {
        _NormalizeVectorDifference(
            Context, LastX, LastY, Control1X, Control1Y,
            &incomingTangentX, &incomingTangentY
            );
...
{
    gctBOOL result;
    vgmENTERSUBAPI(_ComputeEllipse);
    {
    ...
    gcmVERIFY(vgfInvertMatrix(Context, UnitCircleToEllipse, &ellipseToUnitCircle));
    ...
    vgfMultiplyVector2ByMatrix3x2(Context, endPoint0, &ellipseToUnitCircle, EndPoint0);
    vgfMultiplyVector2ByMatrix3x2(Context, endPoint1, &ellipseToUnitCircle, EndPoint1);
    ...
    if (disc < 0.0f)
    {
        ...
        */
        ...
        UnitCircleToEllipse->detDirty = gcvTRUE;
        /* Compute ellipse-to-unit circle matrix. */
        gcmVERIFY(vgfInvertMatrix(Context, UnitCircleToEllipse, &ellipseToUnitCircle));
        vgmMAT(&ellipseToUnitCircle, 2, 0) = 0.0f;
        vgmMAT(&ellipseToUnitCircle, 2, 1) = 0.0f;
    ...
    vgfMultiplyVector2ByMatrix3x2(Context, cp, UnitCircleToEllipse, cp);
    ...
    vgmLEAVESUBAPI(_ComputeEllipse);
    return result;
}
    ...
    )
{
    ...
    /* Reset matrix. */
    vgfInvalidateMatrix(Context, &unitCircleToEllipse);
    ...
    vgfMultiplyVector2ByMatrix2x2(
        Context, incomingTangent, &unitCircleToEllipse, incomingTangent
        );

    vgfMultiplyVector2ByMatrix2x2(
        Context, outgoingTangent, &unitCircleToEllipse, outgoingTangent
        );
    ...
    for (i = 1; i < vgvNUM_TESSELLATED_SEGMENTS;i++)
    {
        ...
        vgfMultiplyVector2ByMatrix3x2(
            Context, nextPoint, &unitCircleToEllipse, nextPoint
            );
        ...
        vgfMultiplyVector2ByMatrix2x2(
            Context, nextTangent, &unitCircleToEllipse, nextTangent
            );
...
{
    vgmENTERSUBAPI(vgmDEFINETESSELATE_Invalid);
    /* This function should never be called. */
    gcmASSERT(gcvFALSE);
    vgmLEAVESUBAPI(vgmDEFINETESSELATE_Invalid);
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETESSELATE_gcvVGCMD_CLOSE);
    ...
    vgmLEAVESUBAPI(vgmDEFINETESSELATE_gcvVGCMD_CLOSE);
    /* Success. */
    return status;
}
...
{
    vgmENTERSUBAPI(vgmDEFINETESSELATE_gcvVGCMD_MOVE);
    {
        vgsCONTROL_COORD_PTR coords;
    ...
    vgmLEAVESUBAPI(vgmDEFINETESSELATE_gcvVGCMD_MOVE);
    /* Success. */
    return gcvSTATUS_OK;
}
...
{
    vgmENTERSUBAPI(vgmDEFINETESSELATE_gcvVGCMD_MOVE_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        gctFLOAT moveToX, moveToY;
    ...
    vgmLEAVESUBAPI(vgmDEFINETESSELATE_gcvVGCMD_MOVE_REL);
    /* Success. */
    return gcvSTATUS_OK;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETESSELATE_gcvVGCMD_LINE);
    {
        vgsCONTROL_COORD_PTR coords;
    ...
    vgmLEAVESUBAPI(vgmDEFINETESSELATE_gcvVGCMD_LINE);
    /* Success. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETESSELATE_gcvVGCMD_LINE_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        gctFLOAT lineToX, lineToY;
    ...
    vgmLEAVESUBAPI(vgmDEFINETESSELATE_gcvVGCMD_LINE_REL);
    /* Success. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETESSELATE_gcvVGCMD_QUAD);
    {
    ...
    vgmLEAVESUBAPI(vgmDEFINETESSELATE_gcvVGCMD_QUAD);
    /* Success. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETESSELATE_gcvVGCMD_QUAD_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        gctFLOAT controlX, controlY;
        gctFLOAT quadToX, quadToY;
    ...
    vgmLEAVESUBAPI(vgmDEFINETESSELATE_gcvVGCMD_QUAD_REL);
    /* Success. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETESSELATE_gcvVGCMD_CUBIC);
    {
        vgsCONTROL_COORD_PTR coords;
        ...
        /* Extract the command coordinates. */
        control1X = Source->get(Context, Source);
        control1Y = Source->get(Context, Source);
        control2X = Source->get(Context, Source);
        control2Y = Source->get(Context, Source);
    ...
    vgmLEAVESUBAPI(vgmDEFINETESSELATE_gcvVGCMD_CUBIC);
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETESSELATE_gcvVGCMD_CUBIC_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        gctFLOAT control1X, control1Y;
        gctFLOAT control2X, control2Y;
        ...
        /* Extract the command coordinates. */
        control1X = Source->get(Context, Source) + coords->lastX;
        control1Y = Source->get(Context, Source) + coords->lastY;
        control2X = Source->get(Context, Source) + coords->lastX;
        control2Y = Source->get(Context, Source) + coords->lastY;
    ...
    vgmLEAVESUBAPI(vgmDEFINETESSELATE_gcvVGCMD_CUBIC_REL);
    /* Success. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETESSELATE_gcvVGCMD_ARC);
    {
        vgsCONTROL_COORD_PTR coords;
    ...
    vgmLEAVESUBAPI(vgmDEFINETESSELATE_gcvVGCMD_ARC);
    /* Success. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETESSELATE_gcvVGCMD_ARC_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        vgsARCCOORDINATES_PTR arcCoords;
        gctFLOAT arcToXRel, arcToYRel;
    ...
    vgmLEAVESUBAPI(vgmDEFINETESSELATE_gcvVGCMD_ARC_REL);
