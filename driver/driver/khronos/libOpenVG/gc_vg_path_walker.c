...
{
    vgmENTERSUBAPI(_CopyCoordinate_S_8);
    {
    ...
    vgmLEAVESUBAPI(_CopyCoordinate_S_8);
}
...
{
    vgmENTERSUBAPI(_CopyCoordinate_S_16);
    {
    /* Get the source coordinate. */
    ...
    * (gctINT16_PTR) Destination->coordinate = coordinate;
    ...
    vgmLEAVESUBAPI(_CopyCoordinate_S_16);
}
...
{
    vgmENTERSUBAPI(_CopyCoordinate_S_32);
    {
        /* Get the source coordinate. */
    ...
    * (gctINT32_PTR) Destination->coordinate = coordinate;
    ...
    vgmLEAVESUBAPI(_CopyCoordinate_S_32);
}
...
{
    vgmENTERSUBAPI(_CopyCoordinate_F);
    {
        /* Get the source coordinate. */
    ...
    vgmLEAVESUBAPI(_CopyCoordinate_F);
}
...
{
    vgmENTERSUBAPI(_ZeroCoordinate_S_8);
    {
    ...
    vgmLEAVESUBAPI(_ZeroCoordinate_S_8);
}
...
{
    vgmENTERSUBAPI(_ZeroCoordinate_S_16);
    {
        /* Set the destination coordinate. */
    ...
    vgmLEAVESUBAPI(_ZeroCoordinate_S_16);
}
...
{
    vgmENTERSUBAPI(_ZeroCoordinate_S_32);
    {
        /* Set the destination coordinate. */
    ...
    vgmLEAVESUBAPI(_ZeroCoordinate_S_32);
}
...
{
    vgmENTERSUBAPI(_ZeroCoordinate_F);
    {
        /* Set the destination coordinate. */
    ...
    vgmLEAVESUBAPI(_ZeroCoordinate_F);
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(_InitializeReadBuffer);
    ...
    dataTypeSize  = vgfGetPathDataSize(Context, dataType);
    ...
    /* Parse the segment. */
    _ReadSegment(Context, Source);
    vgmLEAVESUBAPI(_InitializeReadBuffer);
}
...
{
    vgmENTERSUBAPI(_AppendSubpathToChain);
    {
        /* Verify the walker. */
    ...
    vgmLEAVESUBAPI(_AppendSubpathToChain);
}
...
{
    vgmENTERSUBAPI(_AppendSubpathToPath);
    {
    ...
    vgmLEAVESUBAPI(_AppendSubpathToPath);
}
...
{
    vgsPATH_DATA_PTR newPathData;
    vgmENTERSUBAPI(_RemoveSubpathFromPath);
    /* Verify the walker. */
    vgmVERIFY_WRITER(Destination);
    ...
    vgmLEAVESUBAPI(_RemoveSubpathFromPath);
}
    ...
    )
{
    ...
    gctUINT dataTypeSize;
    gctUINT dataAlignment;
    vgmENTERSUBAPI(_InitializeWriter);
    ...
    vgmLEAVESUBAPI(_InitializeWriter);
}
    ...
    )
{
    ...
    do
    {
        ...
        gcmERR_BREAK(vgsPATHSTORAGE_Open(
            Context, Destination->storage, MinimumSize, &pathData
            ));

        /* Attach to the chain. */
        _AppendSubpathToChain(Context, Destination, pathData);
    ...
    )
{
    ...
    if (pathData != gcvNULL)
    {
        ...
        if (Destination->segmentOffset == Destination->reservedForHead)
        {
            ...
            /* Free the buffer. */
            vgsPATHSTORAGE_Free(Context, Destination->storage, pathData, gcvTRUE);
        ...
        else
        {
            ...
            /* Close the buffer. */
            vgsPATHSTORAGE_Close(Context, Destination->storage, pathData);
        }
...
{
    gcePATHTYPE dataType;
    vgmENTERSUBAPI(vgsPATHWALKER_InitializeImport);
#if vgvVALIDATE_PATH_WALKER
    ...
    vgmLEAVESUBAPI(vgsPATHWALKER_InitializeImport);
}
...
{
    vgmENTERSUBAPI(vgsPATHWALKER_InitializeReader);
    ...
    _InitializeReadBuffer(Context, Source);
    vgmLEAVESUBAPI(vgsPATHWALKER_InitializeReader);
}
...
{
    vgmENTERSUBAPI(vgsPATHWALKER_InitializeWriter);
#if vgvVALIDATE_PATH_WALKER
    /* Singnal reading operation. */
    ...
    Destination->tail = gcvNULL;
    vgmLEAVESUBAPI(vgsPATHWALKER_InitializeWriter);
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(vgsPATHWALKER_NextSegment);
    ...
    do
    {
        ...
        {
            status = vgsPATHWALKER_NextBuffer(Context, Source);
            break;
        }

        /* Update skipped counts. */
        Source->numSegments += 1;
        Source->numCoords   += vgfGetSegmentDataCount(Context, Source->command);
    ...
    vgmLEAVESUBAPI(vgsPATHWALKER_NextSegment);
    /* Success. */
    return status;
}
...
{
    gceSTATUS status = gcvSTATUS_OK;
    vgmENTERSUBAPI(vgsPATHWALKER_NextBuffer);
    /* Verify the walker. */
    vgmVERIFY_READER(Source);
    do
    {
    ...
    vgmLEAVESUBAPI(vgsPATHWALKER_NextBuffer);
    /* Success. */
    return status;
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(vgsPATHWALKER_SeekToSegment);
    /* Verify the walker. */
    vgmVERIFY_READER(Source);
    ...
    while (Segment >= Source->currPathData->numSegments)
    {
        ...
        /* Advance to the next buffer. */
        if (vgsPATHWALKER_NextBuffer(Context, Source) == gcvSTATUS_NO_MORE_DATA)
        {
    ...
    while (Segment)
    {
        ...
        /* Advance to the next segment. */
        if (vgsPATHWALKER_NextSegment(Context, Source) == gcvSTATUS_NO_MORE_DATA)
        {
            result = gcvFALSE;
            goto ErrorHandler;
        }
...
ErrorHandler:
    ...
    vgmLEAVESUBAPI(vgsPATHWALKER_SeekToSegment);
    /* Success. */
    return result;
}
...
{
    vgmENTERSUBAPI(vgsPATHWALKER_SeekToEnd);
    Destination->segmentSize   = 0;
    Destination->segmentOffset = Destination->currEndOffset;
    vgmLEAVESUBAPI(vgsPATHWALKER_SeekToEnd);
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgsPATHWALKER_StartSubpath);
    /* Verify the walker. */
    vgmVERIFY_WRITER(Destination);

    /* Close the current subpath. */
    _CloseSubpath(Context, Destination);

    /* Initialize the walker. */
    _InitializeWriter(Context, Destination, DataType);

    /* Open the path for writing. */
    status = _OpenStorage(Context, Destination, MinimumSize);
    vgmLEAVESUBAPI(vgsPATHWALKER_StartSubpath);
    /* Return status. */
    return status;
}
...
{
    vgsPATH_DATA_PTR pathData;
    vgmENTERSUBAPI(vgsPATHWALKER_CloseSubpath);

    /* Reset float force. */
    Destination->forcedDataType = gcePATHTYPE_UNKNOWN;

    /* Close the current path. */
    pathData = _CloseSubpath(Context, Destination);
    vgmLEAVESUBAPI(vgsPATHWALKER_CloseSubpath);
    /* Return the path pointer. */
    return pathData;
}
    ...
    )
{
    gceSTATUS status;
    vgsPATH_DATA_PTR newPathData;
    vgmENTERSUBAPI(vgsPATHWALKER_DoneWriting);
    /* Verify the walker. */
    vgmVERIFY_WRITER(Destination);
    ...
    else
    {
        ...
        _AppendSubpathToPath(Context, Destination, path);
        ...
        {
            /* Roll back. */
            _RemoveSubpathFromPath(Context, Destination, path);
        }
    ...
    vgmLEAVESUBAPI(vgsPATHWALKER_DoneWriting);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status = gcvSTATUS_OK;
    vgmENTERSUBAPI(vgsPATHWALKER_WriteCommand);
    ...
    do
    {
        ...
        {
            /* Initialize the walker. */
            _InitializeWriter(Context, Destination, Destination->forcedDataType);

            /* Get the command size. */
            commandSize = Destination->commandSizeArray[Command];

            /* Open the path for writing. */
            gcmERR_BREAK(_OpenStorage(Context, Destination, commandSize));
        }
        else
        {
            /* Get the command size. */
            ...
            if ((gctUINT) available < commandSize)
            {
                /* Close the current subpath. */
                _CloseSubpath(Context, Destination);
        ...
        coordinateCount =
        Destination->coordinateCount = vgfGetSegmentDataCount(Context, Command);
    ...
    vgmLEAVESUBAPI(vgsPATHWALKER_WriteCommand);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgsPATHWALKER_GetCopyBlockSize);
    do
    {
        ...
        if ((gctINT) Source->segmentSize > Destination->available)
        {
            ...
            gcmERR_BREAK(vgsPATHWALKER_StartSubpath(
                Context, Destination, Source->segmentSize, gcePATHTYPE_UNKNOWN
                ));
        }
        ...
        do
        {
            ...
            blockSize        = newSize;
            segmentCount    += 1;
            coordinateCount += vgfGetSegmentDataCount(Context, Source->command);
    ...
    while (gcvFALSE);
    vgmLEAVESUBAPI(vgsPATHWALKER_GetCopyBlockSize);
    /* Return status. */
    return status;
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(vgsPATHWALKER_CopyBlock);
    /* Verify the walkers. */
    vgmVERIFY_WRITER(Destination);
    vgmVERIFY_READER(Source);
    ...
    /* Copy data. */
    gcoOS_MemCopy(destination, source, Size);
    ...
    vgmLEAVESUBAPI(vgsPATHWALKER_CopyBlock);
    /* Return status. */
    return status;
}
...
{
    vgsPATH_DATA_PTR newPathData;
    vgmENTERSUBAPI(vgsPATHWALKER_AppendData);
    /* Verify the walkers. */
    vgmVERIFY_WRITER(Destination);
    ...
    newPathData = vgsPATHWALKER_CloseSubpath(Context, Source);

    /* Attach to the chain. */
    if (newPathData != gcvNULL)
    {
        _AppendSubpathToChain(Context, Destination, newPathData);

        /* Update segment and coordinate counts. */
        Destination->numSegments += SegmentCount;
        Destination->numCoords   += CoordinateCount;
    }
    vgmLEAVESUBAPI(vgsPATHWALKER_AppendData);
}
    ...
    )
{
    ...
    vgsPATH_DATA_PTR newPathData;
    vgmENTERSUBAPI(vgsPATHWALKER_ReplaceData);
    /* Verify the walkers. */
    ...
    if (newPathData != gcvNULL)
    {
        ...
        vgsPATHSTORAGE_Free(Context, Destination->storage, currPathData, gcvFALSE);
    }

    vgmLEAVESUBAPI(vgsPATHWALKER_ReplaceData);
}
    ...
    )
{
    ...
    vgmENTERSUBAPI(vgsPATHWALKER_Rollback);
    /* Verify the walker. */
    vgmVERIFY_WRITER(Destination);
    ...
    {
        /* Free the buffer. */
        vgsPATHSTORAGE_Free(Context, Destination->storage, head, gcvTRUE);
    }

    /* Validate the storage. */
    vgmVALIDATE_STORAGE(Destination->storage);

    vgmLEAVESUBAPI(vgsPATHWALKER_Rollback);
}
