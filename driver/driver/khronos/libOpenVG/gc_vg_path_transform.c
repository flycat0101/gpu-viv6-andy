...
{
     vgmENTERSUBAPI(vgmDEFINETRANSFORM_Invalid);
    /* This function should never be called. */
    gcmASSERT(gcvFALSE);
     vgmLEAVESUBAPI(vgmDEFINETRANSFORM_Invalid);
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_CLOSE);
    {
    ...
    vgmLEAVESUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_CLOSE);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_MOVE);
    {
        vgsCONTROL_COORD_PTR coords;
        ...
        do
        {
            ...
            current[0] = Source->get(Context, Source);
            current[1] = Source->get(Context, Source);

            /* Transform with the specified matrix. */
            vgfMultiplyVector2ByMatrix3x2(Context, current, Transform, transformed);

            /* Store the coordinates in the destination. */
            Destination->set(Context, Destination, transformed[0]);
            Destination->set(Context, Destination, transformed[1]);
    ...
    vgmLEAVESUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_MOVE);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_MOVE_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        vgtFLOATVECTOR2 current, transformed;
        ...
        do
        {
            ...
            /* Transform with the specified matrix. */
            vgfMultiplyVector2ByMatrix2x2(Context, current, Transform, transformed);
    ...
    vgmLEAVESUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_MOVE_REL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_LINE);
    {
        vgsCONTROL_COORD_PTR coords;
        vgtFLOATVECTOR2 current, transformed;
    ...
    vgmLEAVESUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_LINE);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_LINE_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        vgtFLOATVECTOR2 current, transformed;
    ...
    vgmLEAVESUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_LINE_REL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_QUAD);
    {
        vgsCONTROL_COORD_PTR coords;
        ...
        do
        {
            ...
            /* Extract the command coordinates. */
            currentControl[0] = Source->get(Context, Source);
            currentControl[1] = Source->get(Context, Source);
            currentQuadTo[0]  = Source->get(Context, Source);
            currentQuadTo[1]  = Source->get(Context, Source);

            /* Transform with the specified matrix. */
            vgfMultiplyVector2ByMatrix3x2(
                Context, currentControl, Transform, transformedControl
                );

            vgfMultiplyVector2ByMatrix3x2(
                Context, currentQuadTo, Transform, transformedQuadTo
                );

            /* Store the coordinates in the destination. */
            Destination->set(Context, Destination, transformedControl[0]);
            Destination->set(Context, Destination, transformedControl[1]);
            Destination->set(Context, Destination, transformedQuadTo[0]);
            Destination->set(Context, Destination, transformedQuadTo[1]);
    ...
    vgmLEAVESUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_QUAD);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_QUAD_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        vgtFLOATVECTOR2 currentControl, transformedControl;
        vgtFLOATVECTOR2 currentQuadTo, transformedQuadTo;
    ...
    vgmLEAVESUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_QUAD_REL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_CUBIC);
    {
        vgsCONTROL_COORD_PTR coords;
        ...
        do
        {
            ...
            /* Extract the command coordinates. */
            currentControl1[0] = Source->get(Context, Source);
            currentControl1[1] = Source->get(Context, Source);
            currentControl2[0] = Source->get(Context, Source);
            currentControl2[1] = Source->get(Context, Source);
            currentCubicTo[0]  = Source->get(Context, Source);
            currentCubicTo[1]  = Source->get(Context, Source);

            /* Transform with the specified matrix. */
            vgfMultiplyVector2ByMatrix3x2(
                Context, currentControl1, Transform, transformedControl1
                );

            vgfMultiplyVector2ByMatrix3x2(
                Context, currentControl2, Transform, transformedControl2
                );

            vgfMultiplyVector2ByMatrix3x2(
                Context, currentCubicTo, Transform, transformedCubicTo
                );

            /* Store the coordinates in the destination. */
            Destination->set(Context, Destination, transformedControl1[0]);
            Destination->set(Context, Destination, transformedControl1[1]);
            Destination->set(Context, Destination, transformedControl2[0]);
            Destination->set(Context, Destination, transformedControl2[1]);
            Destination->set(Context, Destination, transformedCubicTo[0]);
            Destination->set(Context, Destination, transformedCubicTo[1]);
    ...
    vgmLEAVESUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_CUBIC);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_CUBIC_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        vgtFLOATVECTOR2 currentControl1, transformedControl1;
        vgtFLOATVECTOR2 currentControl2, transformedControl2;
    ...
    vgmLEAVESUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_CUBIC_REL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_SQUAD_EMUL);
    {
        vgsCONTROL_COORD_PTR coords;
        ...
        do
        {
            ...
            /* Store the coordinates in the destination. */
            Destination->set(Context, Destination, currentControl[0]);
            Destination->set(Context, Destination, currentControl[1]);
            Destination->set(Context, Destination, transformedQuadTo[0]);
            Destination->set(Context, Destination, transformedQuadTo[1]);
    ...
    vgmLEAVESUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_SQUAD_EMUL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_SQUAD_EMUL_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        vgtFLOATVECTOR2 currentControl;
        vgtFLOATVECTOR2 currentQuadTo, transformedQuadTo;
    ...
    vgmLEAVESUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_SQUAD_EMUL_REL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_SCUBIC_EMUL);
    {
        vgsCONTROL_COORD_PTR coords;
        ...
        do
        {
            ...
            /* Store the coordinates in the destination. */
            Destination->set(Context, Destination, currentControl1[0]);
            Destination->set(Context, Destination, currentControl1[1]);
            Destination->set(Context, Destination, transformedControl2[0]);
            Destination->set(Context, Destination, transformedControl2[1]);
            Destination->set(Context, Destination, transformedCubicTo[0]);
            Destination->set(Context, Destination, transformedCubicTo[1]);
    ...
    vgmLEAVESUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_SCUBIC_EMUL);
    /* Return status. */
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_SCUBIC_EMUL_REL);
    {
        vgsCONTROL_COORD_PTR coords;
        vgtFLOATVECTOR2 currentControl1;
        vgtFLOATVECTOR2 currentControl2, transformedControl2;
    ...
    vgmLEAVESUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_SCUBIC_EMUL_REL);
    /* Return status. */
    return status;
}
    ...
    )
{
    ...
    do
    {
        ...
        */
        ...
        transformedDirection = (vgfGetDeterminant(Context, Transform) < 0.0f)
            ? !arcCoords->counterClockwise
            :  arcCoords->counterClockwise;

        /* Skip the ARC path in the source. */
        vgsPATHWALKER_SeekToEnd(Context, Source);
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_ARC);
    status = _TransformArc(Context, Destination, Source, Transform, gcvFALSE);
    vgmLEAVESUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_ARC);
    return status;
}
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_ARC_REL);
    status = _TransformArc(Context, Destination, Source, Transform, gcvTRUE);
    vgmLEAVESUBAPI(vgmDEFINETRANSFORM_gcvVGCMD_ARC_REL);
    return status;
}
...
{
    vgmENTERSUBAPI(vgfGetTransformArray);
    {
    ...
    vgmLEAVESUBAPI(vgfGetTransformArray);
}
