...
{
    vgmENTERSUBAPI(_SetObjectState);
    do
    {
    ...
    while (gcvFALSE);
    vgmLEAVESUBAPI(_SetObjectState);
}
...
{
    vgmENTERSUBAPI(_GetObjectState);
    do
    {
        vgsOBJECT_PTR object;
        vgsOBJECT_LIST_PTR objectList;
    ...
    while (gcvFALSE);
    vgmLEAVESUBAPI(_GetObjectState);
}
...
{
    VGint result = 0;
    vgmENTERSUBAPI(_GetObjectVectorSize);
    do
    {
        vgsOBJECT_PTR object;
        vgsOBJECT_LIST_PTR objectList;
    ...
    while (gcvFALSE);
    vgmLEAVESUBAPI(_GetObjectVectorSize);
    /* Return result. */
    return result;
}
...
{
    vgmENTERSUBAPI(vgfSetDefaultStates);
    {
...
{
    gceSTATUS status;
    vgmENTERSUBAPI(vgfUpdateStates);
    do
    {
#if gcdGC355_PROFILER
        /* VG_RENDERING_QUALITY */
        ...
        if (MaskingEnable)
        {
            ...
            gcmASSERT(Context->maskImage != gcvNULL);
    ...
    vgmLEAVESUBAPI(vgfUpdateStates);
    /* Return status. */
    return status;
}
