    ...
    )
{
    ...
    vgmENTERSUBAPI(_IsValidItem);
    {
        ...
        while (buffer != gcvNULL)
        {
            ...
            itemOffset = (gctUINT32)((gctUINT8_PTR) Item - (gctUINT8_PTR) firstItem);
    ...
    )
{
    ...
    vgmENTERSUBAPI(_IsAllocatedItem);
    {
    ...
    vgmLEAVESUBAPI(_IsAllocatedItem);
    ...
    )
{
    ...
    {
        vgmENTERSUBAPI(vgsMEMORYMANAGER_Construct);
        ...
        while (gcvNULL);
        vgmLEAVESUBAPI(vgsMEMORYMANAGER_Construct);
    }
    gcmFOOTER();
    ...
    )
{
    ...
    gcmVERIFY_ARGUMENT(Manager != gcvNULL);
    {
        vgmENTERSUBAPI(vgsMEMORYMANAGER_Destroy);
        /* Assume success. */
        status = gcvSTATUS_OK;
        ...
        vgmLEAVESUBAPI(vgsMEMORYMANAGER_Destroy);
    }
    gcmFOOTER();
    /* Return status. */
    return status;
    ...
    )
{
    ...
    {
        vgmENTERSUBAPI(vgsMEMORYMANAGER_Allocate);
        ...
        vgmLEAVESUBAPI(vgsMEMORYMANAGER_Allocate);
    }
    gcmFOOTER();
    /* Return status. */
    return status;
    ...
    )
{
    ...
    vgmENTERSUBAPI(vgsMEMORYMANAGER_Free);
    {
    /* Verify arguments. */
    ...
    /* Update allocated items count. */
#if vgvVALIDATE_MEMORY_MANAGER
    gcmASSERT(_IsValidItem(Context, Manager, item));
    gcmASSERT(_IsAllocatedItem(Context, Manager, item));
    gcmASSERT(Manager->allocatedCount > 0);
    Manager->allocatedCount -= 1;
#endif
    ...
    vgmLEAVESUBAPI(vgsMEMORYMANAGER_Free);
}
