...
static VSC_ErrCode __SpvReplaceBuiltInName(gcSPV spv, VIR_Shader * virShader, SpvId resultId, gctINT memberIndex)
{
    ...
    )
{
    ...
    else
    {
        if (vecOffset != VIR_INVALID_ID)
        {
            ...
            case VIR_SYM_CONST:
                swizzle = __SpvConstIndexToVIRSwizzle(vecOffset);
...
static VIR_LayoutQual __SpvImageFormatToLayoutQual(SpvImageFormat format)
{
    VIR_LayoutQual layout = VIR_LAYQUAL_NONE;

    switch (format)
    {
    case SpvImageFormatUnknown:         layout = VIR_LAYQUAL_IMAGE_FORMAT_NONE; break;
    case SpvImageFormatRgba32f:         layout = VIR_LAYQUAL_IMAGE_FORMAT_RGBA32F; break;
    case SpvImageFormatRgba16f:         layout = VIR_LAYQUAL_IMAGE_FORMAT_RGBA16F; break;
    case SpvImageFormatR32f:            layout = VIR_LAYQUAL_IMAGE_FORMAT_R32F; break;
    case SpvImageFormatRgba8:           layout = VIR_LAYQUAL_IMAGE_FORMAT_RGBA8; break;
    case SpvImageFormatRgba8Snorm:      layout = VIR_LAYQUAL_IMAGE_FORMAT_RGBA8_SNORM; break;
    case SpvImageFormatRgba32i:         layout = VIR_LAYQUAL_IMAGE_FORMAT_RGBA32I; break;
    case SpvImageFormatRgba16i:         layout = VIR_LAYQUAL_IMAGE_FORMAT_RGBA16I; break;
    case SpvImageFormatRgba8i:          layout = VIR_LAYQUAL_IMAGE_FORMAT_RGBA8I; break;
    case SpvImageFormatR32i:            layout = VIR_LAYQUAL_IMAGE_FORMAT_R32I; break;
    case SpvImageFormatRgba32ui:        layout = VIR_LAYQUAL_IMAGE_FORMAT_RGBA32UI; break;
    case SpvImageFormatRgba16ui:        layout = VIR_LAYQUAL_IMAGE_FORMAT_RGBA16UI; break;
    case SpvImageFormatRgba8ui:         layout = VIR_LAYQUAL_IMAGE_FORMAT_RGBA8UI; break;
    case SpvImageFormatR32ui:           layout = VIR_LAYQUAL_IMAGE_FORMAT_R32UI; break;
    ...
    case SpvImageFormatR8ui: layout = VIR_LAYQUAL_IMAGE_FORMAT_NONE; break;
...
static SpvImageFormat __SpvVkFormat2SpvImageFormat(VkFormat vkformat)
{
    SpvImageFormat spvformat = SpvImageFormatUnknown;

    switch (vkformat)
    {
    case VK_FORMAT_R32G32B32A32_SFLOAT:                 spvformat = SpvImageFormatRgba32f; break;
    case VK_FORMAT_R16G16B16A16_SFLOAT:                 spvformat = SpvImageFormatRgba16f; break;
    case VK_FORMAT_R32_SFLOAT:                          spvformat = SpvImageFormatR32f; break;
    case VK_FORMAT_R8G8B8A8_UNORM:                      spvformat = SpvImageFormatRgba8; break;
    case VK_FORMAT_R8G8B8A8_SNORM:                      spvformat = SpvImageFormatRgba8Snorm; break;
    case VK_FORMAT_R32G32_SFLOAT:                       spvformat = SpvImageFormatRg32f; break;
    case VK_FORMAT_R16G16_SFLOAT:                       spvformat = SpvImageFormatRg16f; break;
    case VK_FORMAT_B10G11R11_UFLOAT_PACK32:             spvformat = SpvImageFormatR11fG11fB10f; break;
    case VK_FORMAT_R16_SFLOAT:                          spvformat = SpvImageFormatR16f; break;
    case VK_FORMAT_R16G16B16A16_UNORM:                  spvformat = SpvImageFormatRgba16; break;
    case VK_FORMAT_A2R10G10B10_UNORM_PACK32:            spvformat = SpvImageFormatRgb10A2; break;
    case VK_FORMAT_R16G16_UNORM:                        spvformat = SpvImageFormatRg16; break;
    case VK_FORMAT_R8G8_UNORM:                          spvformat = SpvImageFormatRg8; break;
    case VK_FORMAT_R16_UNORM:                           spvformat = SpvImageFormatR16; break;
    case VK_FORMAT_R8_UNORM:                            spvformat = SpvImageFormatR8; break;
    case VK_FORMAT_R16G16B16A16_SNORM:                  spvformat = SpvImageFormatRgba16Snorm; break;
    case VK_FORMAT_R16G16_SNORM:                        spvformat = SpvImageFormatRg16Snorm; break;
    case VK_FORMAT_R8G8_SNORM:                          spvformat = SpvImageFormatRg8Snorm; break;
    case VK_FORMAT_R16_SNORM:                           spvformat = SpvImageFormatR16Snorm; break;
    case VK_FORMAT_R8_SNORM:                            spvformat = SpvImageFormatR8Snorm; break;
    case VK_FORMAT_R32G32B32A32_SINT:                   spvformat = SpvImageFormatRgba32i; break;
    case VK_FORMAT_R16G16B16A16_SINT:                   spvformat = SpvImageFormatRgba16i; break;
    case VK_FORMAT_R8G8B8A8_SINT:                       spvformat = SpvImageFormatRgba8i; break;
    case VK_FORMAT_R32_SINT:                            spvformat = SpvImageFormatR32i; break;
    case VK_FORMAT_R32G32_SINT:                         spvformat = SpvImageFormatRg32i; break;
    case VK_FORMAT_R16G16_SINT:                         spvformat = SpvImageFormatRg16i; break;
    case VK_FORMAT_R8G8_SINT:                           spvformat = SpvImageFormatRg8i; break;
    case VK_FORMAT_R16_SINT:                            spvformat = SpvImageFormatR16i; break;
    case VK_FORMAT_R8_SINT:                             spvformat = SpvImageFormatR8i; break;
    case VK_FORMAT_R32G32B32A32_UINT:                   spvformat = SpvImageFormatRgba32ui; break;
    case VK_FORMAT_R16G16B16A16_UINT:                   spvformat = SpvImageFormatRgba16ui; break;
    case VK_FORMAT_R8G8B8A8_UINT:                       spvformat = SpvImageFormatRgba8ui; break;
    case VK_FORMAT_R32_UINT:                            spvformat = SpvImageFormatR32ui; break;
    case VK_FORMAT_A2R10G10B10_UINT_PACK32:             spvformat = SpvImageFormatRgb10a2ui; break;
    case VK_FORMAT_R32G32_UINT:                         spvformat = SpvImageFormatRg32ui; break;
    case VK_FORMAT_R16G16_UINT:                         spvformat = SpvImageFormatRg16ui; break;
    case VK_FORMAT_R8G8_UINT:                           spvformat = SpvImageFormatRg8ui; break;
    case VK_FORMAT_R16_UINT:                            spvformat = SpvImageFormatR16ui; break;
    case VK_FORMAT_R8_UINT:                             spvformat = SpvImageFormatR8ui; break;
    default:
        break;
    }
    ...
    )
{
    ...
    if (SPV_ID_TYPE_IS_IMAGE(baseTypeId))
    {
            ...
            (spv->renderpassInfo != gcvNULL))
        {
            ...
            gctUINT                 subpassAttachmentIndex = ~0U;
            gctUINT                 inputAttachmentIndex = ~0U;
            SpvImageFormat          subpassImageFormat = SPV_ID_TYPE_IMAGE_FORMAT(baseTypeId); /* get default image format */
            ...
            if ((renderPass->subPassInfoCount > 0) &&
                (subpassAttachmentIndex <= renderPass->subPassInfoCount) &&
            ...
            if (inputAttachmentIndex < renderPass->attachmentCount && inputAttachmentIndex >= 0)
            {
                subpassImageFormat = __SpvVkFormat2SpvImageFormat(renderPass->attachments[inputAttachmentIndex].format);
            }

            VIR_Symbol_SetLayoutQualifier(sym, __SpvImageFormatToLayoutQual(subpassImageFormat));
        }
        else
        {
            VIR_Symbol_SetLayoutQualifier(sym, __SpvImageFormatToLayoutQual(SPV_ID_TYPE_IMAGE_FORMAT(baseTypeId)));
        }
    }
...
static VSC_ErrCode __SpvIDCopy(gcSPV spv, VIR_Shader * virShader, SpvId from, SpvId to)
{
    ...
    VIR_Operand_SetType(operand, virTypeId);
                                           ...
                                           VIR_Symbol * dst, SpvId dstType)
{
    ...
    VIR_Operand_SetType(VIR_Inst_GetDest(virInst), dstVirTypeId);
    ...
    VIR_Operand_SetType(VIR_Inst_GetSource(virInst, 0), SPV_ID_VIR_TYPE_ID(srcType));
                                           ...
                                           VIR_Symbol * dst, SpvId dstType)
{
    ...
    VIR_Operand_SetType(VIR_Inst_GetSource(virInst, 0), SPV_ID_TYPE_VIR_TYPE_ID(srcType));
    VIR_Operand_SetPrecision(VIR_Inst_GetSource(virInst, 0), VIR_PRECISION_HIGH);
    VIR_Operand_SetRoundMode(VIR_Inst_GetSource(virInst, 0), VIR_ROUND_DEFAULT);
    VIR_Operand_SetModifier(VIR_Inst_GetSource(virInst, 0), VIR_MOD_NONE);
                                          ...
                                          VIR_OpCode op, SpvId src, SpvId dst)
{
    ...
    VIR_Operand_SetOpKind(VIR_Inst_GetSource(virInst, 0), VIR_OPND_SYMBOL);
    VIR_Operand_SetType(VIR_Inst_GetSource(virInst, 0), SPV_ID_VIR_TYPE_ID(src));
    VIR_Operand_SetPrecision(VIR_Inst_GetSource(virInst, 0), VIR_PRECISION_HIGH);
    VIR_Operand_SetRoundMode(VIR_Inst_GetSource(virInst, 0), VIR_ROUND_DEFAULT);
    VIR_Operand_SetModifier(VIR_Inst_GetSource(virInst, 0), VIR_MOD_NONE);
    ...
    case SpvOpTypeStruct:
        {
            ...
            for (i = 0; i < spv->operandSize; i++)
            {
                ...
                __SpvReplaceBuiltInName(spv, virShader, spv->resultId, i);
...
static VSC_ErrCode __SpvAddVariable(gcSPV spv, VIR_Shader * virShader)
{
    ...
    */
    ...
    __SpvReplaceBuiltInName(spv, virShader, spv->resultId, -1);
...
static VSC_ErrCode __SpvAddFuncCall(gcSPV spv, VIR_Shader * virShader)
{
    ...
    for (i = 1; i < spv->operandSize; i++)
    {
        ...
        VIR_Operand_SetOpKind(operand, VIR_OPND_SYMBOL);
        VIR_Operand_SetType(operand, SPV_ID_VIR_TYPE_ID(spvArgs));
        VIR_Operand_SetPrecision(operand, VIR_PRECISION_HIGH);
        VIR_Operand_SetRoundMode(operand, VIR_ROUND_DEFAULT);
        VIR_Operand_SetModifier(operand, VIR_MOD_NONE);
    }
    ...
    if (hasReturn)
    {
        ...
        VIR_Operand_SetOpKind(operand, VIR_OPND_SYMBOL);
        VIR_Operand_SetType(operand, SPV_ID_VIR_TYPE_ID(spv->resultId));
        VIR_Operand_SetPrecision(operand, VIR_PRECISION_HIGH);
        VIR_Operand_SetRoundMode(operand, VIR_ROUND_DEFAULT);
        VIR_Operand_SetModifier(operand, VIR_MOD_NONE);
    }
...
static VSC_ErrCode __SpvAddIntrisicFunction(gcSPV spv, VIR_Shader * virShader)
{
    ...
    if (hasDest)
    {
        ...
        VIR_Operand_SetOpKind(VIR_Inst_GetDest(virInst), VIR_OPND_SYMBOL);
        VIR_Operand_SetType(VIR_Inst_GetDest(virInst), SPV_ID_TYPE_VIR_TYPE_ID(pointedTy));
        VIR_Operand_SetSym(VIR_Inst_GetDest(virInst), dstVirSym);
    }
    ...
    if (argCount > 0)
    {
        ...
        {
            VIR_Swizzle virSwizzle = __SpvID2Swizzle(spv, spv->operands[i]);
            VIR_Operand *srcOpnd = parmOpnd->args[i-2];

            if (spv->opCode == SpvOpImageFetch && i >= 4)
            {
            ...
            if (SPV_ID_TYPE(spv->operands[i]) == SPV_ID_TYPE_SYMBOL)
            {
                ...
                VIR_Operand_SetType(srcOpnd, SPV_ID_VIR_TYPE_ID(resultTypeId));
            ...
            else if (SPV_ID_TYPE(spv->operands[i]) == SPV_ID_TYPE_CONST)
            {
                ...
                VIR_Operand_SetType(srcOpnd, SPV_ID_VIR_TYPE_ID(spv->operands[i]));
                VIR_Operand_SetPrecision(srcOpnd, VIR_PRECISION_HIGH);
                VIR_Operand_SetRoundMode(srcOpnd, VIR_ROUND_DEFAULT);
                VIR_Operand_SetModifier(srcOpnd, VIR_MOD_NONE);
            }
...
static VSC_ErrCode __SpvInsertInstAtFuncBegin(gcSPV spv, VIR_Shader * virShader)
{
    ...
    if (spv->shaderStage == VSC_SHADER_STAGE_CS && SPV_HAS_WORKGROUP())
    {
        ...
        VIR_Operand_SetRoundMode(operand, VIR_ROUND_DEFAULT);
        VIR_Operand_SetModifier(operand, VIR_MOD_NONE);
        VIR_Operand_SetSwizzle(operand, VIR_Enable_2_Swizzle_WShift(VIR_TypeId_Conv2Enable(VIR_TYPE_UINT32)));
        VIR_Operand_SetOpKind(operand, VIR_OPND_SYMBOL);
        VIR_Operand_SetType(operand, VIR_TYPE_UINT32);
        VIR_Operand_SetPrecision(operand, VIR_PRECISION_HIGH);
...
static VSC_ErrCode __SpvEmitVectorShuffle(gcSPV spv, VIR_Shader * virShader)
{
        ...
        SPV_ID_TYPE_IS_VECTOR(resultSpvTypeId[1]))
    {
        ...
        for (i = 0; i < emitRound; i++)
        {
            ...
            VIR_Operand_SetType(operand, typeId);
            VIR_Operand_SetPrecision(operand, VIR_PRECISION_HIGH);
            VIR_Operand_SetRoundMode(operand, VIR_ROUND_DEFAULT);
            VIR_Operand_SetModifier(operand, VIR_MOD_NONE);
            if (SPV_ID_TYPE(spv->operands[i]) == SPV_ID_TYPE_SYMBOL)
...
static VSC_ErrCode __SpvEmitPhi(gcSPV spv, VIR_Shader * virShader)
{
    ...
    VIR_Operand_SetOpKind(operand, VIR_OPND_SYMBOL);
    VIR_Operand_SetType(operand, dstVirTypeId);
    VIR_Operand_SetSym(operand, dstVirSym);
    ...
    VIR_Operand_SetRoundMode(operand, VIR_ROUND_DEFAULT);
    VIR_Operand_SetModifier(operand, VIR_MOD_NONE);
    VIR_Operand_SetType(operand, SPV_ID_VIR_TYPE_ID(resultTypeId));
    ...
    for (i = 0; 2 * i < spv->operandSize; i++)
    {
        ...
        if (SPV_ID_TYPE(spvOperand) != SPV_ID_TYPE_UNKNOW)
        {
            ...
            if (SPV_ID_TYPE(spvOperand) == SPV_ID_TYPE_SYMBOL)
            {
                ...
                VIR_Operand_SetType(newOperands, SPV_ID_VIR_TYPE_ID(resultTypeId));
...
static VSC_ErrCode __SpvEmitCompositeExtract(gcSPV spv, VIR_Shader * virShader)
{
    ...
    if (SPV_ID_TYPE_IS_VECTOR(spvTypeId))
    {
        ...
        if (SPV_ID_TYPE(spv->operands[0]) == SPV_ID_TYPE_SYMBOL)
        {
            ...
            VIR_Operand_SetType(operand, SPV_ID_TYPE_VIR_TYPE_ID(SPV_ID_TYPE_VEC_COMP_TYPE(SPV_ID_SYM_SPV_TYPE(spv->operands[0]))));
            VIR_Operand_SetOpKind(operand, VIR_OPND_SYMBOL);
            VIR_Operand_SetPrecision(operand, VIR_PRECISION_HIGH);
            VIR_Operand_SetRoundMode(operand, VIR_ROUND_DEFAULT);
            VIR_Operand_SetModifier(operand, VIR_MOD_NONE);
    ...
    else if (SPV_ID_TYPE_IS_MATRIX(spvTypeId))
    {
        ...
        if (SPV_ID_TYPE_IS_FLOAT(spv->resultTypeId))
        {
            ...
            VIR_Operand_SetSym(operand, SPV_ID_VIR_SYM(spv->operands[0]));
            VIR_Operand_SetType(operand, SPV_ID_TYPE_VIR_TYPE_ID(SPV_ID_TYPE_MAT_COL_TYPE(SPV_ID_SYM_SPV_TYPE(spv->operands[0]))));
...
static VSC_ErrCode __SpvEmitVectorExtractDynamic(gcSPV spv, VIR_Shader * virShader)
{
    ...
    if (SPV_ID_TYPE(indexId) == SPV_ID_TYPE_CONST)
    {
        ...
        VIR_Operand_SetEnable(operand, VIR_ENABLE_X);
        VIR_Operand_SetOpKind(operand, VIR_OPND_SYMBOL);
        VIR_Operand_SetType(operand, componentTypeId);
...
static VSC_ErrCode __SpvEmitVectorInsertDynamic(gcSPV spv, VIR_Shader * virShader)
{
    ...
    VIR_Operand_SetOpKind(operand, VIR_OPND_SYMBOL);
    VIR_Operand_SetType(operand, vectorTypeId);
...
static VSC_ErrCode __SpvAddOpImage(gcSPV spv, VIR_Shader * virShader)
{
    ...
    gctBOOL isSampledImageFuncParam = gcvFALSE;
    ...
    /* Check if the operand is a function parameter. */
    if (!SPV_ID_SYM_SAMPLED_IMAGE(sampledImageId) &&
        SPV_ID_SYM_IS_FUNC_PARAM(sampledImageId))
    {
        isSampledImageFuncParam = gcvTRUE;
    }

    if (!isSampledImageFuncParam)
    {
    ...
    for (j = 0; j < SPV_MAX_IMAGE_OPERAND_MASK; j++)
    {
        ...
        if (paramIndex != VIR_INVALID_ID)
        {
            ...
            for (k = 0; k < maskCount; k++)
            {
                ...
                VIR_Operand_SetType(paramOperand[k], SPV_ID_VIR_TYPE_ID(spvOperand));
...
static VSC_ErrCode __SpvEmitImageSample(gcSPV spv, VIR_Shader * virShader)
{
    ...
    for (i = 0; i < fixedOperandSize; i++)
    {
        ...
        VIR_Operand_SetType(operand, SPV_ID_VIR_TYPE_ID(spvOperand));
        VIR_Operand_SetPrecision(operand, VIR_PRECISION_HIGH);
    ...
    if (isSetDepth)
    {
        ...
        VIR_Operand_SetType(paramOperand, SPV_ID_VIR_TYPE_ID(spvOperand));
...
static VSC_ErrCode __SpvEmitLoad(gcSPV spv, VIR_Shader * virShader)
{
    ...
    if (SPV_ID_TYPE(spv->operands[0]) == SPV_ID_TYPE_SYMBOL)
    {
        ...
        if (virOpcode == VIR_OP_ATTR_LD)
        {
            ...
            gctUINT         blockOffset = SPV_ID_SYM_BLOCK_OFFSET_VALUE(spvOperand);
            ...
            if (blockIndexType == VIR_SYM_VARIABLE)
            {
                ...
                VIR_Operand_SetSwizzle(operand, VIR_SWIZZLE_X);
                VIR_Operand_SetOpKind(operand, VIR_OPND_SYMBOL);
                VIR_Operand_SetType(operand, VIR_Symbol_GetTypeId(VIR_Shader_GetSymFromId(virShader, blockOffset)));
            }
    ...
    else if (SPV_ID_TYPE(spv->operands[0]) == SPV_ID_TYPE_CONST)
    {
        ...
        VIR_Operand_SetOpKind(operand, VIR_OPND_CONST);
        VIR_Operand_SetType(operand, SPV_ID_VIR_TYPE_ID(spv->operands[0]));
        VIR_Operand_SetPrecision(operand, VIR_PRECISION_HIGH);
        VIR_Operand_SetRoundMode(operand, VIR_ROUND_DEFAULT);
        VIR_Operand_SetModifier(operand, VIR_MOD_NONE);
...
static VSC_ErrCode __SpvEmitStore(gcSPV spv, VIR_Shader * virShader)
{
        ...
        SPV_ID_TYPE(spv->operands[1]) == SPV_ID_TYPE_CONST)
    {
        ...
        else
        {
            ...
            if(VIR_GetTypeComponentType(VIR_Operand_GetType(VIR_Inst_GetDest(virInst))) == VIR_TYPE_BOOLEAN &&
               VIR_GetTypeComponentType(VIR_Operand_GetType(VIR_Inst_GetSource(virInst, 0))) != VIR_TYPE_BOOLEAN)
            {
                VIR_Operand* source1;
                VIR_Operand* source2;

                VIR_Inst_SetOpcode(virInst, VIR_OP_SELECT);
            ...
            if(SPV_ID_SYM_MAPPING_ARRAY_SYM(resultId))
            {
                ...
                for(i = 0; i < VIR_Type_GetArrayLength(arraySymType); i++)
                {
                    ...
                    VIR_Operand_SetType(VIR_Inst_GetSource(restoreVectorInst, 0), dstVirTypeId);
...
static VSC_ErrCode __SpvEmitAtomic(gcSPV spv, VIR_Shader * virShader)
{
    ...
    */
    if (virOpcode == VIR_OP_ATOMCMPXCHG)
    {
        ...
        operand = VIR_Inst_GetSource(virInst, 2);
        VIR_Operand_SetType(operand, newSymTypeId);
    ...
    for (i = 0; i < spv->operandSize; i++)
    {
        ...
        else if (SPV_ID_TYPE(spv->operands[i]) == SPV_ID_TYPE_CONST)
        {
            ...
            VIR_Operand_SetConstId(operand, SPV_ID_VIR_CONST_ID(spv->operands[i]));
            VIR_Operand_SetOpKind(operand, VIR_OPND_CONST);
            VIR_Operand_SetType(operand, SPV_ID_VIR_TYPE_ID(spv->operands[i]));
            VIR_Operand_SetPrecision(operand, VIR_PRECISION_HIGH);
            VIR_Operand_SetRoundMode(operand, VIR_ROUND_DEFAULT);
            VIR_Operand_SetModifier(operand, VIR_MOD_NONE);
    ...
    */
    if (srcBlockSym)
    {
        ...
        else
        {
            ...
            VIR_Operand_SetOpKind(operand, VIR_OPND_SYMBOL);
            VIR_Operand_SetType(operand, virDstTypeId);
            ...
            VIR_Operand_SetOpKind(operand, VIR_OPND_SYMBOL);
            VIR_Operand_SetType(operand, VIR_Type_GetIndex(VIR_Symbol_GetType(srcBlockSym)));
            VIR_Operand_SetPrecision(operand, VIR_PRECISION_HIGH);
            VIR_Operand_SetRoundMode(operand, VIR_ROUND_DEFAULT);
            VIR_Operand_SetModifier(operand, VIR_MOD_NONE);
            __SetAccessChainOffsetToOperand(
        ...
        if (dstBlockSym)
        {
            ...
            VIR_Operand_SetOpKind(operand, VIR_OPND_SYMBOL);
            VIR_Operand_SetType(operand, VIR_Type_GetIndex(VIR_Symbol_GetType(dstBlockSym)));
            VIR_Operand_SetPrecision(operand, VIR_PRECISION_HIGH);
            VIR_Operand_SetRoundMode(operand, VIR_ROUND_DEFAULT);
            VIR_Operand_SetModifier(operand, VIR_MOD_NONE);
            __SetAccessChainOffsetToOperand(
    ...
    */
    else
    {
        if (dstBlockSym)
        {
            ...
            VIR_Operand_SetModifier(operand, VIR_MOD_NONE);
            VIR_Operand_SetSwizzle(operand, virSrcSwizzle);
            VIR_Operand_SetType(operand, SPV_ID_VIR_TYPE_ID(srcId));
...
static VSC_ErrCode __SpvEmitSwitch(gcSPV spv, VIR_Shader * virShader)
{
    ...
    for (i = 0; i < labelCount; i++)
    {
        ...
        case SPV_ID_TYPE_SYMBOL:
            ...
            VIR_Operand_SetSwizzle(operand, VIR_SWIZZLE_X);
            VIR_Operand_SetOpKind(operand, VIR_OPND_SYMBOL);
            VIR_Operand_SetType(operand, virType);
            VIR_Operand_SetSym(operand, sym);
            VIR_Operand_SetPrecision(operand, VIR_PRECISION_HIGH);
            break;
    ...
    )
{
    ...
    for (i = 0; i < unHandledCount; i++)
    {
        ...
        if (SPV_ID_TYPE(spvId) == SPV_ID_TYPE_SYMBOL)
        {
            ...
            VIR_Operand_SetOpKind(operand, VIR_OPND_SYMBOL);
            VIR_Operand_SetType(operand, VIR_Operand_GetType(dest));
            VIR_Operand_SetPrecision(operand, VIR_PRECISION_HIGH);
    ...
    SpvDecodeInfo * info)
{
    ...
    SpvRenderPassInfo *renderpassInfo = (SpvRenderPassInfo *)info->renderpassInfo;
