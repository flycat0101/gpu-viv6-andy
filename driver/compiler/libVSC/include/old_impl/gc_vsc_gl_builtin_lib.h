...
"   float result = 0.0f;\n"
"   float s;\n"
"   if(abs(a) > 1152921504606846976.0f)\n"
"   {\n"
"       return 3.14159265358979323846f / 2.0 * sign(a);\n"
"   }\n"
"   else\n"
"   {\n"
"       s = inversesqrt(1.0 + a * a);\n"
"   }\n"
"   float t = s - 0.5;\n"
"   result = t * result + -0.011785832233726978000000f;\n"
"   result = t * result + 0.017653759568929672000000f;\n"
...
"   result = t * result + 1.209199547767639200000000f;\n"
"   result = result * s * a;\n"
"   bvec2 sel = greaterThan(abs(a), vec2(1152921504606846976.0f));\n"
"   result = mix(result, 3.14159265358979323846f / 2.0 * sign(a), sel);\n"
"   return result;\n"
"}\n"
"vec3 _viv_atan_3(vec3 a)\n"
"{\n"
"   vec3 result = vec3(0.0f);\n"
"   vec3 s = inversesqrt(1.0 + a * a);\n"
"   vec3 t = s - 0.5;\n"
"   result = t * result + -0.011785832233726978000000f;\n"
"   result = t * result + 0.017653759568929672000000f;\n"
"   result = t * result + -0.020724477246403694000000f;\n"
...
"   result = t * result + 1.209199547767639200000000f;\n"
"   result = result * s * a;\n"
"   bvec3 sel = greaterThan(abs(a), vec3(1152921504606846976.0f));\n"
"   result = mix(result, 3.14159265358979323846f / 2.0 * sign(a), sel);\n"
"   return result;\n"
"}\n"
"vec4 _viv_atan_4(vec4 a)\n"
...
"   result = t * result + 1.209199547767639200000000f;\n"
"   result = result * s * a;\n"
"   bvec4 sel = greaterThan(abs(a), vec4(1152921504606846976.0f));\n"
"   result = mix(result, 3.14159265358979323846f / 2.0 * sign(a), sel);\n"
"   return result;\n"
"}\n"
;
...
"    float tiny    = 1.0e-30;\n"
"    float zero    = 0.0;\n"
"    float pi_o_4  = 7.8539818525e-01; /* 0x3f490fdb */\n"
"    float pi_o_2  = 1.5707963705e+00; /* 0x3fc90fdb */\n"
"    float pi      = 3.1415927410e+00; /* 0x40490fdb */\n"
"    float pi_lo   = -8.7422776573e-08; /* 0xb3bbbd2e */\n"
"    float z;\n"
"    int k,m,hx,hy,ix,iy;\n"
"    hx = floatBitsToInt(x);\n"
...
"    result = _viv_fma_2(vec2Temp2, vec2(vec2Temp0.x, vec2Temp1.x), vec2(vec2Temp0.y, vec2Temp1.y));\n"
"    return result;\n"
"}\n"
"vec3 _viv_fma_3(vec3 a, vec3 b, vec3 c);\n"
"vec3 _viv_acos_3(vec3 a)\n"
...
"    result = _viv_fma_3(vec3Temp0, vec3(vec2Temp0.x, vec2Temp1.x, vec2Temp2.x), vec3(vec2Temp0.y, vec2Temp1.y, vec2Temp2.y));\n"
"    return result;\n"
"}\n"
"vec4 _viv_fma_4(vec4 a, vec4 b, vec4 c);\n"
"vec4 _viv_acos_4(vec4 a)\n"
...
"    result = _viv_fma_4(vec4Temp0, vec4(vec2Temp0.x, vec2Temp1.x, vec2Temp2.x, vec2Temp3.x), vec4(vec2Temp0.y, vec2Temp1.y, vec2Temp2.y, vec2Temp3.y));\n"
"    return result;\n"
"}\n"
;
...
"    result = _viv_fma_2(vec2Temp3, vec2(vec2Temp0.x, vec2Temp1.x), vec2(vec2Temp0.y, vec2Temp1.y));\n"
"    return result;\n"
"}\n"
"vec3 _viv_fma_3(vec3 a, vec3 b, vec3 c);\n"
"vec3 _viv_atan_3(vec3 a)\n"
...
"    result = _viv_fma_3(vec3Temp1, vec3(vec2Temp0.x, vec2Temp1.x, vec2Temp2.x), vec3(vec2Temp0.y, vec2Temp1.y, vec2Temp2.y));\n"
"    return result;\n"
"}\n"
"vec4 _viv_fma_4(vec4 a, vec4 b, vec4 c);\n"
"vec4 _viv_atan_4(vec4 a)\n"
...
"    result = _viv_fma_4(vec4Temp1, vec4(vec2Temp0.x, vec2Temp1.x, vec2Temp2.x, vec2Temp3.x), vec4(vec2Temp0.y, vec2Temp1.y, vec2Temp2.y, vec2Temp3.y));\n"
"    return result;\n"
"}\n"
;
...
"    result = _viv_fma_2(vec2(arctrig0.x, arctrig1.x), vec2(vec2Temp0.x, vec2Temp1.x), vec2(arctrig0.y, arctrig1.y));\n"
"    return result;\n"
"}\n"
"vec3 _viv_fma_3(vec3 a, vec3 b, vec3 c);\n"
"vec3 _viv_atan2_3(vec3 y, vec3 x)\n"
...
"    result = _viv_fma_3(vec3(arctrig0.x, arctrig1.x, arctrig2.x), vec3(vec3Temp0.x, vec3Temp1.x, vec3Temp2.x), vec3(arctrig0.y, arctrig1.y, arctrig2.y));\n"
"    return result;\n"
"}\n"
"vec4 _viv_fma_4(vec4 a, vec4 b, vec4 c);\n"
"vec4 _viv_atan2_4(vec4 y, vec4 x)\n"
...
"    result = _viv_fma_4(vec4(arctrig0.x, arctrig1.x, arctrig2.x, arctrig3.x), vec4(vec4Temp0.x, vec4Temp1.x, vec4Temp2.x, vec4Temp3.x), vec4(arctrig0.y, arctrig1.y, arctrig2.y, arctrig3.y));\n"
"    return result;\n"
"}\n"
;
...
"lowp int _viv_findLSB_5(highp uint a)\n"
"{\n"
"   lowp int result = -1;\n"
"   lowp int i;\n"
"   highp uint mask = 1u;\n"
...
"lowp ivec2 _viv_findLSB_6(highp uvec2 a)\n"
"{\n"
"   lowp ivec2 result = ivec2(-1,-1);\n"
"   lowp int i;\n"
"   highp uint mask = 1u;\n"
...
"lowp ivec3 _viv_findLSB_7(highp uvec3 a)\n"
"{\n"
"   lowp ivec3 result = ivec3(-1, -1, -1);\n"
"   lowp int i;\n"
"   highp uint mask = 1u;\n"
...
"lowp ivec4 _viv_findLSB_8(highp uvec4 a)\n"
"{\n"
"   lowp ivec4 result = ivec4(-1, -1, -1, -1);\n"
"   lowp int i;\n"
"   highp uint mask = 1u;\n"
...
"int _viv_bitfieldReverse_1(int a)\n"
"{\n"
"   uint temp = uint(a);\n"
"   uint result = ((temp >> 1) & 0x55555555u) | ((temp & 0x55555555u) << 1);\n"
...
"ivec2 _viv_bitfieldReverse_2(ivec2 a)\n"
"{\n"
"   uvec2 temp = uvec2(a);\n"
"   uvec2 result = ((temp >> 1) & uvec2(0x55555555u)) | ((temp & uvec2(0x55555555u)) << 1);\n"
...
"ivec3 _viv_bitfieldReverse_3(ivec3 a)\n"
"{\n"
"   uvec3 temp = uvec3(a);\n"
"   uvec3 result = ((temp >> 1) & uvec3(0x55555555u)) | ((temp & uvec3(0x55555555u)) << 1);\n"
...
"ivec4 _viv_bitfieldReverse_4(ivec4 a)\n"
"{\n"
"   uvec4 temp = uvec4(a);\n"
"   uvec4 result = ((temp >> 1) & uvec4(0x55555555u)) | ((temp & uvec4(0x55555555u)) << 1);\n"
...
"uint _viv_bitfieldReverse_5(uint a)\n"
"{\n"
"   uint result = ((a >> 1) & 0x55555555u) | ((a & 0x55555555u) << 1);\n"
"   result  = ((result >> 2) & 0x33333333u) | ((result & 0x33333333u) << 2);\n"
"   result = ((result >> 4) & 0x0F0F0F0Fu) | ((result & 0x0F0F0F0Fu) << 4);\n"
"   result = ((result >> 8) & 0x00FF00FFu) | ((result & 0x00FF00FFu) << 8);\n"
"   result = (result >> 16 ) | (result << 16);\n"
...
"uvec2 _viv_bitfieldReverse_6(uvec2 a)\n"
"{\n"
"   uvec2 result = ((a >> 1) & uvec2(0x55555555u)) | ((a & uvec2(0x55555555u)) << 1);\n"
"   result  = ((result >> 2) & uvec2(0x33333333u)) | ((result & uvec2(0x33333333u)) << 2);\n"
"   result = ((result >> 4) & uvec2(0x0F0F0F0Fu)) | ((result & uvec2(0x0F0F0F0Fu)) << 4);\n"
"   result = ((result >> 8) & uvec2(0x00FF00FFu)) | ((result & uvec2(0x00FF00FFu)) << 8);\n"
"   result = (result >> 16 ) | (result << 16);\n"
...
"uvec3 _viv_bitfieldReverse_7(uvec3 a)\n"
"{\n"
"   uvec3 result = ((a >> 1) & uvec3(0x55555555u)) | ((a & uvec3(0x55555555u)) << 1);\n"
"   result  = ((result >> 2) & uvec3(0x33333333u)) | ((result & uvec3(0x33333333u)) << 2);\n"
"   result = ((result >> 4) & uvec3(0x0F0F0F0Fu)) | ((result & uvec3(0x0F0F0F0Fu)) << 4);\n"
"   result = ((result >> 8) & uvec3(0x00FF00FFu)) | ((result & uvec3(0x00FF00FFu)) << 8);\n"
"   result = (result >> 16 ) | (result << 16);\n"
...
"uvec4 _viv_bitfieldReverse_8(uvec4 a)\n"
"{\n"
"   uvec4 result = ((a >> 1) & uvec4(0x55555555u)) | ((a & uvec4(0x55555555u)) << 1);\n"
"   result  = ((result >> 2) & uvec4(0x33333333u)) | ((result & uvec4(0x33333333u)) << 2);\n"
"   result = ((result >> 4) & uvec4(0x0F0F0F0Fu)) | ((result & uvec4(0x0F0F0F0Fu)) << 4);\n"
"   result = ((result >> 8) & uvec4(0x00FF00FFu)) | ((result & uvec4(0x00FF00FFu)) << 8);\n"
"   result = (result >> 16 ) | (result << 16);\n"
...
"highp uint _viv_packUnorm4x8(vec4 a)\n"
"{\n"
"   vec4 temp;\n"
...
"   return result;\n"
"}\n"
"highp uint _viv_packSnorm4x8(vec4 a)\n"
"{\n"
"   vec4 temp;\n"
...
"vec4 _viv_unpackUnorm4x8(highp uint a)\n"
"{\n"
...
"   return result;\n"
"}\n"
"vec4 _viv_unpackSnorm4x8(highp uint a)\n"
"{\n"
...
"   return result;\n"
"}\n"
"vec2 _viv_unpackSnorm2x16(highp uint a)\n"
"{\n"
...
"   return result;\n"
"}\n"
"vec2 _viv_unpackHalf2x16(highp uint a)\n"
"{\n"
"   highp vec2 result;\n"
...
"void _viv_umulExtended_1(uint a, uint b, out uint msb, out uint lsb)\n"
"{\n"
...
"void _viv_umulExtended_2(uvec2 a, uvec2 b, out uvec2 msb, out uvec2 lsb)\n"
"{\n"
"   _viv_asm(MULHI, msb, a, b);\n"
"   _viv_asm(MUL, lsb, a, b);\n"
"}\n";
...
"void _viv_umulExtended_3(uvec3 a, uvec3 b, out uvec3 msb, out uvec3 lsb)\n"
"{\n"
"   _viv_asm(MULHI, msb, a, b);\n"
"   _viv_asm(MUL, lsb, a, b);\n"
"}\n";
...
"void _viv_umulExtended_4(uvec4 a, uvec4 b, out uvec4 msb, out uvec4 lsb)\n"
"{\n"
"   _viv_asm(MULHI, msb, a, b);\n"
"   _viv_asm(MUL, lsb, a, b);\n"
"}\n";
...
"void _viv_imulExtended_1(int a, int b, out int msb, out int lsb)\n"
"{\n"
"   _viv_asm(MULHI, msb, a, b);\n"
"   _viv_asm(MUL, lsb, a, b);\n"
"}\n";
...
"void _viv_imulExtended_2(ivec2 a, ivec2 b, out ivec2 msb, out ivec2 lsb)\n"
"{\n"
"   _viv_asm(MULHI, msb, a, b);\n"
"   _viv_asm(MUL, lsb, a, b);\n"
"}\n";
...
"void _viv_imulExtended_3(ivec3 a, ivec3 b, out ivec3 msb, out ivec3 lsb)\n"
"{\n"
"   _viv_asm(MULHI, msb, a, b);\n"
"   _viv_asm(MUL, lsb, a, b);\n"
"}\n";
...
"void _viv_imulExtended_4(ivec4 a, ivec4 b, out ivec4 msb, out ivec4 lsb)\n"
"{\n"
"   _viv_asm(MULHI, msb, a, b);\n"
"   _viv_asm(MUL, lsb, a, b);\n"
"}\n";
...
"   return -2.0 * temp0 + I;\n"
"}\n";
static gctSTRING gcLibREFLECT_Func_1_halti5 =
"float _viv_reflect_1(float I, float N)\n"
"{\n"
"   float temp0 = N * dot(N, I);\n"
"   return _viv_fma_1(-2.0, temp0, I);\n"
"}\n";
static gctSTRING gcLibREFLECT_Func_2_halti5 =
"vec2 _viv_reflect_2(vec2 I, vec2 N)\n"
"{\n"
"   vec2 temp0 = N * dot(N, I);\n"
"   return _viv_fma_2(vec2(-2.0), temp0, I);\n"
"}\n";
static gctSTRING gcLibREFLECT_Func_3_halti5 =
"vec3 _viv_reflect_3(vec3 I, vec3 N)\n"
"{\n"
"   vec3 temp0 = N * dot(N, I);\n"
"   return _viv_fma_3(vec3(-2.0), temp0, I);\n"
"}\n";
static gctSTRING gcLibREFLECT_Func_4_halti5 =
"vec4 _viv_reflect_4(vec4 I, vec4 N)\n"
"{\n"
"   vec4 temp0 = N * dot(N, I);\n"
