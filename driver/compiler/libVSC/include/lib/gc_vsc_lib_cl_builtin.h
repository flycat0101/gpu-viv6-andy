...
NL "    return result;"
NL "}"
NL "int _atomcmpxchg_int_uint_int2_core1(uint a, int2 val)"
NL "{"
NL "    int tid = _viv_getLocalID();"
NL "    int id_in_a_sh_group = tid & 0x3;"
NL "    int result;"
...
NL "    return result;"
NL "}"
NL"int _atomcmpxchg_int_uint_int2_core2(uint a, int2 val)"
NL "{"
NL "    int tid = _viv_getLocalID();"
NL "    int id_in_a_sh_group = tid & 0x7;"
NL "    int result;"
...
NL "    return result;"
NL "}"
NL "int _atomcmpxchg_int_uint_int2_core4(uint a, int2 val)"
NL "{"
NL "    int  tid = _viv_getLocalID();"
NL "    int id_in_a_sh_group = tid & 0xf;"
NL "    int result;"
...
NL "    return result;"
NL "}"
NL "int _atomcmpxchg_int_uint_int2_core8(uint a, int2 val)"
NL "{"
NL "    int  tid = _viv_getLocalID();"
NL "    int id_in_a_sh_group = tid & 0x1f;"
NL "    int result;"
...
"   if(signbit(a.s0))\n"
"   {\n"
"       result.s0 = 3.14159265358979323846f - result.s0;\n"
"   }\n"
"   if(signbit(a.s1))\n"
"   {\n"
"       result.s1 = 3.14159265358979323846f - result.s1;\n"
"   }\n"
"   return result;\n"
"}\n"
"float3 _viv_acos_float3(float3 a)\n"
...
"   if(signbit(a.s2))\n"
"   {\n"
"       result.s2 = 3.14159265358979323846f - result.s2;\n"
"   }\n"
"   return result;\n"
"}\n"
"float4 _viv_acos_float4(float4 a)\n"
...
"   if(signbit(a.s3))\n"
"   {\n"
"       result.s3 = 3.14159265358979323846f - result.s3;\n"
"   }\n"
"   return result;\n"
"}\n"
"float8 _viv_acos_float8(float8 a)\n"
...
"       temp2 = 1.0;\n"
"   }\n"
"   _viv_asm(MUL, result, temp0, temp0);\n"
"   _viv_asm(MUL, temp3, result, as_float(0x3b42f491));\n"
"   _viv_asm(ADD, temp3, temp3, as_float(0xbc87d6c3));\n"
"   _viv_asm(MUL, temp3, temp3, result);\n"
"   _viv_asm(ADD, temp3, temp3, as_float(0x3d326651));\n"
"   _viv_asm(MUL, temp3, temp3, result);\n"
"   _viv_asm(ADD, temp3, temp3, as_float(0xbd9b407e));\n"
"   _viv_asm(MUL, temp3, temp3, result);\n"
"   _viv_asm(ADD, temp3, temp3, as_float(0x3ddab495));\n"
"   _viv_asm(MUL, temp3, temp3, result);\n"
"   _viv_asm(ADD, temp3, temp3, as_float(0xbe118db7));\n"
"   _viv_asm(MUL, temp3, temp3, result);\n"
"   _viv_asm(ADD, temp3, temp3, as_float(0x3e4cbd6f));\n"
"   _viv_asm(MUL, temp3, temp3, result);\n"
"   _viv_asm(ADD, temp3, temp3, as_float(0xbeaaaa73));\n"
"   _viv_asm(MUL, result, temp3, result);\n"
"   _viv_asm(ADD, result, result, 1.0);\n"
"   _viv_asm(MUL, result, temp0, result);\n"
"   _viv_asm(MUL, result, result, temp2);\n"
"   _viv_asm(ADD, result, result, temp1);\n"
"   _viv_asm(MUL, result, result, signOfA);\n"
"   return result;\n"
"}\n"
"float2 _viv_atan_float2(float2 a)\n"
"{\n"
...
"                {\n"
"                    float temp1;\n"
"                    _viv_asm(MUL, temp1, 0.5, as_float(r1x));\n"
"                    _viv_asm(ADD, temp1, temp1, as_float(0x3f490fdb));\n"
"                    r3x = 0x7f800000;\n"
...
"            }\n"
"        }\n"
"       _viv_asm(MUL, r1z, r1w, r1w);\n"
"       _viv_asm(MUL, r2w, r1z, as_float(0x3b42f491));\n"
"       _viv_asm(ADD, r2w, r2w, as_float(0xbc87d6c3));\n"
"       _viv_asm(MUL, r2w, r2w, r1z);\n"
"       _viv_asm(ADD, r2w, r2w, as_float(0x3d326651));\n"
"       _viv_asm(MUL, r2w, r2w, r1z);\n"
"       _viv_asm(ADD, r2w, r2w, as_float(0xbd9b407e));\n"
"       _viv_asm(MUL, r2w, r2w, r1z);\n"
"       _viv_asm(ADD, r2w, r2w, as_float(0x3ddab495));\n"
"       _viv_asm(MUL, r2w, r2w, r1z);\n"
"       _viv_asm(ADD, r2w, r2w, as_float(0xbe118db7));\n"
"       _viv_asm(MUL, r2w, r2w, r1z);\n"
"       _viv_asm(ADD, r2w, r2w, as_float(0x3e4cbd6f));\n"
"       _viv_asm(MUL, r2w, r2w, r1z);\n"
"       _viv_asm(ADD, r2w, r2w, as_float(0xbeaaaa73));\n"
"       _viv_asm(MUL, r1z, r2w, r1z);\n"
"       _viv_asm(ADD, r1z, r1z, 1.0);\n"
"       _viv_asm(MUL, r1z, r1w, r1z);\n"
"       _viv_asm(MUL, r1z, r1z, r2y);\n"
"       _viv_asm(ADD, r1z, r1z, r2x);\n"
"        r1x = r3z | r1x;\n"
"       _viv_asm(MUL, r1z, r1z, r2z);\n"
"       _viv_asm(ADD, result, r1z, as_float(r1x));\n"
"    }\n"
"    return result;\n"
"}\n"
