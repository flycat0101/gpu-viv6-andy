...
typedef struct _VIR_SPIRV_INFO      VIR_SpirvInfo;
...
#define VIR_OPCODE_isVX2Only(Opcode)   \
    ((VIR_OpcodeInfo[(Opcode)].flags & VIR_OPFLAG_VX2) && !(VIR_OpcodeInfo[(Opcode)].flags & VIR_OPFLAG_VX1))
...
#define VIR_Shader_GetSpirvInfo(Shader)             ((Shader)->spirvInfo)
#define VIR_Shader_SetSpirvInfo(Shader, c)          ((Shader)->spirvInfo = (c))
...
/*
** funcId for internal intrinsics, once add a new ID, please also update "VIR_IntrinsicsKind INTERNAL_INTRINSIC[]".
*/
typedef enum _VIR_INTRINSIC_INTERNAL_ID
{
    ...
    VIR_INTRINSIC_INTERNAL_CONV_F32_TO_F16      = 9,
    VIR_INTRINSIC_INTERNAL_QUANTIZE_TO_F16      = 10,
    VIR_INTRINSIC_INTERNAL_IMAGEFETCH           = 11,
...
typedef enum _VIR_UNIFORMKIND
{
    ...
    VIR_UNIFORM_GLOBAL_INVOCATION_ID_OFFSET,
...
typedef enum _VIR_IMAGEFORMAT
{
    ...
    /*F16 SNORM/UNORM.*/
    VIR_IMAGE_FORMAT_RGBA16,
    VIR_IMAGE_FORMAT_RGBA16_SNORM,
    VIR_IMAGE_FORMAT_RG16,
    VIR_IMAGE_FORMAT_RG16_SNORM,
    VIR_IMAGE_FORMAT_R16,
    VIR_IMAGE_FORMAT_R16_SNORM,
    /*F8 SNORM/UNORM.*/
...
typedef enum VIR_SYMFLAG
{
    ...
    VIR_SYMFLAG_UNDEF                           = 0x20000000, /* output gl_PointSize has NO Def in vertex shader */
...
#define isSymUnDef(sym)                        (((sym)->flags & VIR_SYMFLAG_UNDEF) != 0)
/* function flags */
...
/* Some informations that from the SPIR-V binary. */
typedef enum _VIR_SPIRV_CAPABILITY
{
    VIR_SPIRV_CAPABILITY_NONE               = 0x0000,
    VIR_SPIRV_CAPABILITY_CLIP_DISTANCE      = 0x0001,
    VIR_SPIRV_CAPABILITY_CULL_DISTANCE      = 0x0002,
    VIR_SPIRV_CAPABILITY_POINT_SIZE         = 0x0004,
}VIR_Spirv_Capability;

struct _VIR_SPIRV_INFO
{
    VIR_Spirv_Capability        capability;
};

#define VIR_SprivInfo_GetCap(Info)                  ((Info)->capability)
#define VIR_SprivInfo_SetCap(Info, Val)             do {(Info)->capability |= (Val); } while (0)
#define VIR_SprivInfo_HasClipDistance(Info)         (((Info)->capability & VIR_SPIRV_CAPABILITY_CLIP_DISTANCE) != 0)
#define VIR_SprivInfo_HasCullDistance(Info)         (((Info)->capability & VIR_SPIRV_CAPABILITY_CULL_DISTANCE) != 0)
#define VIR_SprivInfo_HasPointSize(Info)            (((Info)->capability & VIR_SPIRV_CAPABILITY_POINT_SIZE) != 0)
...
typedef enum _VIR_MEMORY_SCOPE_TYPE
{
    VIR_MEMORY_SCOPE_TYPE_CROSS_DEVICE  = 0,
    VIR_MEMORY_SCOPE_TYPE_DEVICE        = 1,
    VIR_MEMORY_SCOPE_TYPE_WORKGROUP     = 2,
    VIR_MEMORY_SCOPE_TYPE_SUBGROUP      = 3,
    VIR_MEMORY_SCOPE_TYPE_INVOCATION    = 4,
    VIR_MEMORY_SCOPE_TYPE_QUEUE_FAMILY  = 5,
}VIR_MEMORY_SCOPE_TYPE;

typedef enum _VIR_MEMORY_SEMANTIC_FLAG
{
    VIR_MEMORY_SEMANTIC_RELAXED                = 0x0,
    VIR_MEMORY_SEMANTIC_ACQUIRE                = 0x2,
    VIR_MEMORY_SEMANTIC_RELEASE                = 0x4,
    VIR_MEMORY_SEMANTIC_ACQUIRERELEASE         = 0x8,
    VIR_MEMORY_SEMANTIC_SEQUENTIALLYCONSISTENT = 0x10,
    VIR_MEMORY_SEMANTIC_UNIFORMMEMORY          = 0x40,
    VIR_MEMORY_SEMANTIC_SUBGROUPMEMORY         = 0x80,
    VIR_MEMORY_SEMANTIC_WORKGROUPMEMORY        = 0x100,
    VIR_MEMORY_SEMANTIC_CROSSWORKGROUPMEMORY   = 0x200,
    VIR_MEMORY_SEMANTIC_ATOMICCOUNTERMEMORY    = 0x400,
    VIR_MEMORY_SEMANTIC_IMAGEMEMORY            = 0x800,
    VIR_MEMORY_SEMANTIC_OUTPUTMEMORY           = 0x1000,
    VIR_MEMORY_SEMANTIC_MAKEAVAILABLE          = 0x2000,
    VIR_MEMORY_SEMANTIC_MAKEVISIBLE            = 0x4000,
    VIR_MEMORY_SEMANTIC_VOLATILE               = 0x8000,
}VIR_MEMORY_SEMANTIC_FLAG;
...
typedef enum _VIR_SHADERFLAGS
{
    ...
    VIR_SHFLAG_GENERATED_FROM_SPIRV             = 0x08,
...
#define VIR_Shader_IsGeneratedFromSpirv(Shader)     (((Shader)->flags & VIR_SHFLAG_GENERATED_FROM_SPIRV) != 0)
...
struct _VIR_SHADER
{
    ...
    /* Some informations from the SPIR-V binary. */
    VIR_SpirvInfo       spirvInfo;
