...
typedef enum _VIR_INTRINSIC_INTERNAL_ID
{
    ...
    VIR_INTRINSIC_INTERNAL_IMAGEFETCHFORSAMPLER = 12,
    VIR_INTRINSIC_INTERNAL_IMAGEADDR            = 13,
    VIR_INTRINSIC_INTERNAL_IMAGE_QUERY_FORMAT   = 14,
    VIR_INTRINSIC_INTERNAL_IMAGE_QUERY_ORDER    = 15,
    VIR_INTRINSIC_INTERNAL_IMAGE_QUERY_SIZE_LOD = 16,
    VIR_INTRINSIC_INTERNAL_IMAGE_QUERY_SIZE     = 17,
    VIR_INTRINSIC_INTERNAL_IMAGE_QUERY_LOD      = 18,
    VIR_INTRINSIC_INTERNAL_IMAGE_QUERY_LEVELS   = 19,
    VIR_INTRINSIC_INTERNAL_IMAGE_QUERY_SAMPLES  = 20,
