...
{
    SHS_PRIV_CONSTANT_FLAG_COMPUTE_GROUP_NUM            = 0,
    SHS_PRIV_CONSTANT_FLAG_IMAGE_SIZE                   = 1,
    SHS_PRIV_CONSTANT_FLAG_TEXTURE_SIZE                 = 2,
    SHS_PRIV_CONSTANT_FLAG_LOD_MIN_MAX                  = 3,
    SHS_PRIV_CONSTANT_FLAG_LEVELS_SAMPLES               = 4,
    SHS_PRIV_CONSTANT_FLAG_BASE_INSTANCE                = 5,
    SHS_PRIV_CONSTANT_FLAG_SAMPLE_LOCATION              = 6,
    SHS_PRIV_CONSTANT_FLAG_ENABLE_MULTISAMPLE_BUFFERS   = 7,
    SHS_PRIV_CONSTANT_FLAG_PRIVATE_MEM_ADDR             = 8,
