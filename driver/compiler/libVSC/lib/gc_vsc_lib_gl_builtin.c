...
/* The width is fixed for OES driver. */
"#define IMAGE_BUFFER_WIDTH_SIZE                            (MAX_TEXTURE_BUFFER_SIZE)\n"
;
...
/* Just use the real width for the vulkan driver. */
"#define IMAGE_BUFFER_WIDTH_SIZE                            (int(_viv_bitfieldExtract_uint_const(img_desc.z, 0, 16))) \n"
;
...
"   ivec2 p = ivec2(coord%imgWidth, coord/imgWidth);\n"
"   uvec2 addrRet = _viv_image_computeImgAddr2D(img_desc, p);\n"
"   uint inBorder = addrRet.x;\n"
"   uint address = addrRet.y;\n"
"   if (inBorder > 0u) { result.w = (inBorder == 2u) ? 1.0 : 0.0; } \n"
...
"    highp vec4 result;\n"
"    int imgWidth = IMAGE_BUFFER_WIDTH_SIZE;\n"
"    ivec2 newCoord = ivec2(p%imgWidth, p/imgWidth);\n"
...
"    mediump ivec4 size;\n"
"    _viv_asm(GET_SAMPLER_LBS, size, sampler);\n"
"    ivec2 newCoord = ivec2(p%size.x, p/size.x);\n"
...
"   uint address;\n"
"   int imgWidth = IMAGE_BUFFER_WIDTH_SIZE;\n"
"   address = _viv_image_computeImgAddr2D(uvec4(img_desc), ivec2(p%imgWidth, p/imgWidth)).y;\n"
"   _viv_asm(ATOMADD, result, address, data);\n"
"   return result;\n"
"}\n";
...
"   uint address;\n"
"   int imgWidth = IMAGE_BUFFER_WIDTH_SIZE;\n"
"   address = _viv_image_computeImgAddr2D(img_desc, ivec2(p%imgWidth, p/imgWidth)).y;\n"
"   _viv_asm(ATOMADD, result, address, data);\n"
"   return result;\n"
"}\n";
...
NL "    return result;"
NL "}"
NL "void _viv_process_clip_distance(int userClipEnable, float clipDistance0, float clipDistance1, float clipDistance2, float clipDistance3, float clipDistance4, float clipDistance5, float clipDistance6, float clipDistance7)"
NL "{"
NL "    if (((userClipEnable & (1 << 0)) == 1) && (clipDistance0 < 0.0))"
NL "        discard;"
NL "    if (((userClipEnable & (1 << 1)) == 1) && (clipDistance1 < 0.0))"
NL "        discard;"
NL "    if (((userClipEnable & (1 << 2)) == 1) && (clipDistance2 < 0.0))"
NL "        discard;"
NL "    if (((userClipEnable & (1 << 3)) == 1) && (clipDistance3 < 0.0))"
NL "        discard;"
NL "    if (((userClipEnable & (1 << 4)) == 1) && (clipDistance4 < 0.0))"
NL "        discard;"
NL "    if (((userClipEnable & (1 << 5)) == 1) && (clipDistance5 < 0.0))"
NL "        discard;"
NL "    if (((userClipEnable & (1 << 6)) == 1) && (clipDistance6 < 0.0))"
NL "        discard;"
NL "    if (((userClipEnable & (1 << 7)) == 1) && (clipDistance7 < 0.0))"
NL "        discard;"
NL "}"
NL ;
