...
NL "#define gcdHalfMantissaNumBits    11"
NL "#define gcdFloatMantissaNumBits   24"
NL "#define gcdHalfMantissaBitMask    0x3FF"
NL "#define gcdFloatMantissaBitMask   0x7FFFFF"
NL "#define gcdFloatMantissaAdjForRounding   0x1800"
NL "#define gcdFloatLeastSignificantBitsAfterHalf   0x1FFF"
NL;
...
gctSTRING gcCLLibVSTORE_HALF_Funcs =
NL "void _viv_vstore_half_rtz(float data, size_t offset, __global half *p)"
NL "{"
NL "   uint resUint = as_uint(data) & (~gcdFloatLeastSignificantBitsAfterHalf);"
NL "   uint unsignedVal = as_uint(data) & 0x7fffffff;"
NL "   float resFloat = as_float(resUint);"
NL "   ushort dataHalf = as_ushort(viv_convert_half(resFloat));"
NL "   if((unsignedVal >= 0x477FF000) &&  (unsignedVal < 0x7f800000)) {"
NL "       dataHalf--;"
NL "   }"
NL "   *((__global ushort *)(p + offset)) = dataHalf;"
NL "}"
NL "void _viv_vstore_half2_rtz(float2 data, size_t offset, __global half *p)"
NL "{"
NL "   uint2 resUint = as_uint2(data) & (~gcdFloatLeastSignificantBitsAfterHalf);"
NL "   uint2 unsignedVal = as_uint2(data) & 0x7fffffff;"
NL "   float2 resFloat = as_float2(resUint);"
NL "   ushort2 dataHalf = as_ushort2(viv_convert_half2(resFloat));"
NL "   int2 isInHighRange = ((unsignedVal >= 0x477FF000) &&  (unsignedVal < 0x7f800000));"
NL "   ushort2 dataHalfHigh = dataHalf - 1;"
NL "   dataHalf = select(dataHalf, dataHalfHigh, isInHighRange);"
NL "   vstore2(dataHalf, offset, (__global ushort *)p);"
NL "}"
NL "void _viv_vstore_half3_rtz(float3 data, size_t offset, __global half *p)"
NL "{"
NL "   uint3 resUint = as_uint3(data) & (~gcdFloatLeastSignificantBitsAfterHalf);"
NL "   uint3 unsignedVal = as_uint3(data) & 0x7fffffff;"
NL "   float3 resFloat = as_float3(resUint);"
NL "   ushort3 dataHalf = as_ushort3(viv_convert_half3(resFloat));"
NL "   int3 isInHighRange = ((unsignedVal >= 0x477FF000) &&  (unsignedVal < 0x7f800000));"
NL "   ushort3 dataHalfHigh = dataHalf - 1;"
NL "   dataHalf = select(dataHalf, dataHalfHigh, isInHighRange);"
NL "   vstore3(dataHalf, offset, (__global ushort *)p);"
NL "}"
NL "void _viv_vstore_half4_rtz(float4 data, size_t offset, __global half *p)"
NL "{"
NL "   uint4 resUint = as_uint4(data) & (~gcdFloatLeastSignificantBitsAfterHalf);"
NL "   uint4 unsignedVal = as_uint4(data) & 0x7fffffff;"
NL "   float4 resFloat = as_float4(resUint);"
NL "   ushort4 dataHalf = as_ushort4(viv_convert_half4(resFloat));"
NL "   int4 isInHighRange = ((unsignedVal >= 0x477FF000) &&  (unsignedVal < 0x7f800000));"
NL "   ushort4 dataHalfHigh = dataHalf - 1;"
NL "   dataHalf = select(dataHalf, dataHalfHigh, isInHighRange);"
NL "   vstore4(dataHalf, offset, (__global ushort *)p);"
NL "}"
NL "void _viv_vstore_half8_rtz(float8 data, size_t offset, __global half *p)"
NL "{"
NL "   uint8 resUint = as_uint8(data) & (~gcdFloatLeastSignificantBitsAfterHalf);"
NL "   uint8 unsignedVal = as_uint8(data) & 0x7fffffff;"
NL "   float8 resFloat = as_float8(resUint);"
NL "   ushort8 dataHalf = as_ushort8(viv_convert_half8(resFloat));"
NL "   int8 isInHighRange = ((unsignedVal >= 0x477FF000) &&  (unsignedVal < 0x7f800000));"
NL "   ushort8 dataHalfHigh = dataHalf - (ushort8)1;"
NL "   dataHalf = select(dataHalf, dataHalfHigh, isInHighRange);"
NL "   vstore8(dataHalf, offset, (__global ushort *)p);"
NL "}"
NL "void _viv_vstore_half16_rtz(float16 data, size_t offset, __global half *p)"
NL "{"
NL "   uint16 resUint = as_uint16(data) & (~gcdFloatLeastSignificantBitsAfterHalf);"
NL "   uint16 unsignedVal = as_uint16(data) & 0x7fffffff;"
NL "   float16 resFloat = as_float16(resUint);"
NL "   ushort16 dataHalf = as_ushort16(viv_convert_half16(resFloat));"
NL "   int16 isInHighRange = ((unsignedVal >= 0x477FF000) &&  (unsignedVal < 0x7f800000));"
NL "   ushort16 dataHalfHigh = dataHalf - (ushort16)1;"
NL "   dataHalf = select(dataHalf, dataHalfHigh, isInHighRange);"
NL "   vstore16(dataHalf, offset, (__global ushort *)p);"
NL "}"
NL "void _viv_vstore_half_rtp(float data, size_t offset, __global half *p)"
NL "{"
NL "   if(data <= 0.0) {"
NL "       _viv_vstore_half_rtz(data, offset, p);"
NL "   }"
NL "   else {"
NL "       if(as_uint(data) <= 0x38800000) { /* data <= 2^(-14) */"
NL "           /* data* (2^24), then round up to an integer, range 1~1024 */"
NL "           data = ceil(as_float(as_uint(data) + 0x3f800000 - 0x33800000));"
NL "           data = as_float(as_uint(data) - 0x3f800000 + 0x33800000); /* divide 2^24, back to the original scale */"
NL "       }"
NL "       else if(as_uint(data) & gcdFloatLeastSignificantBitsAfterHalf) {"
NL "           data = as_float(as_uint(data) | gcdFloatMantissaAdjForRounding);"
NL "       }"
NL "       vstore_half(data, offset, p);"
NL "   }"
NL "}"
NL "void _viv_vstore_half2_rtp(float2 data, size_t offset, __global half *p)"
NL "{"
NL "   float2 dataRtp;"
NL "   float2 dataNegative;"
NL "   float2 dataSmall;"
NL "   int2 isRtp = (as_uint2(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
NL "   int2 isNegative = (data <= 0.0);"
NL "   uint2 dataClrLsb = as_uint2(data) & (~gcdFloatLeastSignificantBitsAfterHalf);"
NL "   uint2 unsignedVal = as_uint2(data) & 0x7fffffff;"
NL "   int2 isInHighRange = ((unsignedVal >= 0x477FF000) &&  (unsignedVal < 0x7f800000));"
NL "   uint2 dataHighRange = 0x477Fe000 | (dataClrLsb & 0x80000000);"
NL "   int2 isSmallData = as_uint2(data) <= 0x38800000;"
NL "   dataNegative = as_float2(select(dataClrLsb, dataHighRange, isInHighRange));"
NL "   dataSmall = ceil(as_float2(as_uint2(data) + 0x3f800000 - 0x33800000));"
NL "   dataSmall = as_float2(as_uint2(dataSmall) - 0x3f800000 + 0x33800000);"
NL "   dataRtp = as_float2(as_uint2(data) | gcdFloatMantissaAdjForRounding);"
NL "   data = select(data, dataRtp, isRtp);"
NL "   data = select(data, dataSmall, isSmallData);"
NL "   data = select(data, dataNegative, isNegative);"
NL "   vstore_half2(data, offset, p);"
NL "}"
NL "void _viv_vstore_half3_rtp(float3 data, size_t offset, __global half *p)"
NL "{"
NL "   float3 dataRtp;"
NL "   float3 dataNegative;"
NL "   float3 dataSmall;"
NL "   int3 isRtp = (as_uint3(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
NL "   int3 isNegative = (data <= 0.0);"
NL "   uint3 dataClrLsb = as_uint3(data) & (~gcdFloatLeastSignificantBitsAfterHalf);"
NL "   uint3 unsignedVal = as_uint3(data) & 0x7fffffff;"
NL "   int3 isInHighRange = ((unsignedVal >= 0x477FF000) &&  (unsignedVal < 0x7f800000));"
NL "   uint3 dataHighRange = 0x477Fe000 | (dataClrLsb & 0x80000000);"
NL "   int3 isSmallData = as_uint3(data) <= 0x38800000;"
NL "   dataNegative = as_float3(select(dataClrLsb, dataHighRange, isInHighRange));"
NL "   dataSmall = ceil(as_float3(as_uint3(data) + 0x3f800000 - 0x33800000));"
NL "   dataSmall = as_float3(as_uint3(dataSmall) - 0x3f800000 + 0x33800000);"
NL "   dataRtp = as_float3(as_uint3(data) | gcdFloatMantissaAdjForRounding);"
NL "   data = select(data, dataRtp, isRtp);"
NL "   data = select(data, dataSmall, isSmallData);"
NL "   data = select(data, dataNegative, isNegative);"
NL "   vstore_half3(data, offset, p);"
NL "}"
NL "void _viv_vstore_half4_rtp(float4 data, size_t offset, __global half *p)"
NL "{"
NL "   float4 dataRtp;"
NL "   float4 dataNegative;"
NL "   float4 dataSmall;"
NL "   int4 isRtp = (as_uint4(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
NL "   int4 isNegative = (data <= 0.0);"
NL "   uint4 dataClrLsb = as_uint4(data) & (~gcdFloatLeastSignificantBitsAfterHalf);"
NL "   uint4 unsignedVal = as_uint4(data) & 0x7fffffff;"
NL "   int4 isInHighRange = ((unsignedVal >= 0x477FF000) &&  (unsignedVal < 0x7f800000));"
NL "   uint4 dataHighRange = 0x477Fe000 | (dataClrLsb & 0x80000000);"
NL "   int4 isSmallData = as_uint4(data) <= 0x38800000;"
NL "   dataNegative = as_float4(select(dataClrLsb, dataHighRange, isInHighRange));"
NL "   dataSmall = ceil(as_float4(as_uint4(data) + 0x3f800000 - 0x33800000));"
NL "   dataSmall = as_float4(as_uint4(dataSmall) - 0x3f800000 + 0x33800000);"
NL "   dataRtp = as_float4(as_uint4(data) | gcdFloatMantissaAdjForRounding);"
NL "   data = select(data, dataRtp, isRtp);"
NL "   data = select(data, dataSmall, isSmallData);"
NL "   data = select(data, dataNegative, isNegative);"
NL "   vstore_half4(data, offset, p);"
NL "}"
NL "void _viv_vstore_half8_rtp(float8 data, size_t offset, __global half *p)"
NL "{"
NL "   float8 dataRtp;"
NL "   float8 dataNegative;"
NL "   float8 dataSmall;"
NL "   int8 isRtp = (as_uint8(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
NL "   int8 isNegative = (data <= 0.0);"
NL "   uint8 dataClrLsb = as_uint8(data) & (~gcdFloatLeastSignificantBitsAfterHalf);"
NL "   uint8 unsignedVal = as_uint8(data) & 0x7fffffff;"
NL "   int8 isInHighRange = ((unsignedVal >= 0x477FF000) &&  (unsignedVal < 0x7f800000));"
NL "   uint8 dataHighRange = 0x477Fe000 | (dataClrLsb & 0x80000000);"
NL "   int8 isSmallData = as_uint8(data) <= 0x38800000;"
NL "   dataNegative = as_float8(select(dataClrLsb, dataHighRange, isInHighRange));"
NL "   dataSmall = ceil(as_float8(as_uint8(data) + 0x3f800000 - 0x33800000));"
NL "   dataSmall = as_float8(as_uint8(dataSmall) - 0x3f800000 + 0x33800000);"
NL "   dataRtp = as_float8(as_uint8(data) | gcdFloatMantissaAdjForRounding);"
NL "   data = select(data, dataRtp, isRtp);"
NL "   data = select(data, dataSmall, isSmallData);"
NL "   data = select(data, dataNegative, isNegative);"
NL "   vstore_half8(data, offset, p);"
NL "}"
NL "void _viv_vstore_half16_rtp(float16 data, size_t offset, __global half *p)"
NL "{"
NL "   float16 dataRtp;"
NL "   float16 dataNegative;"
NL "   float16 dataSmall;"
NL "   int16 isRtp = (as_uint16(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
NL "   int16 isNegative = (data <= 0.0);"
NL "   uint16 dataClrLsb = as_uint16(data) & (~gcdFloatLeastSignificantBitsAfterHalf);"
NL "   uint16 unsignedVal = as_uint16(data) & 0x7fffffff;"
NL "   int16 isInHighRange = ((unsignedVal >= 0x477FF000) &&  (unsignedVal < 0x7f800000));"
NL "   uint16 dataHighRange = 0x477Fe000 | (dataClrLsb & 0x80000000);"
NL "   int16 isSmallData = as_uint16(data) <= 0x38800000;"
NL "   dataNegative = as_float16(select(dataClrLsb, dataHighRange, isInHighRange));"
NL "   dataSmall = ceil(as_float16(as_uint16(data) + 0x3f800000 - 0x33800000));"
NL "   dataSmall = as_float16(as_uint16(dataSmall) - 0x3f800000 + 0x33800000);"
NL "   dataRtp = as_float16(as_uint16(data) | gcdFloatMantissaAdjForRounding);"
NL "   data = select(data, dataRtp, isRtp);"
NL "   data = select(data, dataSmall, isSmallData);"
NL "   data = select(data, dataNegative, isNegative);"
NL "   vstore_half16(data, offset, p);"
NL "}"
NL "void _viv_vstore_half_rtn(float data, size_t offset, __global half *p)"
NL "{"
NL "   if(data >= 0.0) {"
NL "       _viv_vstore_half_rtz(data, offset, p);"
NL "   }"
NL "   else {"
NL "       if(as_uint(data) & gcdFloatLeastSignificantBitsAfterHalf) {"
NL "           data = as_float(as_uint(data) | gcdFloatMantissaAdjForRounding);"
NL "       }"
NL "       if(data > -0.000000059604644775390625f) {"
NL "           data = -0.000000059604644775390625f;"
NL "       }"
NL "       vstore_half(data, offset, p);"
NL "   }"
NL "}"
NL "void _viv_vstore_half2_rtn(float2 data, size_t offset, __global half *p)"
NL "{"
NL "   float2 dataRtn;"
NL "   float2 dataPositive;"
NL "   int2 isRtn = (as_uint2(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
NL "   int2 isPositive = (data >= 0.0);"
NL "   uint2 dataClrLsb = as_uint2(data) & (~gcdFloatLeastSignificantBitsAfterHalf);"
NL "   uint2 unsignedVal = as_uint2(data) & 0x7fffffff;"
NL "   int2 isInHighRange = ((unsignedVal >= 0x477FF000) &&  (unsignedVal < 0x7f800000));"
NL "   uint2 dataHighRange = 0x477Fe000 | (dataClrLsb & 0x80000000);"
NL "   int2 isDenorm = data > -0.000000059604644775390625f;"
NL "   dataPositive = as_float2(select(dataClrLsb, dataHighRange, isInHighRange));"
NL "   dataRtn = as_float2(as_uint2(data) | gcdFloatMantissaAdjForRounding);"
NL "   data = select(data, dataRtn, isRtn);"
NL "   data = select(data, -0.000000059604644775390625f, isDenorm);"
NL "   data = select(data, dataPositive, isPositive);"
NL "   vstore_half2(data, offset, p);"
NL "}"
NL "void _viv_vstore_half3_rtn(float3 data, size_t offset, __global half *p)"
NL "{"
NL "   float3 dataRtn;"
NL "   float3 dataPositive;"
NL "   int3 isRtn = (as_uint3(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
NL "   int3 isPositive = (data >= 0.0);"
NL "   uint3 dataClrLsb = as_uint3(data) & (~gcdFloatLeastSignificantBitsAfterHalf);"
NL "   uint3 unsignedVal = as_uint3(data) & 0x7fffffff;"
NL "   int3 isInHighRange = ((unsignedVal >= 0x477FF000) &&  (unsignedVal < 0x7f800000));"
NL "   uint3 dataHighRange = 0x477Fe000 | (dataClrLsb & 0x80000000);"
NL "   int3 isDenorm = data > -0.000000059604644775390625f;"
NL "   dataPositive = as_float3(select(dataClrLsb, dataHighRange, isInHighRange));"
NL "   dataRtn = as_float3(as_uint3(data) | gcdFloatMantissaAdjForRounding);"
NL "   data = select(data, dataRtn, isRtn);"
NL "   data = select(data, -0.000000059604644775390625f, isDenorm);"
NL "   data = select(data, dataPositive, isPositive);"
NL "   vstore_half3(data, offset, p);"
NL "}"
NL "void _viv_vstore_half4_rtn(float4 data, size_t offset, __global half *p)"
NL "{"
NL "   float4 dataRtn;"
NL "   float4 dataPositive;"
NL "   int4 isRtn = (as_uint4(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
NL "   int4 isPositive = (data >= 0.0);"
NL "   uint4 dataClrLsb = as_uint4(data) & (~gcdFloatLeastSignificantBitsAfterHalf);"
NL "   uint4 unsignedVal = as_uint4(data) & 0x7fffffff;"
NL "   int4 isInHighRange = ((unsignedVal >= 0x477FF000) &&  (unsignedVal < 0x7f800000));"
NL "   uint4 dataHighRange = 0x477Fe000 | (dataClrLsb & 0x80000000);"
NL "   int4 isDenorm = data > -0.000000059604644775390625f;"
NL "   dataPositive = as_float4(select(dataClrLsb, dataHighRange, isInHighRange));"
NL "   dataRtn = as_float4(as_uint4(data) | gcdFloatMantissaAdjForRounding);"
NL "   data = select(data, dataRtn, isRtn);"
NL "   data = select(data, -0.000000059604644775390625f, isDenorm);"
NL "   data = select(data, dataPositive, isPositive);"
NL "   vstore_half4(data, offset, p);"
NL "}"
NL "void _viv_vstore_half8_rtn(float8 data, size_t offset, __global half *p)"
NL "{"
NL "   float8 dataRtn;"
NL "   float8 dataPositive;"
NL "   int8 isRtn = (as_uint8(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
NL "   int8 isPositive = (data >= 0.0);"
NL "   uint8 dataClrLsb = as_uint8(data) & (~gcdFloatLeastSignificantBitsAfterHalf);"
NL "   uint8 unsignedVal = as_uint8(data) & 0x7fffffff;"
NL "   int8 isInHighRange = ((unsignedVal >= 0x477FF000) &&  (unsignedVal < 0x7f800000));"
NL "   uint8 dataHighRange = 0x477Fe000 | (dataClrLsb & 0x80000000);"
NL "   int8 isDenorm = data > -0.000000059604644775390625f;"
NL "   dataPositive = as_float8(select(dataClrLsb, dataHighRange, isInHighRange));"
NL "   dataRtn = as_float8(as_uint8(data) | gcdFloatMantissaAdjForRounding);"
NL "   data = select(data, dataRtn, isRtn);"
NL "   data = select(data, -0.000000059604644775390625f, isDenorm);"
NL "   data = select(data, dataPositive, isPositive);"
NL "   vstore_half8(data, offset, p);"
NL "}"
NL "void _viv_vstore_half16_rtn(float16 data, size_t offset, __global half *p)"
NL "{"
NL "   float16 dataRtn;"
NL "   float16 dataPositive;"
NL "   int16 isRtn = (as_uint16(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
NL "   int16 isPositive = (data >= 0.0);"
NL "   uint16 dataClrLsb = as_uint16(data) & (~gcdFloatLeastSignificantBitsAfterHalf);"
NL "   uint16 unsignedVal = as_uint16(data) & 0x7fffffff;"
NL "   int16 isInHighRange = ((unsignedVal >= 0x477FF000) &&  (unsignedVal < 0x7f800000));"
NL "   uint16 dataHighRange = 0x477Fe000 | (dataClrLsb & 0x80000000);"
NL "   int16 isDenorm = data > -0.000000059604644775390625f;"
NL "   dataPositive = as_float16(select(dataClrLsb, dataHighRange, isInHighRange));"
NL "   dataRtn = as_float16(as_uint16(data) | gcdFloatMantissaAdjForRounding);"
NL "   data = select(data, dataRtn, isRtn);"
NL "   data = select(data, -0.000000059604644775390625f, isDenorm);"
NL "   data = select(data, dataPositive, isPositive);"
NL "   vstore_half16(data, offset, p);"
NL "}"
NL "void _viv_vstorea_half_rtz(float data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half_rtz(data, offset, p);"
NL "}"
NL "void _viv_vstorea_half2_rtz(float2 data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half2_rtz(data, offset, p);"
NL "}"
NL "void _viv_vstorea_half3_rtz(float3 data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half4_rtz((float4)(data, 0.0), offset, p);"
NL "}"
NL "void _viv_vstorea_half4_rtz(float4 data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half4_rtz(data, offset, p);"
NL "}"
NL "void _viv_vstorea_half8_rtz(float8 data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half8_rtz(data, offset, p);"
NL "}"
NL "void _viv_vstorea_half16_rtz(float16 data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half16_rtz(data, offset, p);"
NL "}"
NL "void _viv_vstorea_half_rtp(float data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half_rtp(data, offset, p);"
NL "}"
NL "void _viv_vstorea_half2_rtp(float2 data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half2_rtp(data, offset, p);"
NL "}"
NL "void _viv_vstorea_half3_rtp(float3 data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half4_rtp((float4)(data, 0.0), offset, p);"
NL "}"
NL "void _viv_vstorea_half4_rtp(float4 data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half4_rtp(data, offset, p);"
NL "}"
NL "void _viv_vstorea_half8_rtp(float8 data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half8_rtp(data, offset, p);"
NL "}"
NL "void _viv_vstorea_half16_rtp(float16 data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half16_rtp(data, offset, p);"
NL "}"
NL "void _viv_vstorea_half_rtn(float data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half_rtn(data, offset, p);"
NL "}"
NL "void _viv_vstorea_half2_rtn(float2 data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half2_rtn(data, offset, p);"
NL "}"
NL "void _viv_vstorea_half3_rtn(float3 data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half4_rtn((float4)(data, 0.0), offset, p);"
NL "}"
NL "void _viv_vstorea_half4_rtn(float4 data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half4_rtn(data, offset, p);"
NL "}"
NL "void _viv_vstorea_half8_rtn(float8 data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half8_rtn(data, offset, p);"
NL "}"
NL "void _viv_vstorea_half16_rtn(float16 data, size_t offset, __global half *p)"
NL "{"
NL "   _viv_vstore_half16_rtn(data, offset, p);"
NL "}"
NL;
#endif
