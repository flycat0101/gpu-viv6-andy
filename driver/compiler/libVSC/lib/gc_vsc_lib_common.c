...
NL "   }"
NL "   else {"
NL "       if(data > 0.0 && (as_uint(data) & gcdFloatLeastSignificantBitsAfterHalf)) {"
...
NL "   int2 isRtp = (data > 0.0) && (as_uint2(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
...
NL "   int3 isRtp = (data > 0.0) && (as_uint3(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
...
NL "   int4 isRtp = (data > 0.0) && (as_uint4(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
...
NL "   int8 isRtp = (data > 0.0) && (as_uint8(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
...
NL "   int16 isRtp = (data > 0.0) && (as_uint16(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
...
NL "   int2 isRtn = (data < 0.0) && (as_uint2(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
...
NL "   int3 isRtn = (data < 0.0) && (as_uint3(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
...
NL "   int4 isRtn = (data < 0.0) && (as_uint4(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
...
NL "   int8 isRtn = (data < 0.0) && (as_uint8(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
...
NL "   int16 isRtn = (data < 0.0) && (as_uint16(data) & gcdFloatLeastSignificantBitsAfterHalf) != 0;"
...
NL "{"
NL "   _viv_vstore_half3_rtz(data, offset, p);"
NL "}"
...
NL "{"
NL "   _viv_vstore_half3_rtp(data, offset, p);"
NL "}"
...
NL "{"
NL "   _viv_vstore_half3_rtn(data, offset, p);"
NL "}"
