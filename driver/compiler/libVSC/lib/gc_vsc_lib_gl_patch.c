...
gctSTRING gcLibTexFormatConvertHalti2_Header =
"#version 310 es\n"
...
gctSTRING gcLibTexFormatConvertHalti2_TexCvtUnifiedFunc =
...
"   ivec4 temp;\n"
"   ivec4 temp2;\n"
"   _viv_asm(OR_BITWISE, temp2!<f:UINT32>, color, 0xffff0000u);\n"
"   _viv_asm(CMP!<c:GREATER>, temp, color, _16BITS_SIGNED_MAX);\n"
"   _viv_asm(CMP!<c:ZERO>, color, temp, color);\n"
"   _viv_asm(CMP!<c:NOT_ZERO>, color, temp, temp2);\n"
"   return color;\n"
"}\n"
...
"   ivec4 temp;\n"
"   ivec4 temp2;\n"
"   _viv_asm(OR_BITWISE, temp2!<f:UINT32>, color, 0xffffff00u);\n"
"   _viv_asm(CMP!<c:GREATER>, temp, color, _8BITS_SIGNED_MAX);\n"
"   _viv_asm(CMP!<c:ZERO>, color, temp, color);\n"
"   _viv_asm(CMP!<c:NOT_ZERO>, color, temp, temp2);\n"
"   return color;\n"
"}\n"
...
"   int temp;\n"
"   _viv_asm(OR_BITWISE, temp!<f:UINT32>, iret, 0xffffff00u);\n"
...
gctSTRING gcLibTexFormatConvertHalti2_TexCvtFunc =
"\n"
"vec4 _txcvt_R32F(\n"
...
"        color.w = 1;\n"
"    }\n"
"    else if (type == TEXLDTYPE_U)\n"
"    {\n"
"        color   = texelFetch(origSampler, floatBitsToInt(coord.xyz), int(lod_bias));\n"
"        color.y = 0;\n"
"        color.z = 0;\n"
"        color.w = 1;\n"
"    }\n"
...
"    else if (type == TEXLDTYPE_U)\n"
"    {\n"
"        color    = texelFetch(extraSampler, floatBitsToInt(coord.xyz), int(lod_bias)).xyxy;\n"
"        color.xy = texelFetch(origSampler, floatBitsToInt(coord.xyz), int(lod_bias)).xy;\n"
"    }\n"
"    else\n"
"    {\n"
"        if (mod == MOD_NONE)\n"
...
"        else if (type == TEXLDTYPE_U)\n"
"        {\n"
"            color.x = texelFetch(origSampler, floatBitsToInt(coord.xyz), int(lod_bias)).x;\n"
"        }\n"
"        else\n"
"        {\n"
...
"        else if (type == TEXLDTYPE_U)\n"
"        {\n"
"            color.x = texelFetch(origSampler, floatBitsToInt(coord.xyz), int(lod_bias)).y;\n"
"        }\n"
"        else\n"
"        {\n"
...
"    else if (type == TEXLDTYPE_U)\n"
"    {\n"
"        ftmp = texelFetch(origSampler, floatBitsToInt(coord.xyz), int(lod_bias));\n"
"    }\n"
"    else\n"
"    {\n"
"        if (mod == MOD_NONE)\n"
...
gctSTRING gcLibTexFormatConvertHalti2_TexCvtFunc1 =
...
"    else if (type == TEXLDTYPE_U)\n"
"    {\n"
"        rgVal = texelFetch(origSampler, floatBitsToInt(coord.xyz), int(lod_bias));\n"
"    }\n"
"    else\n"
"    {\n"
"        if (mod == MOD_NONE)\n"
...
"    else if (type == TEXLDTYPE_U)\n"
"    {\n"
"        itmp = texelFetch(origSampler, floatBitsToInt(coord.xyz), int(lod_bias));\n"
"    }\n"
"    else\n"
"    {\n"
"        if (mod == MOD_NONE)\n"
...
gctSTRING gcLibTexFormatConvertHalti2_TexPcfCvtFunc =
...
gctSTRING gcLibTexFormatConvertHalti2_OutputCvtUnifiedFunc =
...
"                     in    uint  sampleMask, \n"
"                     inout highp uvec4 subsampleDepthReg) \n"
"{\n"
"    uint mask; \n"
...
"    return iret;\n"
"}\n"
"highp vec4[2] _outputcvt_A32B32G32R32F_2_G32R32F(highp vec4 intval)\n"
"{\n"
"    vec4 ret[2];\n"
"    ret[0] = vec4(intval.rg, 0, 1);\n"
"    ret[1] = vec4(intval.ba, 0, 1);\n"
"    return ret;\n"
"}\n"
...
gctSTRING gcLibTexFormatConvertHalti2_MainFunc =
"void main(void)\n"
"{\n"
"    fragColor = vec4(0.0,0.0,0.0, 0.0);\n"
"}" ;

gctSTRING gcLibTexFormatConvertHalti1_Header =
"#version 300 es\n"
"#extension GL_VIV_asm: enable\n"
...
gctSTRING gcLibTexFormatConvertHalti1_SinglePipe_Header =
"#version 310 es\n"
"#extension GL_VIV_asm: enable\n"
...
gctSTRING gcLibTexFormatConvertHalti1_TexCvtUnifiedFunc =
"mediump float _txcvt_single_swizzle_float(in vec4 val, in int swizzle)\n"
"{\n"
"   switch (swizzle)\n"
"   {\n"
...
"   int temp2;\n"
"   _viv_asm(OR_BITWISE, temp2!<f:UINT32>, ret, 0xffff0000u);\n"
...
"}\n"
"\n"
"highp ivec2 _txcvt_i16_to_i32_vec2(in ivec2 val)\n"
"{\n"
"   highp ivec2 ret = val & 0xffff;\n"
"   ivec2 temp;\n"
"   ivec2 temp2;\n"
"   _viv_asm(OR_BITWISE, temp2!<f:UINT32>, ret, 0xffff0000u);\n"
"   _viv_asm(CMP!<c:GREATER>, temp, ret, _16BITS_SIGNED_MAX);\n"
"   _viv_asm(CMP!<c:ZERO>, ret, temp, ret);\n"
"   _viv_asm(CMP!<c:NOT_ZERO>, ret, temp, temp2);\n"
"   return ret;\n"
"}\n"
"\n"
"highp ivec4 _txcvt_i16_to_i32_vec4(in ivec4 val)\n"
"{\n"
"   highp ivec4 ret = val & 0xffff;\n"
"   ivec4 temp;\n"
"   ivec4 temp2;\n"
"   _viv_asm(OR_BITWISE, temp2!<f:UINT32>, ret, 0xffff0000u);\n"
"   _viv_asm(CMP!<c:GREATER>, temp, ret, _16BITS_SIGNED_MAX);\n"
...
"   ivec2 temp;\n"
"   ivec2 temp2;\n"
"   _viv_asm(OR_BITWISE, temp2!<f:UINT32>, iret, 0xffffff00u);\n"
"   _viv_asm(CMP!<c:GREATER>, temp, iret, _8BITS_SIGNED_MAX);\n"
"   _viv_asm(CMP!<c:ZERO>, iret, temp, iret);\n"
"   _viv_asm(CMP!<c:NOT_ZERO>, iret, temp, temp2);\n"
"   return iret;\n"
"}\n"
"\n"
...
"   iret = _txcvt_i16_to_i32_vec2(ivec2((itmp.y << 8) | (itmp.z), (itmp.w << 8) | (itmp.x)));\n"
"   return iret;\n"
"}\n"
"\n"
...
"}\n"
"\n"
"highp ivec4 _cvt_8I_32I_vec4(highp ivec4 color)\n"
"{\n"
"   highp ivec4 iret = color & 0x000000ff;\n"
"   ivec4 temp;\n"
"   ivec4 temp2;\n"
"   _viv_asm(OR_BITWISE, temp2!<f:UINT32>, iret, 0xffffff00u);\n"
"   _viv_asm(CMP!<c:GREATER>, temp, iret, _8BITS_SIGNED_MAX);\n"
...
gctSTRING gcLibTexFormatConvertHalti1_TexCvtFunc0 =
...
gctSTRING gcLibTexFormatConvertHalti1_TexCvtFunc1 =
"highp vec4 _txcvt_R8(\n"
"    sampler3D origSampler,\n"
"    vec4 coord,\n"
"    int mod,\n"
...
"    iret = _txcvt_i16_to_i32_vec4(ivec4(itmp.x, itmp.x >> 16, itmp.y, itmp.y >> 16);\n"
"    return iret;\n"
"}\n"
"\n"
...
gctSTRING gcLibTexFormatConvertHalti1_TexCvtFunc_SinglePipe =
...
gctSTRING gcLibTexFormatConvertHalti1_TexPcfCvtFunc =
...
gctSTRING gcLibTexFormatConvertHalti1_OutputCvtUnifiedFunc =
"uint _alphaToMask(float alphaValue)  \n"
"{  \n"
"    uint mask;  \n"
"    if (alphaValue > 0.75)  \n"
...
gctSTRING gcLibTexFormatConvertHalti1_OutputCvtFunc =
"highp vec4 _outputcvt_R8_1_X8R8G8B8(highp vec4 val)\n"
"{\n"
"    return vec4(val.x, 0.0, 0.0, 1.0);\n"
"}\n"
...
gctSTRING gcLibTexFormatConvertHalti1_MainFunc =
"void main(void)\n"
"{\n"
...
gctSTRING gcLibTexFormatConvertHalti0_Header =
"#version 300 es\n"
"#extension GL_VIV_asm: enable\n"
...
gctSTRING gcLibTexFormatConvertHalti0_TexCvtUnifiedFunc =
"mediump float _txcvt_single_swizzle_float(in vec4 val, in int swizzle)\n"
"{\n"
"   switch (swizzle)\n"
"   {\n"
...
gctSTRING gcLibTexFormatConvertHalti0_TexCvtFunc =
"highp vec4 _txcvt_R8(\n"
"    sampler3D origSampler,\n"
"    vec4 coord,\n"
"    int mod,\n"
...
gctSTRING gcLibTexFormatConvertHalti0_TexPcfCvtFunc =
"float _txpcfcvt_2DCoord_all(\n"
"    sampler2D sampler,\n"
"    vec4 coord,\n"
"    int mod,\n"
...
gctSTRING gcLibTexFormatConvertHalti0_OutputCvtUnifiedFunc =
"uint _alphaToMask(float alphaValue)  \n"
"{  \n"
"    uint mask;  \n"
"    if (alphaValue > 0.75)  \n"
...
gctSTRING gcLibTexFormatConvertHalti0_OutputCvtFunc =
"highp vec4 _outputcvt_R8_1_X8R8G8B8(highp vec4 val)\n"
"{\n"
"    return vec4(val.x, 0.0, 0.0, 1.0);\n"
"}\n"
...
gctSTRING gcLibTexFormatConvertHalti0_MainFunc =
"void main(void)\n"
"{\n"
...
gctSTRING gcLibConvertBlend_Func =
"highp float _do_blendFunc(\n"
"    highp float src,\n"
"    highp float dst,\n"
"    highp float srcAlpha,\n"
"    highp float dstAlpha,\n"
"    highp float constColor,\n"
"    highp float constAlpha,\n"
"    highp float multiplySrc,\n"
"    highp float func,\n"
"    highp float bSrc\n"
"    )\n"
"{\n"
...
"    else if (func == 1.0)\n"
"         ret = 1.0;\n"
"    else if (func == 768.0/*0x0300*/)\n"
"         ret = src;\n"
"    else if (func == 769.0/*0x0301*/)\n"
"         ret = 1.0 - src;\n"
"    else if (func == 774.0/*0x0306*/)\n"
"         ret = dst;\n"
"    else if (func == 775.0/*0x0307*/)\n"
"         ret = 1.0 - dst;\n"
"    else if (func == 770.0/*0x0302*/)\n"
"         ret = srcAlpha;\n"
"    else if (func == 771.0/*0x0303*/)\n"
"         ret = 1.0 - srcAlpha;\n"
"    else if (func == 772.0/*0x0304*/)\n"
"         ret = dstAlpha;\n"
"    else if (func == 773.0/*0x0305*/)\n"
"         ret = 1.0 - dstAlpha;\n"
"    else if (func == 32769.0/*0x8001*/)\n"
"         ret = constColor;\n"
"    else if (func == 32770.0/*0x8002*/)\n"
"         ret = 1.0 - constColor;\n"
"    else if (func == 32771.0/*0x8003*/)\n"
"         ret = constAlpha;\n"
"    else if (func == 32772.0/*0x8004*/)\n"
"         ret = 1.0 - constAlpha;\n"
"    else if (func == 776.0/*0x0308*/)\n"
"         if (bSrc > 0.0)\n"
"               ret = min(srcAlpha, 1.0 - dstAlpha);\n"
"         else\n"
"               ret = 1.0;\n"
"    ret *= multiplySrc;\n"
"    return ret;\n"
"}\n"
"highp float _do_blend(\n"
"     highp float src,\n"
"     highp float dst,\n"
"     highp float srcAlpha,\n"
"     highp float dstAlpha,\n"
...
"{\n"
"    highp float ret = src;\n"
"    highp float srcRet = src;\n"
"    highp float dstRet = dst;\n"
"    srcRet = _do_blendFunc(src, dst, srcAlpha, dstAlpha, constColor, constAlpha, src, srcFunc, bSrc);\n"
"    dstRet = _do_blendFunc(src, dst, srcAlpha, dstAlpha, constColor, constAlpha, dst, dstFunc, bSrc);\n"
"    if (equation == 32774.0/*0x8006*/) /* add */\n"
"    {\n"
"       ret = srcRet + dstRet;\n"
"    }\n"
"    else if (equation == 32778.0/*0x800A*/) /* SUB */\n"
"    {\n"
"       ret = srcRet - dstRet;\n"
"    }\n"
"    else if (equation == 32779.0/*0x800B*/) /* rev_sub */\n"
"    {\n"
"       ret = dstRet - srcRet;\n"
"    }\n"
"    return ret;\n"
"}\n"
"highp vec4 _blend_func(\n"
"    highp vec4 src,\n"
"    highp sampler2D rtSampler,\n"
"    highp float rtWidth,\n"
"    highp float rtHeight,\n"
"    highp vec4 equalTion, /*x-> rgbEquation, y->alphaEquation*/\n"
"    highp vec4 func, /*x-> rgbSrcFunction, y->rgbDstFunction, z-> alphaSrcFunc, w->alphaDstFunc*/\n"
"    highp vec4 constColor,\n"
"    highp vec4 fragCoord,\n"
"    highp float yInvert\n"
"    )\n"
"{\n"
"    highp vec2 coord = vec2 (fragCoord.x,rtHeight * yInvert + (1.0 - yInvert * 2.0)*fragCoord.y) /vec2 (rtWidth, rtHeight);\n"
"    highp vec4 dst = texture2D(rtSampler, coord);\n"
"    highp vec4 ret;\n"
"    ret.x = _do_blend(src.x, dst.x, src.w, dst.w, constColor.x, constColor.w, equalTion.x, func.x, func.y, 1.0);\n"
"    ret.y = _do_blend(src.y, dst.y, src.w, dst.w, constColor.y, constColor.w, equalTion.x, func.x, func.y, 1.0);\n"
"    ret.z = _do_blend(src.z, dst.z, src.w, dst.w, constColor.z, constColor.w, equalTion.x, func.x, func.y, 1.0);\n"
"    ret.w = _do_blend(src.w, dst.w, src.w, dst.w, constColor.w, constColor.w, equalTion.y, func.z, func.w, 0.0);\n"
"    return ret;\n"
"}\n"
"void _viv_alpha_test(\n"
"    highp float alphaValue,\n"
"    highp vec2 alphaTestData\n"
"    )\n"
"{\n"
"    highp float refValue = alphaTestData.x;\n"
"    highp float func = alphaTestData.y;\n"
"    if (func == 0.0) /* GL_NEVER */ \n"
"         discard;\n"
"    else if (func == 1.0 && alphaValue >= refValue) /* GL_LESS */ \n"
"         discard;\n"
"    else if (func == 2.0 && alphaValue != refValue) /* GL_EQUAL */\n"
"         discard;\n"
"    else if (func == 3.0 && alphaValue > refValue) /* GL_LESS_EQUAL */ \n"
"         discard;\n"
"    else if (func == 4.0 && alphaValue <= refValue) /* GL_GREATER */\n"
"         discard;\n"
"    else if (func == 5.0 && alphaValue == refValue) /* GL_NOT_EQUAL */\n"
"         discard;\n"
"    else if (func == 6.0 && alphaValue < refValue) /* GL_GREATER_EQUAL */ \n"
"         discard;\n"
"}\n"
"void main()\n"
"{\n"
