    ...
    )
{
    ...
    gcmONERROR(gcSHADER_AddOutput(Shader, "vVertex", gcSHADER_FLOAT_X4, 1, 0, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOutput(Shader, "vVertex1", gcSHADER_FLOAT_X4, 1, 1, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOutput(Shader, "vVertex2", gcSHADER_FLOAT_X4, 1, 2, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOutput(Shader, "vVertex3", gcSHADER_FLOAT_X4, 1, 3, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOutput(Shader, "vVertex4", gcSHADER_FLOAT_X4, 1, 4, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOutput(Shader, "#Position", gcSHADER_FLOAT_X4, 1, 155, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 0, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 0, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 1, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 1, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 2, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 2, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 3, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 3, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 4, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 6, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 0, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 7, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 0, 0x55, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 6, 0x2, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 1, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 7, 0x2, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 1, 0x55, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 6, 0x4, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 2, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 7, 0x4, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 2, 0x55, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 6, 0x8, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 3, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 7, 0x8, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 3, 0x55, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 11, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 6, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_UNIFORM, 0, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ABS, 12, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 11, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ABS, 13, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 7, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 14, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MAX, 16, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MIN, 15, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 20, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 6, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, -0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SAT, 21, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 20, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 23, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 21, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 21, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 24, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 21, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 21, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 25, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 17, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 29, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 7, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, -0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SAT, 30, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 29, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 32, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 30, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 30, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 33, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 30, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 30, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 34, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 3.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 33, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 26, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 35, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 36, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 35, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 37, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 6, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 1.000000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 38, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 37, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 40, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 41, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MAX, 48, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 46, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.125000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MIN, 47, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 48, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.750000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 52, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, -0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SAT, 53, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 52, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 55, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 53, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 53, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 56, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 53, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 53, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 57, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 3.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 56, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 49, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 61, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x55, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, -0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SAT, 62, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 61, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 64, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 62, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 62, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 65, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 62, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 62, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 66, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 3.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 65, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 58, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 67, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 68, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 67, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 69, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 1.000000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 70, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 69, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 72, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 73, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 42, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 47, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 73, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 75, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 7, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_UNIFORM, 0, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ABS, 76, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 75, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ABS, 77, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 6, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 78, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MAX, 80, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 78, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.125000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MIN, 79, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 80, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.750000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 84, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 7, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, -0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SAT, 85, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 84, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 87, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 85, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 85, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 88, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 85, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 85, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 89, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 3.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 88, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 81, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 93, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 6, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, -0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SAT, 94, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 93, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 96, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 94, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 94, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 97, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 94, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 94, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 98, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 3.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 97, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 90, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 99, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 100, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 99, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 101, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 7, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 1.000000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 102, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 101, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 104, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 105, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 74, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 79, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 105, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 107, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x55, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_UNIFORM, 0, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ABS, 108, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 107, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ABS, 109, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 110, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MAX, 112, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 110, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.125000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MIN, 111, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 112, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.750000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 116, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x55, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, -0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SAT, 117, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 116, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 119, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 117, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 117, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 120, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 117, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 117, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 121, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 3.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 120, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 113, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 125, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, -0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SAT, 126, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 125, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 128, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 126, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 126, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 129, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 126, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 126, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 130, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 3.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 129, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 122, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 131, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 132, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 131, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 133, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x55, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 1.000000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 134, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 133, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 136, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 137, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 106, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 111, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 137, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 138, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 139, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 140, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 141, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 142, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 143, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 144, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 145, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 146, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 147, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 5, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 1.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 147, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ABS, 149, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 0, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 150, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 1.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 149, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ABS, 151, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 0, 0x55, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 152, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 1.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 151, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 153, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 154, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 156, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 158, 0x8, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 1.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 156, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 158, 0x3, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 0, 0x4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 158, 0x4, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 154, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 155, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 158, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_NOP, 0, 0x0, gcSL_FLOAT, gcSHADER_PRECISION_HIGH));
    return gcvSTATUS_OK;
    ...
    )
{
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 1, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 0, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 2, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 1, 0x2, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 1, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 2, 0x2, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 1, 0x4, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 2, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 2, 0x4, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 1, 0x8, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 3, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 2, 0x8, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 6, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ABS, 7, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 6, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ABS, 8, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 2, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 9, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MAX, 11, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 9, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.125000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MIN, 10, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 11, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.750000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 15, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 1, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, -0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SAT, 16, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 15, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 18, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 16, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 16, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 19, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 16, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 16, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 20, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 3.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 19, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 12, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 24, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 2, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, -0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SAT, 25, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 24, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 27, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 25, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 25, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 28, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 25, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 25, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 29, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 3.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 28, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 21, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 30, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 31, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 30, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 32, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 1, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 1.000000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 33, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 32, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 35, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 36, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 5, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 10, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 36, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 38, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_UNIFORM, 0, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ABS, 39, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 38, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ABS, 40, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 41, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MAX, 43, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 41, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.125000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MIN, 42, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 43, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.750000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 47, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, -0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SAT, 48, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 47, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 50, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 48, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 48, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 51, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 48, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 48, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 52, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 3.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 51, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 44, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 56, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x55, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, -0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SAT, 57, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 56, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 59, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 57, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 57, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 60, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 57, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 57, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 61, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 3.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 60, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 53, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 62, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 63, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 62, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 64, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 1.000000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 65, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 64, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 67, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 68, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 37, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 42, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 68, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 70, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 2, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_UNIFORM, 0, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ABS, 71, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 70, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ABS, 72, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 1, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 73, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MAX, 75, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 73, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.125000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MIN, 74, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 75, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.750000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 79, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 2, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, -0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SAT, 80, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 79, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 82, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 80, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 80, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 83, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 80, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 80, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 84, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 3.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 83, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 76, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 88, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 1, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, -0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SAT, 89, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 88, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 91, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 89, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 89, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 92, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 89, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 89, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 93, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 3.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 92, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 85, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 94, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 95, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 94, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 96, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 2, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 1.000000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 97, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 96, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 99, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 100, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 69, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 74, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 100, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 102, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x55, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_UNIFORM, 0, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ABS, 103, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 102, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ABS, 104, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 105, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MAX, 107, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 105, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.125000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MIN, 106, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 107, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.750000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 111, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x55, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, -0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SAT, 112, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 111, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 114, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 112, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 112, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 115, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 112, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 112, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 116, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 3.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 115, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 108, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 120, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, -0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SAT, 121, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 120, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 123, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 121, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 121, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 124, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 121, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 121, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 125, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 3.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 124, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 117, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 126, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 127, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 126, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 128, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 4, 0x55, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 1.000000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 129, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 128, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.500000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 131, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 132, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 101, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 106, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 132, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 133, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 134, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 135, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 136, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 137, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 138, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 139, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 140, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 141, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    ...
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 142, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 141, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.100000f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_SUB, 0, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 1.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 142, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MUL, 145, 0x1, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 0, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 0.333300f));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_ADD, 147, 0x8, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceConstant(Shader, 1.000000f));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 145, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 147, 0x3, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_ATTRIBUTE, 0, 0x4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 147, 0x4, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 0, 0x0, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_MOV, 144, 0xF, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddSourceIndexed(Shader, gcSL_TEMP, 147, 0xE4, gcSL_NOT_INDEXED, 0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    gcmONERROR(gcSHADER_AddOpcode(Shader, gcSL_NOP, 0, 0x0, gcSL_FLOAT, gcSHADER_PRECISION_MEDIUM));
    return gcvSTATUS_OK;
...
static gceSTATUS _Egypt2(gcSHADER Shader)
{
    ...
    */
    ...
    OPCODE(NORM, 54, XYZ, gcSHADER_PRECISION_HIGH); TEMP(53, XYZ, gcSHADER_PRECISION_HIGH);
    ...
    */
    ...
    OPCODE(NORM, 65, XYZ, gcSHADER_PRECISION_HIGH); TEMP(64, XYZ, gcSHADER_PRECISION_HIGH);
    ...
    */
    OPCODE(CROSS, 66, XYZ, gcSHADER_PRECISION_HIGH); TEMP(54, XYZ, gcSHADER_PRECISION_HIGH); TEMP(65, XYZ, gcSHADER_PRECISION_HIGH);
    ...
    */
    ...
    OPCODE(NORM, 74, XYZ, gcSHADER_PRECISION_HIGH); TEMP(73, XYZ, gcSHADER_PRECISION_HIGH);
    ...
    */
    ...
    OPCODE(ADD, 80, XY, gcSHADER_PRECISION_HIGH); TEMP(79, XY, gcSHADER_PRECISION_HIGH); UNIFORM_ARRAY(uniSunShadowMatrix, XY, 3);
...
static gceSTATUS _Shader1683Code(IN gcSHADER Shader)
{
    gceSTATUS   status;
...
gl_FragColor=vec4(vVertex.x,vVertex.y,f,1.+f*0.3333);\
    ...
    { 1683, _Shader1683, gcvNULL, _Shader1683Code },
