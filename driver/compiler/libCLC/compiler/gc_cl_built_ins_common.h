...
static clsBUILTIN_FUNCTION CommonBuiltinFunctions[] =
{
    ...
    {clvEXTENSION_NONE,     "mix",    T_F_GENTYPE,  3, {T_F_GENTYPE, T_F_GENTYPE, T_F_GENTYPE}, {0}, {1, 1, 1}, 1},

    /* Angle and Trigonometry Functions */
    {clvEXTENSION_NONE,     "radians",              T_F_GENTYPE,  1, {T_F_GENTYPE}, {0}, {1}, 1},
    ...
    {clvEXTENSION_NONE,     "degrees",              T_F_GENTYPE,  1, {T_F_GENTYPE}, {0}, {1}, 1},
    ...
    {clvEXTENSION_NONE,     "smoothstep",           T_F_GENTYPE,  3, {T_F_GENTYPE, T_F_GENTYPE, T_F_GENTYPE}, {0}, {1, 1, 1}, 1},
    ...
    {clvEXTENSION_CL_KHR_FP16,     "fast_length",   T_HALF,     1, {T_HALF},   {0}, {0}, 1},
    {clvEXTENSION_CL_KHR_FP16,     "fast_length",   T_HALF,     1, {T_HALF2},  {0}, {0}, 1},
    {clvEXTENSION_CL_KHR_FP16,     "fast_length",   T_HALF,     1, {T_HALF3},  {0}, {0}, 1},
    {clvEXTENSION_CL_KHR_FP16,     "fast_length",   T_HALF,     1, {T_HALF4},  {0}, {0}, 1},
    ...
    {clvEXTENSION_CL_KHR_FP16,     "length",        T_HALF,     1, {T_HALF},   {0}, {0}, 1},
    {clvEXTENSION_CL_KHR_FP16,     "length",        T_HALF,     1, {T_HALF2},  {0}, {0}, 1},
    {clvEXTENSION_CL_KHR_FP16,     "length",        T_HALF,     1, {T_HALF3},  {0}, {0}, 1},
    {clvEXTENSION_CL_KHR_FP16,     "length",        T_HALF,     1, {T_HALF4},  {0}, {0}, 1},
    ...
    {clvEXTENSION_CL_KHR_FP16,     "distance",      T_HALF,     2, {T_HALF,    T_HALF}, {0}, {0}, 1},
    {clvEXTENSION_CL_KHR_FP16,     "distance",      T_HALF,     2, {T_HALF2,   T_HALF2}, {0}, {0}, 1},
    {clvEXTENSION_CL_KHR_FP16,     "distance",      T_HALF,     2, {T_HALF3,   T_HALF3}, {0}, {0}, 1},
    {clvEXTENSION_CL_KHR_FP16,     "distance",      T_HALF,     2, {T_HALF4,   T_HALF4}, {0}, {0}, 1},
    ...
    {clvEXTENSION_CL_KHR_FP16,     "fast_distance", T_HALF,     2, {T_HALF,    T_HALF}, {0}, {0}, 1},
    {clvEXTENSION_CL_KHR_FP16,     "fast_distance", T_HALF,     2, {T_HALF2,   T_HALF2}, {0}, {0}, 1},
    {clvEXTENSION_CL_KHR_FP16,     "fast_distance", T_HALF,     2, {T_HALF3,   T_HALF3}, {0}, {0}, 1},
    {clvEXTENSION_CL_KHR_FP16,     "fast_distance", T_HALF,     2, {T_HALF4,   T_HALF4}, {0}, {0}, 1},
    ...
    {clvEXTENSION_CL_KHR_FP16,     "dot",           T_HALF,     2, {T_HALF,    T_HALF}, {0}, {0}, 1},
    {clvEXTENSION_CL_KHR_FP16,     "dot",           T_HALF,     2, {T_HALF2,   T_HALF2}, {0}, {0}, 1},
    {clvEXTENSION_CL_KHR_FP16,     "dot",           T_HALF,     2, {T_HALF3,   T_HALF3}, {0}, {0}, 1},
    {clvEXTENSION_CL_KHR_FP16,     "dot",           T_HALF,     2, {T_HALF4,   T_HALF4}, {0}, {0}, 1},

    {clvEXTENSION_NONE,     "cross",                T_FLOAT3,   2, {T_FLOAT3, T_FLOAT3}, {0}, {0}, 1},

    {clvEXTENSION_NONE,     "normalize",            T_F_GENTYPE,  1, {T_F_GENTYPE}, {0}, {1}, 1},
    ...
    {clvEXTENSION_NONE,     "fast_normalize",       T_F_GENTYPE,  1, {T_F_GENTYPE}, {0}, {1}, 1},
    ...
    {clvEXTENSION_NONE,     "faceforward",          T_F_GENTYPE,    3, {T_F_GENTYPE,    T_F_GENTYPE,    T_F_GENTYPE}, {0}, {1, 1, 1}, 1},
    ...
    {clvEXTENSION_NONE,     "reflect",              T_F_GENTYPE,  2, {T_F_GENTYPE, T_F_GENTYPE}, {0}, {1, 1}, 1},
    ...
    {clvEXTENSION_NONE,     "refract",              T_F_GENTYPE,  2, {T_F_GENTYPE, T_F_GENTYPE}, {0}, {1, 1}, 1},
    ...
    {clvEXTENSION_VIV_BITFIELD,     "viv_bitfieldExtract",      T_INT4,         3, {T_INT4, T_INT4, T_INT4}, {0}, {0, 1, 1}, 1},
       ...
       if(IOperand &&
          clmGEN_CODE_IsVectorDataType(OperandsParameters[0].dataTypes[0].def)) { /*Floating point vector case with no finite math */
           if (gcmOPT_DriverVIRPath() &&
               ...
               gceSTATUS   status;
               clsIOPERAND intermIOperandX, intermIOperandY;
               clsROPERAND intermROperandX, intermROperandY;
               clsIOPERAND resultIOperand;
               clsROPERAND resultROperand;
               clsIOPERAND resultIOperand1;
               clsIOPERAND selectorIOperand;
               clsROPERAND selectorROperand;
               clsROPERAND infROperand, unsignROperand;
               clsGEN_CODE_DATA_TYPE dataType;

               dataType = IOperand->dataType;
               ...
               clsIOPERAND_New(Compiler, &intermIOperandX, dataType);
               clsIOPERAND_New(Compiler, &intermIOperandY, dataType);
               clsROPERAND_InitializeUsingIOperand(&intermROperandX, &intermIOperandX);
               clsROPERAND_InitializeUsingIOperand(&intermROperandY, &intermIOperandY);
               status = clGenBitwiseExprCode(Compiler,
                                             PolynaryExpr->exprBase.base.lineNo,
                                             PolynaryExpr->exprBase.base.stringNo,
                                             clvOPCODE_AND_BITWISE,
               ...
               clsIOPERAND_New(Compiler, &selectorIOperand, dataType);
               clsROPERAND_InitializeUsingIOperand(&selectorROperand, &selectorIOperand);
               ...
               clsIOPERAND_New(Compiler, &resultIOperand, IOperand->dataType);
               clsROPERAND_InitializeUsingIOperand(&resultROperand, &resultIOperand);
               status = clGenGenericCode2(Compiler,
                                          PolynaryExpr->exprBase.base.lineNo,
                                          PolynaryExpr->exprBase.base.stringNo,
                                          clvOPCODE_MIN,
                                          ...
                                          &OperandsParameters[1].rOperands[0]);
               if (gcmIS_ERROR(status)) return status;
               clsIOPERAND_New(Compiler, &resultIOperand1, IOperand->dataType);
               status =  clGenSelectExprCode(Compiler,
                                             PolynaryExpr->exprBase.base.lineNo,
                                             PolynaryExpr->exprBase.base.stringNo,
                                             clvOPCODE_SELECT,
                                             &resultIOperand1,
               ...
               status = clGenGenericCode2(Compiler,
                                          ...
                                          &infROperand);
               if (gcmIS_ERROR(status)) return status;
               clsROPERAND_InitializeUsingIOperand(&resultROperand, &resultIOperand1);
    ...
    )
{
   ...
   if(OperandsParameters[0].rOperands[0].dataType.elementType == clvTYPE_FLOAT &&
      !(CodeGenerator->fpConfig & cldFpFINITE_MATH_ONLY)) {
       if(IOperand &&
          clmGEN_CODE_IsVectorDataType(OperandsParameters[0].dataTypes[0].def)) { /* vector type */
           if (gcmOPT_DriverVIRPath() &&
               !clmIsElementTypeHighPrecision(IOperand->dataType.elementType)) {
               gceSTATUS   status;
               clsIOPERAND intermIOperandX, intermIOperandY;
        ...
        else return _GenScalarMaxCode(Compiler,
                                      CodeGenerator,
                                      PolynaryExpr,
                                      OperandCount,
                                      OperandsParameters,
       ...
       (clmGEN_CODE_vectorSize_GET(srcType) == 16 ||
        ...
        if(!clIsIntegerZero(&OperandsParameters[0].dataTypes[0].byteOffset)) {
            ...
            status = clGenArithmeticExprCode(Compiler,
                                             ...
                                             &OperandsParameters[0].dataTypes[0].byteOffset);
            if (gcmIS_ERROR(status)) return status;
            clsROPERAND_InitializeUsingIOperand(src, addressOffset);
        }
    ...
    )
{
    ...
    if(clGetAddrSpaceQualifier(&memOperand->decl) == clvQUALIFIER_LOCAL) {
        isSrcStride = gcvTRUE;
    }
...
{
    if(clmIsElementTypeHighPrecision(clmGEN_CODE_elementType_GET(DataType))) return DataType;
    else {
...
END_FIND:
    ...
    /* 8bytes for signature, and 4bytes for the byteOffset. */
    printfBufferOffset = 12;
    for(i = 1; i < (operandsNeeded + 1); i++) {
        ...
        if(clmIsElementTypeHighPrecision(clmGEN_CODE_elementType_GET(OperandsParameters[i].dataTypes[0].def))) {
