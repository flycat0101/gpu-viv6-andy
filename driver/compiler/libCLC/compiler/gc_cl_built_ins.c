...
/* Sampler_T First byte: addressing mode. */
    {"CLK_ADDRESS_NONE",            0x0, T_SAMPLER_T, clvEXTENSION_NONE},
    {"CLK_ADDRESS_CLAMP_TO_EDGE",   0x1, T_SAMPLER_T, clvEXTENSION_NONE},
    {"CLK_ADDRESS_CLAMP",           0x2, T_SAMPLER_T, clvEXTENSION_NONE},
    {"CLK_ADDRESS_REPEAT",          0x3, T_SAMPLER_T, clvEXTENSION_NONE},
    {"CLK_ADDRESS_MIRRORED_REPEAT", 0x4, T_SAMPLER_T, clvEXTENSION_NONE},
/* Sampler_T Second byte: filter mode. */
    {"CLK_FILTER_NEAREST",          0x000, T_SAMPLER_T, clvEXTENSION_NONE},
    {"CLK_FILTER_LINEAR",           0x100, T_SAMPLER_T, clvEXTENSION_NONE},
/* Sampler_T Third byte: normalized coords. */
    {"CLK_NORMALIZED_COORDS_FALSE", 0x00000, T_SAMPLER_T, clvEXTENSION_NONE},
    {"CLK_NORMALIZED_COORDS_TRUE",  0x10000, T_SAMPLER_T, clvEXTENSION_NONE},
/* cl_channel_order */
