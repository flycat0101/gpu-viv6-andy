...
/*openGL stuff */
    {"MAXFLOAT",    0x7F7FFFFF, T_FLOAT, clvEXTENSION_NONE},
    {"HUGE_VALF",   0x7f800000, T_FLOAT, clvEXTENSION_NONE},
    {"INFINITY",    0x7f800000, T_FLOAT, clvEXTENSION_NONE},
    {"NAN",         0x7fc00000, T_FLOAT, clvEXTENSION_NONE},
/* Sampler_T First byte: addressing mode. */
    {"CLK_ADDRESS_NONE",            0x0, T_UINT, clvEXTENSION_NONE},
    {"CLK_ADDRESS_CLAMP_TO_EDGE",   0x1, T_UINT, clvEXTENSION_NONE},
    {"CLK_ADDRESS_CLAMP",           0x2, T_UINT, clvEXTENSION_NONE},
    {"CLK_ADDRESS_REPEAT",          0x3, T_UINT, clvEXTENSION_NONE},
    {"CLK_ADDRESS_MIRRORED_REPEAT", 0x4, T_UINT, clvEXTENSION_NONE},
/* Sampler_T Second byte: filter mode. */
    {"CLK_FILTER_NEAREST",          0x000, T_UINT, clvEXTENSION_NONE},
    {"CLK_FILTER_LINEAR",           0x100, T_UINT, clvEXTENSION_NONE},
/* Sampler_T Third byte: normalized coords. */
    {"CLK_NORMALIZED_COORDS_FALSE", 0x00000, T_UINT, clvEXTENSION_NONE},
    {"CLK_NORMALIZED_COORDS_TRUE",  0x10000, T_UINT, clvEXTENSION_NONE},
/* cl_channel_order */
    {"CLK_R",         0x10B0, T_UINT, clvEXTENSION_NONE},
    {"CLK_A",         0x10B1, T_UINT, clvEXTENSION_NONE},
    {"CLK_RG",        0x10B2, T_UINT, clvEXTENSION_NONE},
    {"CLK_RA",        0x10B3, T_UINT, clvEXTENSION_NONE},
    {"CLK_RGB",       0x10B4, T_UINT, clvEXTENSION_NONE},
    {"CLK_RGBA",      0x10B5, T_UINT, clvEXTENSION_NONE},
    {"CLK_BGRA",      0x10B6, T_UINT, clvEXTENSION_NONE},
    {"CLK_ARGB",      0x10B7, T_UINT, clvEXTENSION_NONE},
    {"CLK_INTENSITY", 0x10B8, T_UINT, clvEXTENSION_NONE},
    {"CLK_LUMINANCE", 0x10B9, T_UINT, clvEXTENSION_NONE},
    {"CLK_Rx",        0x10BA, T_UINT, clvEXTENSION_NONE},
    {"CLK_RGx",       0x10BB, T_UINT, clvEXTENSION_NONE},
    {"CLK_RGBx",      0x10BC, T_UINT, clvEXTENSION_NONE},
/* CLK_channel_type */
    {"CLK_SNORM_INT8",      0x10D0, T_UINT, clvEXTENSION_NONE},
    {"CLK_SNORM_INT16",     0x10D1, T_UINT, clvEXTENSION_NONE},
    {"CLK_UNORM_INT8",      0x10D2, T_UINT, clvEXTENSION_NONE},
    {"CLK_UNORM_INT16",     0x10D3, T_UINT, clvEXTENSION_NONE},
    {"CLK_UNORM_SHORT_565", 0x10D4, T_UINT, clvEXTENSION_NONE},
    {"CLK_UNORM_SHORT_555", 0x10D5, T_UINT, clvEXTENSION_NONE},
    {"CLK_UNORM_INT_101010",0x10D6, T_UINT, clvEXTENSION_NONE},
    {"CLK_SIGNED_INT8",     0x10D7, T_UINT, clvEXTENSION_NONE},
    {"CLK_SIGNED_INT16",    0x10D8, T_UINT, clvEXTENSION_NONE},
    {"CLK_SIGNED_INT32",    0x10D9, T_UINT, clvEXTENSION_NONE},
    {"CLK_UNSIGNED_INT8",   0x10DA, T_UINT, clvEXTENSION_NONE},
    {"CLK_UNSIGNED_INT16",  0x10DB, T_UINT, clvEXTENSION_NONE},
    {"CLK_UNSIGNED_INT32",  0x10DC, T_UINT, clvEXTENSION_NONE},
    {"CLK_HALF_FLOAT",      0x10DD, T_UINT, clvEXTENSION_NONE},
    {"CLK_FLOAT",           0x10DE, T_UINT, clvEXTENSION_NONE},

    {"CLK_LOCAL_MEM_FENCE", 0x1, T_UINT, clvEXTENSION_NONE},
    {"CLK_GLOBAL_MEM_FENCE", 0x2, T_UINT, clvEXTENSION_NONE},

    /* Numerical constants. */
    {"CHAR_BIT",    0x00000008  /* 8 */,                T_UINT, clvEXTENSION_NONE},
    {"SCHAR_MAX",   0x0000007F  /* 127 */,              T_CHAR, clvEXTENSION_NONE},
    {"SCHAR_MIN",   0xFFFFFF80  /* (-127-1) */,         T_CHAR, clvEXTENSION_NONE},
    {"CHAR_MAX",    0x0000007F  /* 127 */,              T_CHAR, clvEXTENSION_NONE},
    {"CHAR_MIN",    0xFFFFFF80  /* (-127-1) */,         T_CHAR, clvEXTENSION_NONE},
    {"UCHAR_MAX",   0x000000FF  /* 255 */,              T_UCHAR, clvEXTENSION_NONE},
    {"SHRT_MAX",    0x00007FFF  /* 32767 */,            T_SHORT, clvEXTENSION_NONE},
    {"SHRT_MIN",    0xFFFF8000  /* (-32767-1) */,       T_SHORT, clvEXTENSION_NONE},
    {"USHRT_MAX",   0x0000FFFF  /* 65535 */,            T_USHORT, clvEXTENSION_NONE},
    {"INT_MAX",     0x7FFFFFFF  /* 2147483647 */,       T_INT, clvEXTENSION_NONE},
    {"INT_MIN",     0x80000000  /* (-2147483647-1) */,  T_INT, clvEXTENSION_NONE},
    {"UINT_MAX",    0xFFFFFFFF, /* 4294967295 */        T_UINT, clvEXTENSION_NONE},
    /* long/ulong are not supported. */
    {"LONG_MAX",    0x7FFFFFFFFFFFFFFFLL,          T_LONG, clvEXTENSION_NONE},
    {"LONG_MIN",    (gctUINT64)(-0x7FFFFFFFFFFFFFFFLL - 1LL), T_LONG, clvEXTENSION_NONE},
    {"ULONG_MAX",   0xFFFFFFFFFFFFFFFFULL,         T_ULONG, clvEXTENSION_NONE},

    {"FLT_DIG",         0x6         /* 6 */,      T_UINT, clvEXTENSION_NONE},
    {"FLT_MANT_DIG",    0x18        /* 24 */,     T_UINT, clvEXTENSION_NONE},
    {"FLT_MAX_10_EXP",  0x26        /* +38 */,    T_INT, clvEXTENSION_NONE},
    {"FLT_MAX_EXP",     0x80        /* +128 */,   T_INT, clvEXTENSION_NONE},
    {"FLT_MIN_10_EXP",  0xFFFFFFDB  /* -37 */,    T_INT, clvEXTENSION_NONE},
    {"FLT_MIN_EXP",     0xFFFFFF83  /* -125 */,   T_INT, clvEXTENSION_NONE},
    {"FLT_RADIX",       0x2         /* 2 */,      T_UINT, clvEXTENSION_NONE},
    {"FLT_MAX",         0x7F7FFFFF  /* 340282346638528859811704183484516925440.0f */, T_FLOAT, clvEXTENSION_NONE},
    {"FLT_MIN",         0x00800000  /* 1.175494350822287507969e-38f */,               T_FLOAT, clvEXTENSION_NONE},
    {"FLT_EPSILON",     0x34000000  /* 1.1920928955078125e-7f */,                     T_FLOAT, clvEXTENSION_NONE},

    {"FP_ILOGB0",       0x80000000  /* (-2147483647-1) */,  T_INT, clvEXTENSION_NONE},
    {"FP_ILOGBNAN",     0x7FFFFFFF  /* 2147483647 */,       T_INT, clvEXTENSION_NONE},

    {"M_E_F",           0x402df854  /* 2.71828174591064f */, T_FLOAT, clvEXTENSION_NONE},
    {"M_LOG2E_F",       0x3FB8AA3B  /* 1.44269502162933f */, T_FLOAT, clvEXTENSION_NONE},
    {"M_LOG10E_F",      0x3EDE5BD9  /* 0.43429449200630f */, T_FLOAT, clvEXTENSION_NONE},
    {"M_LN2_F",         0x3F317218  /* 0.69314718246460f */, T_FLOAT, clvEXTENSION_NONE},
    {"M_LN10_F",        0x40135D8E  /* 2.30258512496948f */, T_FLOAT, clvEXTENSION_NONE},
    {"M_PI_F",          0x40490FDB  /* 3.14159274101257f */, T_FLOAT, clvEXTENSION_NONE},
    {"M_PI_2_F",        0x3FC90FDB  /* 1.57079637050629f */, T_FLOAT, clvEXTENSION_NONE},
    {"M_PI_4_F",        0x3F490FDB  /* 0.78539818525314f */, T_FLOAT, clvEXTENSION_NONE},
    {"M_1_PI_F",        0x3EA2F983  /* 0.31830987334251f */, T_FLOAT, clvEXTENSION_NONE},
    {"M_2_PI_F",        0x3F22F983  /* 0.63661974668503f */, T_FLOAT, clvEXTENSION_NONE},
    {"M_2_SQRTPI_F",    0x3F906EBB  /* 1.12837922573090f */, T_FLOAT, clvEXTENSION_NONE},
    {"M_SQRT2_F",       0x3FB504F3  /* 1.41421353816986f */, T_FLOAT, clvEXTENSION_NONE},
    {"M_SQRT1_2_F",     0x3F3504F3  /* 0.70710676908493f */, T_FLOAT, clvEXTENSION_NONE},

/* For DOUBLE */
    {"M_E",           0x402df854  /* 2.71828174591064f */, HAS_DOUBLE_SUPPORT ? T_DOUBLE : T_FLOAT, clvEXTENSION_NONE},
    {"M_LOG2E",       0x3FB8AA3B  /* 1.44269502162933f */, HAS_DOUBLE_SUPPORT ? T_DOUBLE : T_FLOAT, clvEXTENSION_NONE},
    {"M_LOG10E",      0x3EDE5BD9  /* 0.43429449200630f */, HAS_DOUBLE_SUPPORT ? T_DOUBLE : T_FLOAT, clvEXTENSION_NONE},
    {"M_LN2",         0x3F317218  /* 0.69314718246460f */, HAS_DOUBLE_SUPPORT ? T_DOUBLE : T_FLOAT, clvEXTENSION_NONE},
    {"M_LN10",        0x40135D8E  /* 2.30258512496948f */, HAS_DOUBLE_SUPPORT ? T_DOUBLE : T_FLOAT, clvEXTENSION_NONE},
    {"M_PI",          0x40490FDB  /* 3.14159274101257f */, HAS_DOUBLE_SUPPORT ? T_DOUBLE : T_FLOAT, clvEXTENSION_NONE},
    {"M_PI_2",        0x3FC90FDB  /* 1.57079637050629f */, HAS_DOUBLE_SUPPORT ? T_DOUBLE : T_FLOAT, clvEXTENSION_NONE},
    {"M_PI_4",        0x3F490FDB  /* 0.78539818525314f */, HAS_DOUBLE_SUPPORT ? T_DOUBLE : T_FLOAT, clvEXTENSION_NONE},
    {"M_1_PI",        0x3EA2F983  /* 0.31830987334251f */, HAS_DOUBLE_SUPPORT ? T_DOUBLE : T_FLOAT, clvEXTENSION_NONE},
    {"M_2_PI",        0x3F22F983  /* 0.63661974668503f */, HAS_DOUBLE_SUPPORT ? T_DOUBLE : T_FLOAT, clvEXTENSION_NONE},
    {"M_2_SQRTPI",    0x3F906EBB  /* 1.12837922573090f */, HAS_DOUBLE_SUPPORT ? T_DOUBLE : T_FLOAT, clvEXTENSION_NONE},
    {"M_SQRT2",       0x3FB504F3  /* 1.41421353816986f */, HAS_DOUBLE_SUPPORT ? T_DOUBLE : T_FLOAT, clvEXTENSION_NONE},
    {"M_SQRT1_2",     0x3F3504F3  /* 0.70710676908493f */, HAS_DOUBLE_SUPPORT ? T_DOUBLE : T_FLOAT, clvEXTENSION_NONE},

/* For Half macros */
    {"HALF_DIG",         0x3         /* 3 */,      T_UINT,   clvEXTENSION_CL_KHR_FP16},
    {"HALF_MANT_DIG",    0xB         /* 11 */,     T_UINT,   clvEXTENSION_CL_KHR_FP16},
    {"HALF_MAX_10_EXP",  0x4         /* +4 */,     T_INT,    clvEXTENSION_CL_KHR_FP16},
    {"HALF_MAX_EXP",     0x10        /* +16 */,    T_INT,    clvEXTENSION_CL_KHR_FP16},
    {"HALF_MIN_10_EXP",  0xFFFFFFFC  /* -4 */,     T_INT,    clvEXTENSION_CL_KHR_FP16},
    {"HALF_MIN_EXP",     0xFFFFFFF3  /* -13 */,    T_INT,    clvEXTENSION_CL_KHR_FP16},
    {"HALF_RADIX",       0x2         /* 2 */,      T_UINT,   clvEXTENSION_CL_KHR_FP16},
    {"HALF_MAX",         0x477fE000  /* 0x1.ffcp15h */,   T_HALF,    clvEXTENSION_CL_KHR_FP16},
    {"HALF_MIN",         0x38800000  /* 0x1.0p-14h */,    T_HALF,    clvEXTENSION_CL_KHR_FP16},
    {"HALF_HALF_EPSILON",0x3a800000  /* 0x1.0p-10h */,    T_HALF,    clvEXTENSION_CL_KHR_FP16},

    {"M_E_H",            0x402df854  /* 2.71828174591064f */,  T_HALF, clvEXTENSION_NONE},
    {"M_LOG2E_H",        0x3FB8AA3B  /* 1.44269502162933f */,  T_HALF, clvEXTENSION_NONE},
    {"M_LOG10E_H",       0x3EDE5BD9  /* 0.43429449200630f */,  T_HALF, clvEXTENSION_NONE},
    {"M_LN2_H",          0x3F317218  /* 0.69314718246460f */,  T_HALF, clvEXTENSION_NONE},
    {"M_LN10_H",         0x40135D8E  /* 2.30258512496948f */,  T_HALF, clvEXTENSION_NONE},
    {"M_PI_H",           0x40490FDB  /* 3.14159274101257f */,  T_HALF, clvEXTENSION_NONE},
    {"M_PI_2_H",         0x3FC90FDB  /* 1.57079637050629f */,  T_HALF, clvEXTENSION_NONE},
    {"M_PI_4_H",         0x3F490FDB  /* 0.78539818525314f */,  T_HALF, clvEXTENSION_NONE},
    {"M_1_PI_H",         0x3EA2F983  /* 0.31830987334251f */,  T_HALF, clvEXTENSION_NONE},
    {"M_2_PI_H",         0x3F22F983  /* 0.63661974668503f */,  T_HALF, clvEXTENSION_NONE},
    {"M_2_SQRTPI_H",     0x3F906EBB  /* 1.12837922573090f */,  T_HALF, clvEXTENSION_NONE},
    {"M_SQRT2_H",        0x3FB504F3  /* 1.41421353816986f */,  T_HALF, clvEXTENSION_NONE},
    {"M_SQRT1_2_H",      0x3F3504F3  /* 0.70710676908493f */,  T_HALF, clvEXTENSION_NONE},
    };
...
static clsBUILTIN_UNNAMED_VARIABLE _BuiltinUnnamedVariables[] = {
    ...
    {clvBUILTIN_GLOBAL_SIZE, clvQUALIFIER_UNIFORM, clvQUALIFIER_NONE, T_UINT4, gcvFALSE, _sldGlobalSizeName},
    {clvBUILTIN_GLOBAL_WORK_SCALE, clvQUALIFIER_UNIFORM, clvQUALIFIER_NONE, T_UINT4, gcvFALSE, "#global_work_scale"},
    {clvBUILTIN_LOCAL_SIZE, clvQUALIFIER_UNIFORM, clvQUALIFIER_NONE, T_UINT4, gcvFALSE, _sldLocalSizeName},
    {clvBUILTIN_GLOBAL_INVOCATION_INDEX, clvQUALIFIER_ATTRIBUTE, clvQUALIFIER_NONE, T_UINT, gcvFALSE, "#global_invocation_index"},
    {clvBUILTIN_LOCAL_INVOCATION_INDEX, clvQUALIFIER_ATTRIBUTE, clvQUALIFIER_NONE, T_UINT, gcvFALSE, _sldLocalInvocationIndexName},
    ...
    {clvBUILTIN_GLOBAL_OFFSET, clvQUALIFIER_UNIFORM, clvQUALIFIER_NONE, T_UINT4, gcvFALSE, _sldGlobalOffsetName},
...
static clsBUILTIN_FUNCTION_INFO    _BuiltinFunctionInfos[] =
{
    ...
    {"vloada_half",     gcvFALSE,       gcvFALSE,       gcvNULL, _GenVloadaHalfCode},
    {"vloada_half2",    gcvFALSE,       gcvFALSE,       gcvNULL, _GenVloadaHalfCode},
    {"vloada_half3",    gcvFALSE,       gcvFALSE,       gcvNULL, _GenVloadaHalfCode},
    {"vloada_half4",    gcvFALSE,       gcvFALSE,       gcvNULL, _GenVloadaHalfCode},
    {"vloada_half8",    gcvFALSE,       gcvFALSE,       gcvNULL, _GenVloadaHalfCode},
    {"vloada_half16",   gcvFALSE,       gcvFALSE,       gcvNULL, _GenVloadaHalfCode},
    ...
    {"vstore_half_rte",     gcvFALSE,       gcvFALSE,       gcvNULL, _GenVstoreHalfRteCode},
    {"vstore_half2_rte",    gcvFALSE,       gcvFALSE,       gcvNULL, _GenVstoreHalfRteCode},
    {"vstore_half3_rte",    gcvFALSE,       gcvFALSE,       gcvNULL, _GenVstoreHalfRteCode},
    ...
    {"vstorea_half4",   gcvFALSE,       gcvFALSE,       gcvNULL, _GenVstoreaHalfCode},
    {"vstorea_half8",   gcvFALSE,       gcvFALSE,       gcvNULL, _GenVstoreaHalfCode},
    {"vstorea_half16",  gcvFALSE,       gcvFALSE,       gcvNULL, _GenVstoreaHalfCode},
    {"vstorea_half_rte",    gcvFALSE,       gcvFALSE,       gcvNULL, _GenVstoreaHalfRteCode},
    {"vstorea_half2_rte",   gcvFALSE,       gcvFALSE,       gcvNULL, _GenVstoreaHalfRteCode},
    {"vstorea_half3_rte",   gcvFALSE,       gcvFALSE,       gcvNULL, _GenVstoreaHalfRteCode},
