...
#undef TOSTR2
  ...
  // Macros to control image support
  Builder.defineMacro("__IMAGE_SUPPORT__", "1");

  // Macro for endianness
  Builder.defineMacro("__ENDIAN_LITTLE__", "1");

  // Macro for OpenCL version
  Builder.defineMacro("__OPENCL_VERSION__", "110");

  // Macro for OpenCL Language version
  Builder.defineMacro("__OPENCL_C_VERSION__", LangOpts.OpenCLVersion);

  // Macro for kernel exec
