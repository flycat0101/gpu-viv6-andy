...
static void ParseHeaderSearchArgs(HeaderSearchOptions &Opts, ArgList &Args) {
  ...
  // Move declaration of it and ie out of for loop to make WinCE compiler happy.
  arg_iterator it = Args.filtered_begin(OPT_I, OPT_F);
...
////KLC comment out handling of PCH for NOW, IT WOULD JUST CONTINUE IF FOUND
        continue;
    } else
...
/*** KLC commenent out ones don't need ***/
