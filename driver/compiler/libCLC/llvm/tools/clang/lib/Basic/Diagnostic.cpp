...
static const StaticDiagInfoRec *GetDiagInfo(unsigned DiagID) {
  ...
  StaticDiagInfoRec Find = { (unsigned short)DiagID, 0, 0, 0, 0, 0, 0 };
...
#else
  DelayedDiagArg1.erase(DelayedDiagArg1.begin(), DelayedDiagArg1.end());
  DelayedDiagArg2.erase(DelayedDiagArg2.begin(), DelayedDiagArg2.end());
#endif
}
...
Diagnostic::getDiagnosticLevel(unsigned DiagID, unsigned DiagClass) const {
  ...
  default: assert(0 && "Unknown mapping!");break;
