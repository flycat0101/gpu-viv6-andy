...
public:
  ...
  bool hasVolatile() const { return ((Mask & Volatile) ? true : false); }
  ...
  bool hasRestrict() const { return ((Mask & Restrict) ? true : false); }
  ...
  bool hasCVRQualifiers() const { return (getCVRQualifiers() ? true : false); }
  ...
  bool hasObjCGCAttr() const { return ((Mask & GCAttrMask) ? true : false); }
  ...
  bool hasAddressSpace() const { return ((Mask & AddressSpaceMask) ? true : false); }
  ...
  bool hasFastQualifiers() const { return (getFastQualifiers() ? true : false); }
  ...
  bool hasNonFastQualifiers() const { return ((Mask & ~FastMask) ? true : false); }
  ...
  bool hasQualifiers() const { return (Mask ? true : false); }
...
public:
  ...
  bool isLocalRestrictQualified() const {
    return ((getLocalFastQualifiers() & Qualifiers::Restrict) ? true : false);
  }
  ...
  bool hasLocalNonFastQualifiers() const {
    return ((Value.getPointer().is<const ExtQuals*>()) ? true : false);
  }
...
public:
  ...
  bool isFunctionNoProtoType() const { return (getAs<FunctionNoProtoType>() ? true : false); }
  bool isFunctionProtoType() const { return (getAs<FunctionProtoType>() ? true : false); }
...
inline bool Type::isBuiltinType() const {
  return (getAs<BuiltinType>() ? true : false);
}
