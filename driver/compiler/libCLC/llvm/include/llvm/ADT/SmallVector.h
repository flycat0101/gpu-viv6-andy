...
#else
    // If following calling results in wrong number result, use code commented out instead.
    //size_type NumInputs = 0;
    size_type NumInputs = 0;
    in_iter startTmp = in_start;
    for (; startTmp != in_end; ++startTmp)
        ++NumInputs;
#endif
