...
define PINFO
PINFO DESCRIPTION="illegal_vector_sizes"
endef

NAME=illegal_vector_sizes
...
SOURCE_OBJECTS += $(CL11_TEST_DIR)/UnitTest/test_vivante/illegal_vector_sizes/main.o
SOURCE_OBJECTS += $(CL11_TEST_DIR)/UnitTest/test_vivante/illegal_vector_sizes/testcases.o
SOURCE_OBJECTS += $(CL11_TEST_DIR)/UnitTest/test_vivante/illegal_vector_sizes/vectorgenerator.o
SOURCE_OBJECTS += $(CL11_TEST_DIR)/UnitTest/test_vivante/illegal_vector_sizes/kernelgenerator.o
EXTRA_SRCVPATH += $(CL11_TEST_DIR)/UnitTest/test_vivante/illegal_vector_sizes
