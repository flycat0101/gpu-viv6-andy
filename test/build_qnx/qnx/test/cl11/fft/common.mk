...
SOURCE_OBJECTS += $(CL11_TEST_DIR)/fft/clutil.o
SOURCE_OBJECTS += $(CL11_TEST_DIR)/fft/fft.o
SOURCE_OBJECTS += $(CL11_TEST_DIR)/fft/main.o
EXTRA_SRCVPATH += $(CL11_TEST_DIR)/fft
...
LDOPTS += -lGAL -lVSC -lLLVM_viv -lCLC -lOpenCL

include $(qnx_build_dir)/math.mk

INSTALLDIR=$(firstword $(INSTALLDIR_$(OS)) samples/cl11)
