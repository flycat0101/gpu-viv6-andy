...
SOURCE_OBJECTS += $(VDK_TEST_DIR)/es11/tutorial5/main.o
SOURCE_OBJECTS += $(VDK_TEST_DIR)/es11/tutorial5/font.o
SOURCE_OBJECTS += $(VDK_TEST_DIR)/es11/tutorial5/render.o

EXTRA_SRCVPATH += $(VDK_TEST_DIR)/es11/tutorial5
...
LDOPTS += -lGAL -lVSC -lVDK -lEGL_viv -lGLES_CM_viv
