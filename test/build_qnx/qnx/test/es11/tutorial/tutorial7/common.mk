...
SOURCE_OBJECTS += $(VDK_TEST_DIR)/es11/tutorial7/main.o
SOURCE_OBJECTS += $(VDK_TEST_DIR)/es11/tutorial7/font.o
SOURCE_OBJECTS += $(VDK_TEST_DIR)/es11/tutorial7/render.o
SOURCE_OBJECTS += $(VDK_TEST_DIR)/es11/tutorial7/mesh.o
SOURCE_OBJECTS += $(VDK_TEST_DIR)/es11/tutorial7/texture.o
SOURCE_OBJECTS += $(VDK_TEST_DIR)/es11/tutorial7/timer.o

EXTRA_SRCVPATH += $(VDK_TEST_DIR)/es11/tutorial7
