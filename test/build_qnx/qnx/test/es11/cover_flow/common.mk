...
MY_SRC := $(VDK_TEST_DIR)/cover_flow

EXTRA_INCVPATH += $(driver_root)/hal/inc
EXTRA_INCVPATH += $(driver_root)/sdk/inc

SOURCE_OBJECTS += $(wildcard $(MY_SRC)/*.c)
EXTRA_SRCVPATH += $(MY_SRC)
...
LIBS += GAL VDK EGL GLESv1_CM

include $(qnx_build_dir)/math.mk

INSTALLDIR=$(firstword $(INSTALLDIR_$(OS)) samples/es11/)
