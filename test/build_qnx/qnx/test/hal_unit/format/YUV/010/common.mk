...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV010.so"
endef

NAME=gal2DFormatYUV010
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/010/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/010
