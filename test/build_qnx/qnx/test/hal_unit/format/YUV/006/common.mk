...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV006.so"
endef

NAME=gal2DFormatYUV006
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/006/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/006
