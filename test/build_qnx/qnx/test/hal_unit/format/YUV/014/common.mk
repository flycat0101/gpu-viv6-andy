...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV014.so"
endef

NAME=gal2DFormatYUV014
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/014/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/014
