...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV008.so"
endef

NAME=gal2DFormatYUV008
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/008/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/008
