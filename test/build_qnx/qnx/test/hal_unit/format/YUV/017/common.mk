...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV017.so"
endef

NAME=gal2DFormatYUV017
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/017/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/017
