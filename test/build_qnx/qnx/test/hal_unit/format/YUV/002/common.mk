...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV002.so"
endef

NAME=gal2DFormatYUV002
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/002/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/002
