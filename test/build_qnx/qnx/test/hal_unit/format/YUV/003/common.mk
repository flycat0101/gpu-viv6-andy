...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV003.so"
endef

NAME=gal2DFormatYUV003
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/003/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/003
