...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV005.so"
endef

NAME=gal2DFormatYUV005
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/005/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/005
