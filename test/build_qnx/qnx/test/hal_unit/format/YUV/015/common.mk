...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV015.so"
endef

NAME=gal2DFormatYUV015
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/015/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/015
