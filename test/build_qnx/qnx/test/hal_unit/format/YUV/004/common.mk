...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV004.so"
endef

NAME=gal2DFormatYUV004
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/004/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/004
