...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV013.so"
endef

NAME=gal2DFormatYUV013
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/013/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/013
