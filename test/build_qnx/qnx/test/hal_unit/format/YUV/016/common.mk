...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV016.so"
endef

NAME=gal2DFormatYUV016
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/016/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/016
