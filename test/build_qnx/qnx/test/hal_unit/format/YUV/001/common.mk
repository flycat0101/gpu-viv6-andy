...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV001.so"
endef

NAME=gal2DFormatYUV001
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/001/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/001
