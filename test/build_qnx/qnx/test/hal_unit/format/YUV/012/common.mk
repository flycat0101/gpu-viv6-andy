...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV012.so"
endef

NAME=gal2DFormatYUV012
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/012/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/012
