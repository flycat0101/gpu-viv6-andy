...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV007.so"
endef

NAME=gal2DFormatYUV007
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/007/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/007
