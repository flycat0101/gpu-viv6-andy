...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV011.so"
endef

NAME=gal2DFormatYUV011
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/011/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/011
