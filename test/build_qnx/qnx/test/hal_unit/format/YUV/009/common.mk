...
define PINFO
PINFO DESCRIPTION="libgal2DFormatYUV009.so"
endef

NAME=gal2DFormatYUV009
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/YUV/009/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/YUV/009
