...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTileStatus010.so"
endef

NAME=gal2DFormatTileStatus010
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/TileStatus/010/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/TileStatus/010
