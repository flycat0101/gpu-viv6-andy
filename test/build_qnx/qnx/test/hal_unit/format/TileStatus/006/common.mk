...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTileStatus006.so"
endef

NAME=gal2DFormatTileStatus006
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/TileStatus/006/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/TileStatus/006
