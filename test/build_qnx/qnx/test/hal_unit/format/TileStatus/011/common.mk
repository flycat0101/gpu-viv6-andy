...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTileStatus011.so"
endef

NAME=gal2DFormatTileStatus011
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/TileStatus/011/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/TileStatus/011
