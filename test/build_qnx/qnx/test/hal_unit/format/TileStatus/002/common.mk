...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTileStatus002.so"
endef

NAME=gal2DFormatTileStatus002
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/TileStatus/002/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/TileStatus/002
