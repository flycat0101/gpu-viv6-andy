...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTileStatus015.so"
endef

NAME=gal2DFormatTileStatus015
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/TileStatus/015/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/TileStatus/015
