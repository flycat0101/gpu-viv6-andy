...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTileStatus016.so"
endef

NAME=gal2DFormatTileStatus016
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/TileStatus/016/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/TileStatus/016
