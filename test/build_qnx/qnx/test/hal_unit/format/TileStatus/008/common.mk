...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTileStatus008.so"
endef

NAME=gal2DFormatTileStatus008
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/TileStatus/008/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/TileStatus/008
