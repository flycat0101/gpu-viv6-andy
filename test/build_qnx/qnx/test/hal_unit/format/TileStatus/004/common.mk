...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTileStatus004.so"
endef

NAME=gal2DFormatTileStatus004
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/TileStatus/004/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/TileStatus/004
