...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTileStatus005.so"
endef

NAME=gal2DFormatTileStatus005
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/TileStatus/005/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/TileStatus/005
