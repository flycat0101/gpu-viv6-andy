...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTileStatus009.so"
endef

NAME=gal2DFormatTileStatus009
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/TileStatus/009/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/TileStatus/009
