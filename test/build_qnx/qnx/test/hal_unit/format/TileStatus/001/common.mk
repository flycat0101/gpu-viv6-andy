...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTileStatus001.so"
endef

NAME=gal2DFormatTileStatus001
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/TileStatus/001/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/TileStatus/001
