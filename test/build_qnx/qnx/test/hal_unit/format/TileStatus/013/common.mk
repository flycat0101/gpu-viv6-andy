...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTileStatus013.so"
endef

NAME=gal2DFormatTileStatus013
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/TileStatus/013/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/TileStatus/013
