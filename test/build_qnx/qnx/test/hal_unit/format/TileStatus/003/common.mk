...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTileStatus003.so"
endef

NAME=gal2DFormatTileStatus003
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/TileStatus/003/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/TileStatus/003
