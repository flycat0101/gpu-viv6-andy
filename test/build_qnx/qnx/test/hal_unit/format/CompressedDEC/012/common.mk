...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC012.so"
endef

NAME=gal2DFormatCompressedDEC012
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/012/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/012
