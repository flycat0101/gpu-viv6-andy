...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC002.so"
endef

NAME=gal2DFormatCompressedDEC002
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/002/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/002
