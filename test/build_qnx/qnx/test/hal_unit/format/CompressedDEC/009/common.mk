...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC009.so"
endef

NAME=gal2DFormatCompressedDEC009
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/009/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/009
