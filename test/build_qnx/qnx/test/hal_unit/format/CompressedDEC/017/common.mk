...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC017.so"
endef

NAME=gal2DFormatCompressedDEC017
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/017/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/017
