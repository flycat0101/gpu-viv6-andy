...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC007.so"
endef

NAME=gal2DFormatCompressedDEC007
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/007/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/007
