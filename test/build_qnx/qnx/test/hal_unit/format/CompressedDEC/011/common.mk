...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC011.so"
endef

NAME=gal2DFormatCompressedDEC011
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/011/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/011
