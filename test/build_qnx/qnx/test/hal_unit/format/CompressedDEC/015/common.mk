...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC015.so"
endef

NAME=gal2DFormatCompressedDEC015
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/015/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/015
