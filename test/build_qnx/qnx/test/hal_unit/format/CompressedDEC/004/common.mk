...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC004.so"
endef

NAME=gal2DFormatCompressedDEC004
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/004/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/004
