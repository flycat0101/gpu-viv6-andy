...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC010.so"
endef

NAME=gal2DFormatCompressedDEC010
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/010/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/010
