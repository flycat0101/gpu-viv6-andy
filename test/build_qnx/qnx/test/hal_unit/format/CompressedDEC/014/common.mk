...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC014.so"
endef

NAME=gal2DFormatCompressedDEC014
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/014/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/014
