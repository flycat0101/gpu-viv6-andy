...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC006.so"
endef

NAME=gal2DFormatCompressedDEC006
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/006/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/006
