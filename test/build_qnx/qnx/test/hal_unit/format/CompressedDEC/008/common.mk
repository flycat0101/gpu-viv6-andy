...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC008.so"
endef

NAME=gal2DFormatCompressedDEC008
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/008/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/008
