...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC005.so"
endef

NAME=gal2DFormatCompressedDEC005
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/005/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/005
