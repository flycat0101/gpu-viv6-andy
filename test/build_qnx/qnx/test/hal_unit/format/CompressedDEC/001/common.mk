...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC001.so"
endef

NAME=gal2DFormatCompressedDEC001
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/001/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/001
