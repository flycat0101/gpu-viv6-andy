...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC003.so"
endef

NAME=gal2DFormatCompressedDEC003
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/003/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/003
