...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC013.so"
endef

NAME=gal2DFormatCompressedDEC013
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/013/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/013
