...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedDEC016.so"
endef

NAME=gal2DFormatCompressedDEC016
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedDEC/016/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedDEC/016
