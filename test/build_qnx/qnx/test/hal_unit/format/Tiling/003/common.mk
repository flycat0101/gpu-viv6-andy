...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTiling003.so"
endef

NAME=gal2DFormatTiling003
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/Tiling/003/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/Tiling/003
