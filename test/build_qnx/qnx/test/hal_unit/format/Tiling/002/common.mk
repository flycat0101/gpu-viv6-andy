...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTiling002.so"
endef

NAME=gal2DFormatTiling002
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/Tiling/002/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/Tiling/002
