...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTiling005.so"
endef

NAME=gal2DFormatTiling005
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/Tiling/005/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/Tiling/005
