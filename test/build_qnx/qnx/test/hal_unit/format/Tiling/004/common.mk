...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTiling004.so"
endef

NAME=gal2DFormatTiling004
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/Tiling/004/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/Tiling/004
