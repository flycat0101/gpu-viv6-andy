...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTiling013.so"
endef

NAME=gal2DFormatTiling013
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/Tiling/013/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/Tiling/013
