...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTiling009.so"
endef

NAME=gal2DFormatTiling009
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/Tiling/009/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/Tiling/009
