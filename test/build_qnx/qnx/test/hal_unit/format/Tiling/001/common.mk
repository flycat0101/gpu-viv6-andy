...
define PINFO
PINFO DESCRIPTION="libgal2DFormatTiling001.so"
endef

NAME=gal2DFormatTiling001
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/Tiling/001/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/Tiling/001
