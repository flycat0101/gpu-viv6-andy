...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedTPC005.so"
endef

NAME=gal2DFormatCompressedTPC005
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedTPC/005/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedTPC/005
