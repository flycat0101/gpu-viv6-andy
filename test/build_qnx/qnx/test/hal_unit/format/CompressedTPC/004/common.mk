...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedTPC004.so"
endef

NAME=gal2DFormatCompressedTPC004
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedTPC/004/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedTPC/004
