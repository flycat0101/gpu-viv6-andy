...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedTPC011.so"
endef

NAME=gal2DFormatCompressedTPC011
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedTPC/011/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedTPC/011
