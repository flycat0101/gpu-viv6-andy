...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedTPC008.so"
endef

NAME=gal2DFormatCompressedTPC008
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedTPC/008/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedTPC/008
