...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedTPC014.so"
endef

NAME=gal2DFormatCompressedTPC014
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedTPC/014/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedTPC/014
