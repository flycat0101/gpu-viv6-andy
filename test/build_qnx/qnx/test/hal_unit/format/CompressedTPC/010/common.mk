...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedTPC010.so"
endef

NAME=gal2DFormatCompressedTPC010
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedTPC/010/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedTPC/010
