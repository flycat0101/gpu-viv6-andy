...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedTPC016.so"
endef

NAME=gal2DFormatCompressedTPC016
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedTPC/016/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedTPC/016
