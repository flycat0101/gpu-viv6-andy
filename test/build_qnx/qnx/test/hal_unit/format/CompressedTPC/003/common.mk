...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedTPC003.so"
endef

NAME=gal2DFormatCompressedTPC003
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedTPC/003/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedTPC/003
