...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedTPC012.so"
endef

NAME=gal2DFormatCompressedTPC012
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedTPC/012/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedTPC/012
