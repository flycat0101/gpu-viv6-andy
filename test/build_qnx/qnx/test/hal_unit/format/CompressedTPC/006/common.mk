...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedTPC006.so"
endef

NAME=gal2DFormatCompressedTPC006
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedTPC/006/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedTPC/006
