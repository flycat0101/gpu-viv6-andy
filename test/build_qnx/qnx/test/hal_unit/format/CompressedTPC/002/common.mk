...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedTPC002.so"
endef

NAME=gal2DFormatCompressedTPC002
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedTPC/002/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedTPC/002
