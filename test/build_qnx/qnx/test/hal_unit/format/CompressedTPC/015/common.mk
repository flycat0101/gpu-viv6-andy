...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedTPC015.so"
endef

NAME=gal2DFormatCompressedTPC015
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedTPC/015/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedTPC/015
