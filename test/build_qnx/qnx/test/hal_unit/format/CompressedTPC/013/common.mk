...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedTPC013.so"
endef

NAME=gal2DFormatCompressedTPC013
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedTPC/013/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedTPC/013
