...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedTPC007.so"
endef

NAME=gal2DFormatCompressedTPC007
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedTPC/007/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedTPC/007
