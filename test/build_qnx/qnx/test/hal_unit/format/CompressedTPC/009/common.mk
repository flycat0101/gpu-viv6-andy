...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedTPC009.so"
endef

NAME=gal2DFormatCompressedTPC009
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedTPC/009/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedTPC/009
