...
define PINFO
PINFO DESCRIPTION="libgal2DFormatCompressedTPC001.so"
endef

NAME=gal2DFormatCompressedTPC001
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/format/CompressedTPC/001/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/format/CompressedTPC/001
