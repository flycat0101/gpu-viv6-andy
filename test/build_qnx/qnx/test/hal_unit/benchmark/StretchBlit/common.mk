...
define PINFO
PINFO DESCRIPTION="libgal2DBenchmarkStretchBlit.so"
endef

NAME=gal2DBenchmarkStretchBlit
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/benchmark/StretchBlit/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/benchmark/StretchBlit
