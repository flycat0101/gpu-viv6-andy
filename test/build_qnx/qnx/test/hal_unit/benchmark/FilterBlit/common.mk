...
define PINFO
PINFO DESCRIPTION="libgal2DBenchmarkFilterBlit.so"
endef

NAME=gal2DBenchmarkFilterBlit
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/benchmark/FilterBlit/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/benchmark/FilterBlit
