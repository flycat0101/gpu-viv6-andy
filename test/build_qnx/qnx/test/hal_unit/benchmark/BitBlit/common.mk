...
define PINFO
PINFO DESCRIPTION="libgal2DBenchmarkBitBlit.so"
endef

NAME=gal2DBenchmarkBitBlit
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/benchmark/BitBlit/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/benchmark/BitBlit
