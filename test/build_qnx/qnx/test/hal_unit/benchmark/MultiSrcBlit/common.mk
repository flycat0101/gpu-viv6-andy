...
define PINFO
PINFO DESCRIPTION="libgal2DBenchmarkMultiSrcBlit.so"
endef

NAME=gal2DBenchmarkMultiSrcBlit
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/benchmark/MultiSrcBlit/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/benchmark/MultiSrcBlit
