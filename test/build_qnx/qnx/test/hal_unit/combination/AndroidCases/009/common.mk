...
define PINFO
PINFO DESCRIPTION="libgal2DAndroidCases009.so"
endef

NAME=gal2DAndroidCases009
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/AndroidCases/009/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/AndroidCases/009
