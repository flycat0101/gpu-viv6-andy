...
define PINFO
PINFO DESCRIPTION="libgal2DAndroidCases005.so"
endef

NAME=gal2DAndroidCases005
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/AndroidCases/005/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/AndroidCases/005
