...
define PINFO
PINFO DESCRIPTION="libgal2DAndroidCases002.so"
endef

NAME=gal2DAndroidCases002
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/AndroidCases/002/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/AndroidCases/002
