...
define PINFO
PINFO DESCRIPTION="libgal2DAndroidCases001.so"
endef

NAME=gal2DAndroidCases001
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/AndroidCases/001/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/AndroidCases/001
