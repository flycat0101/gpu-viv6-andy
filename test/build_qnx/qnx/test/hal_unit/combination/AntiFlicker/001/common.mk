...
define PINFO
PINFO DESCRIPTION="libgal2DAntiFlicker001.so"
endef

NAME=gal2DAntiFlicker001
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/AntiFlicker/001/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/AntiFlicker/001
