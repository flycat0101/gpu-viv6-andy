...
define PINFO
PINFO DESCRIPTION="libgal2DAntiFlicker003.so"
endef

NAME=gal2DAntiFlicker003
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/AntiFlicker/003/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/AntiFlicker/003
