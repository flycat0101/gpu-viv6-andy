...
define PINFO
PINFO DESCRIPTION="libgal2DAntiFlicker002.so"
endef

NAME=gal2DAntiFlicker002
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/AntiFlicker/002/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/AntiFlicker/002
