...
define PINFO
PINFO DESCRIPTION="libgal2DBlendFactors_001.so"
endef

NAME=gal2DBlendFactors_001
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/BlendFactors/001/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/BlendFactors/001
