...
define PINFO
PINFO DESCRIPTION="libgal2DBlendFactors_002.so"
endef

NAME=gal2DBlendFactors_002
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/BlendFactors/002/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/BlendFactors/002
