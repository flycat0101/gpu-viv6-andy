...
define PINFO
PINFO DESCRIPTION="libgal2DBlendFactors_003.so"
endef

NAME=gal2DBlendFactors_003
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/BlendFactors/003/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/BlendFactors/003
