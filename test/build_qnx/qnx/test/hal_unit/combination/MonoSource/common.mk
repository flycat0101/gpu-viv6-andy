...
define PINFO
PINFO DESCRIPTION="libgal2DMonoSource.so"
endef

NAME=gal2DMonoSource
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/MonoSource/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/MonoSource
