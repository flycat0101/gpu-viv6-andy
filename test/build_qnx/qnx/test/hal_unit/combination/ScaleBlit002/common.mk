...
define PINFO
PINFO DESCRIPTION="libgal2DScaleBlit002.so"
endef

NAME=gal2DScaleBlit002
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/ScaleBlit002/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/ScaleBlit002
