...
define PINFO
PINFO DESCRIPTION="libgal2DMaskedSource.so"
endef

NAME=gal2DMaskedSource
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/MaskedSource/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/MaskedSource
