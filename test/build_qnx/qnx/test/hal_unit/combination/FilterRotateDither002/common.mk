...
define PINFO
PINFO DESCRIPTION="libgal2DFilterRotateDither002.so"
endef

NAME=gal2DFilterRotateDither002
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/FilterRotateDither002/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/FilterRotateDither002
