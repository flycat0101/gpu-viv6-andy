...
define PINFO
PINFO DESCRIPTION="libgal2DMaskedBlit.so"
endef

NAME=gal2DMaskedBlit
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/MaskedBlit/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/MaskedBlit
