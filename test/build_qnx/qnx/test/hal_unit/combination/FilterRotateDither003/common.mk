...
define PINFO
PINFO DESCRIPTION="libgal2DFilterRotateDither003.so"
endef

NAME=gal2DFilterRotateDither003
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/FilterRotateDither003/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/FilterRotateDither003
