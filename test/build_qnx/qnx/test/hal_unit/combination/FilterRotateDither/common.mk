...
define PINFO
PINFO DESCRIPTION="libgal2DFilterRotateDither.so"
endef

NAME=gal2DFilterRotateDither
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/FilterRotateDither/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/FilterRotateDither
