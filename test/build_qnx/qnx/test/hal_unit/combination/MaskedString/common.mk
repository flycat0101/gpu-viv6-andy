...
define PINFO
PINFO DESCRIPTION="libgal2DMaskedString.so"
endef

NAME=gal2DMaskedString
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/MaskedString/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/MaskedString
