...
define PINFO
PINFO DESCRIPTION="libgal2DBlitFullRotate.so"
endef

NAME=gal2DBlitFullRotate
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/combination/BlitFullRotate/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/combination/BlitFullRotate
