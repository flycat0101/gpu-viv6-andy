...
define PINFO
PINFO DESCRIPTION="libgalUtil.so"
endef
...
SOURCE_OBJECTS += $(HAL2D_UNIT_TEST_DIR)/galUtil/galUtil.o
SOURCE_OBJECTS += $(HAL2D_UNIT_TEST_DIR)/galUtil/galUtilOS.o

EXTRA_SRCVPATH += $(HAL2D_UNIT_TEST_DIR)/galUtil
