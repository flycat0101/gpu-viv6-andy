...
define PINFO
PINFO DESCRIPTION="libgal2DMultiSourceBlit003.so"
endef

NAME=gal2DMultiSourceBlit003
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/blit/MultiSourceBlit/003/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/blit/MultiSourceBlit/003
