...
define PINFO
PINFO DESCRIPTION="libgal2DMultiSourceBlit002.so"
endef

NAME=gal2DMultiSourceBlit002
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/blit/MultiSourceBlit/002/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/blit/MultiSourceBlit/002
