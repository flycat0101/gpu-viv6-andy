...
define PINFO
PINFO DESCRIPTION="libgal2DMultiSourceBlit001.so"
endef

NAME=gal2DMultiSourceBlit001
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/blit/MultiSourceBlit/001/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/blit/MultiSourceBlit/001
