...
define PINFO
PINFO DESCRIPTION="libgal2DMultiSourceBlit012.so"
endef

NAME=gal2DMultiSourceBlit012
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/blit/MultiSourceBlit/012/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/blit/MultiSourceBlit/012
