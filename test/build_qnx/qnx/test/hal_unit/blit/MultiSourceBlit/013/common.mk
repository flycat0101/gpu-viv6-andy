...
define PINFO
PINFO DESCRIPTION="libgal2DMultiSourceBlit013.so"
endef

NAME=gal2DMultiSourceBlit013
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/blit/MultiSourceBlit/013/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/blit/MultiSourceBlit/013
