...
define PINFO
PINFO DESCRIPTION="libgal2DMultiSourceBlit010.so"
endef

NAME=gal2DMultiSourceBlit010
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/blit/MultiSourceBlit/010/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/blit/MultiSourceBlit/010
