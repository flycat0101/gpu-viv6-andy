...
define PINFO
PINFO DESCRIPTION="libgal2DMultiSourceBlit014.so"
endef

NAME=gal2DMultiSourceBlit014
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/blit/MultiSourceBlit/014/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/blit/MultiSourceBlit/014
