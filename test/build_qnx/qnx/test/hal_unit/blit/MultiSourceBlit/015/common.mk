...
define PINFO
PINFO DESCRIPTION="libgal2DMultiSourceBlit015.so"
endef

NAME=gal2DMultiSourceBlit015
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/blit/MultiSourceBlit/015/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/blit/MultiSourceBlit/015
