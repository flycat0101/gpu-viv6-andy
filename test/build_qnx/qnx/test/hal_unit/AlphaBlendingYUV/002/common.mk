...
define PINFO
PINFO DESCRIPTION="libgal2DAlphaBlendingYUV002.so"
endef

NAME=gal2DAlphaBlendingYUV002
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphaBlendingYUV/002/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphaBlendingYUV/002
