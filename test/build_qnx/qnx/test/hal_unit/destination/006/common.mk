...
define PINFO
PINFO DESCRIPTION="libgal2DDestination006.so"
endef

NAME=gal2DDestination006
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/destination/006/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/destination/006
