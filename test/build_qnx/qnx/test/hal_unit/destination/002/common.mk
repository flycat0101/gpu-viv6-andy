...
define PINFO
PINFO DESCRIPTION="libgal2DDestination002.so"
endef

NAME=gal2DDestination002
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/destination/002/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/destination/002
