...
define PINFO
PINFO DESCRIPTION="libgal2DDestination005.so"
endef

NAME=gal2DDestination005
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/destination/005/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/destination/005
