...
define PINFO
PINFO DESCRIPTION="libgal2DDestination004.so"
endef

NAME=gal2DDestination004
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/destination/004/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/destination/004
