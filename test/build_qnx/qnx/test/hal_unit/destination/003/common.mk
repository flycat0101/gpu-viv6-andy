...
define PINFO
PINFO DESCRIPTION="libgal2DDestination003.so"
endef

NAME=gal2DDestination003
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/destination/003/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/destination/003
