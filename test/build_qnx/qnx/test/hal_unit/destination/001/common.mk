...
define PINFO
PINFO DESCRIPTION="libgal2DDestination001.so"
endef

NAME=gal2DDestination001
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/destination/001/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/destination/001
