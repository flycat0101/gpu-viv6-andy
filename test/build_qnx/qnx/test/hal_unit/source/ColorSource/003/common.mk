...
define PINFO
PINFO DESCRIPTION="libgal2DColorSource003.so"
endef

NAME=gal2DColorSource003
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/source/ColorSource/003/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/source/ColorSource/003
