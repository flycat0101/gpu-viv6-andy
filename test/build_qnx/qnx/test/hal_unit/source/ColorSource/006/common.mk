...
define PINFO
PINFO DESCRIPTION="libgal2DColorSource006.so"
endef

NAME=gal2DColorSource006
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/source/ColorSource/006/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/source/ColorSource/006
