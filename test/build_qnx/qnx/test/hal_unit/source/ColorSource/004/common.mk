...
define PINFO
PINFO DESCRIPTION="libgal2DColorSource004.so"
endef

NAME=gal2DColorSource004
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/source/ColorSource/004/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/source/ColorSource/004
