...
define PINFO
PINFO DESCRIPTION="libgal2DColorSource005.so"
endef

NAME=gal2DColorSource005
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/source/ColorSource/005/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/source/ColorSource/005
