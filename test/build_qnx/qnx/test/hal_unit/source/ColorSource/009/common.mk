...
define PINFO
PINFO DESCRIPTION="libgal2DColorSource009.so"
endef

NAME=gal2DColorSource009
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/source/ColorSource/009/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/source/ColorSource/009
