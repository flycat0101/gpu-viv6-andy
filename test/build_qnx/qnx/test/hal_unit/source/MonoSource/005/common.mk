...
define PINFO
PINFO DESCRIPTION="libgal2DMonochromeSource005.so"
endef

NAME=gal2DMonochromeSource005
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/source/MonoSource/005/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/source/MonoSource/005
