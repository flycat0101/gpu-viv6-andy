...
define PINFO
PINFO DESCRIPTION="libgal2DSingleColorBrush002.so"
endef

NAME=gal2DSingleColorBrush002
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/brush/SingleColor/002/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/brush/SingleColor/002
