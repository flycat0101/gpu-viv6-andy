...
define PINFO
PINFO DESCRIPTION="libgal2DMonochromeBrush005.so"
endef

NAME=gal2DMonochromeBrush005
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/brush/Monochrome/005/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/brush/Monochrome/005
