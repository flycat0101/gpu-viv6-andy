...
define PINFO
PINFO DESCRIPTION="libgal2DColorBrush003.so"
endef

NAME=gal2DColorBrush003
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/brush/Color/003/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/brush/Color/003
