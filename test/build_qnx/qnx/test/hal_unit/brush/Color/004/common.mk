...
define PINFO
PINFO DESCRIPTION="libgal2DColorBrush004.so"
endef

NAME=gal2DColorBrush004
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/brush/Color/004/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/brush/Color/004
