...
define PINFO
PINFO DESCRIPTION="libgal2DColorBrush002.so"
endef

NAME=gal2DColorBrush002
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/brush/Color/002/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/brush/Color/002
