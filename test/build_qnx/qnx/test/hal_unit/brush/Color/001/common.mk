...
define PINFO
PINFO DESCRIPTION="libgal2DColorBrush001.so"
endef

NAME=gal2DColorBrush001
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/brush/Color/001/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/brush/Color/001
