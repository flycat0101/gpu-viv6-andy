...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit014.so"
endef

NAME=gal2DAlphablendFilterBlit014
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/014/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/014
