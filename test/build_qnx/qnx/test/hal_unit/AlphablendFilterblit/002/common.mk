...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit002.so"
endef

NAME=gal2DAlphablendFilterBlit002
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/002/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/002
