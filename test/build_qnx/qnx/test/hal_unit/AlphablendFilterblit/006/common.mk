...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit006.so"
endef

NAME=gal2DAlphablendFilterBlit006
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/006/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/006
