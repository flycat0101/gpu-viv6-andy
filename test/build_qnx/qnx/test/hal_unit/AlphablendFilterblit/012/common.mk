...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit012.so"
endef

NAME=gal2DAlphablendFilterBlit012
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/012/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/012
