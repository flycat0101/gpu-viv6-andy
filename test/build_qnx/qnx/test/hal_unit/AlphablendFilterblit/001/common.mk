...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit001.so"
endef

NAME=gal2DAlphablendFilterBlit001
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/001/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/001
