...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit015.so"
endef

NAME=gal2DAlphablendFilterBlit015
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/015/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/015
