...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit011.so"
endef

NAME=gal2DAlphablendFilterBlit011
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/011/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/011
