...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit005.so"
endef

NAME=gal2DAlphablendFilterBlit005
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/005/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/005
