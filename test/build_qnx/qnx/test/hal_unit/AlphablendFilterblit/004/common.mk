...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit004.so"
endef

NAME=gal2DAlphablendFilterBlit004
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/004/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/004
