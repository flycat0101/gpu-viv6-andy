...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit016.so"
endef

NAME=gal2DAlphablendFilterBlit016
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/016/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/016
