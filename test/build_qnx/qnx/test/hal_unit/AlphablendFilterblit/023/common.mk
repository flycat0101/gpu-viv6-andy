...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit023.so"
endef

NAME=gal2DAlphablendFilterBlit023
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/023/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/023
