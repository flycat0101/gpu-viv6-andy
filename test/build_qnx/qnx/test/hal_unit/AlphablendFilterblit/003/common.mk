...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit003.so"
endef

NAME=gal2DAlphablendFilterBlit003
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/003/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/003
