...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit021.so"
endef

NAME=gal2DAlphablendFilterBlit021
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/021/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/021
