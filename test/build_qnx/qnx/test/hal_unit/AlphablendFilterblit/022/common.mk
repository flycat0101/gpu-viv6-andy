...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit022.so"
endef

NAME=gal2DAlphablendFilterBlit022
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/022/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/022
