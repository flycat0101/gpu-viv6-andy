...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit018.so"
endef

NAME=gal2DAlphablendFilterBlit018
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/018/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/018
