...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit013.so"
endef

NAME=gal2DAlphablendFilterBlit013
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/013/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/013
