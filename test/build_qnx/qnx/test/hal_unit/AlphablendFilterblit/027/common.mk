...
define PINFO
PINFO DESCRIPTION="libgal2DAlphablendFilterBlit027.so"
endef

NAME=gal2DAlphablendFilterBlit027
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/AlphablendFilterblit/027/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/AlphablendFilterblit/027
