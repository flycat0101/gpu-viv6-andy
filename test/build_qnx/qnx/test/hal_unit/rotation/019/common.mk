...
define PINFO
PINFO DESCRIPTION="libgal2DRotation019.so"
endef

NAME=gal2DRotation019
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/rotation/019/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/rotation/019
