...
define PINFO
PINFO DESCRIPTION="libgal2DRotation009.so"
endef

NAME=gal2DRotation009
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/rotation/009/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/rotation/009
