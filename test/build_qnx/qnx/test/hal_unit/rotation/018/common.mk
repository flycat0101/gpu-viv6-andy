...
define PINFO
PINFO DESCRIPTION="libgal2DRotation018.so"
endef

NAME=gal2DRotation018
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/rotation/018/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/rotation/018
