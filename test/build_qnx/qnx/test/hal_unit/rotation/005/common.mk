...
define PINFO
PINFO DESCRIPTION="libgal2DRotation005.so"
endef

NAME=gal2DRotation005
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/rotation/005/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/rotation/005
