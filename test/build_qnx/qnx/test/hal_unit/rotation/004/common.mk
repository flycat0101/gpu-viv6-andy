...
define PINFO
PINFO DESCRIPTION="libgal2DRotation004.so"
endef

NAME=gal2DRotation004
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/rotation/004/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/rotation/004
