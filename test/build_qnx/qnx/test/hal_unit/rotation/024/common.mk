...
define PINFO
PINFO DESCRIPTION="libgal2DRotation024.so"
endef

NAME=gal2DRotation024
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/rotation/024/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/rotation/024
