...
define PINFO
PINFO DESCRIPTION="libgal2DRotation006.so"
endef

NAME=gal2DRotation006
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/rotation/006/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/rotation/006
