...
define PINFO
PINFO DESCRIPTION="libgal2DRotation025.so"
endef

NAME=gal2DRotation025
...
SOURCE_OBJECTS += $(wildcard $(MY_SRC)/gal2D/rotation/025/*.c)
EXTRA_SRCVPATH += $(MY_SRC)/gal2D/rotation/025
