...
SOURCE_OBJECTS += $(ES20_TEST_DIR)/shareContext/shareContext.o

EXTRA_SRCVPATH += $(ES20_TEST_DIR)/shareContext
...
LDOPTS += -lVDK -lGLESv2 -lEGL

include $(qnx_build_dir)/math.mk

INSTALLDIR=$(firstword $(INSTALLDIR_$(OS)) samples/es20/shareContext)
