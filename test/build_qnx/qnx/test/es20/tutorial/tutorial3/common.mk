...
define PINFO
PINFO DESCRIPTION="es20 tutorials"
endef
...
SOURCE_OBJECTS += $(VDK_TEST_DIR)/es20/tutorial3/tutorial3.o
SOURCE_OBJECTS += $(VDK_TEST_DIR)/es20/tutorial3/common.o
SOURCE_OBJECTS += $(VDK_TEST_DIR)/es20/tutorial3/commonMath.o

EXTRA_SRCVPATH += $(VDK_TEST_DIR)/es20/tutorial3
...
INSTALLDIR=$(firstword $(INSTALLDIR_$(OS)) samples/es20/tutorial)
