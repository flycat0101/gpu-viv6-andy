...
POST_BUILD+= && $(CP_HOST) $(test_root)/test/ovx/vx_tutorial4/bmp_list.txt $(target_dir)/
POST_BUILD+= && $(CP_HOST) $(test_root)/test/ovx/vx_tutorial4/Scene_500Lux__2xInt_NoSh_1920x1080_1frame_Yonly.bayer $(target_dir)/
