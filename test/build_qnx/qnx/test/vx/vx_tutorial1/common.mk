...
define PINFO
PINFO DESCRIPTION="vx tutorial 1"
endef
...
SOURCE_OBJECTS += $(test_root)/test/ovx/vx_tutorial1/vx_tutorial1.o

EXTRA_SRCVPATH += $(test_root)/test/ovx/vx_tutorial1
...
INSTALLDIR=$(firstword $(INSTALLDIR_$(OS)) samples/ovx/vx_tutorial1/)

target_dir=$(INSTALL_ROOT_$(OS))/$(CPU)$(filter le be, $(VARIANT_LIST))$(CPUVARDIR_SUFFIX)/$(INSTALLDIR)

POST_BUILD+= && $(CP_HOST) $(test_root)/test/ovx/vx_tutorial1/*.bmp $(target_dir)/
