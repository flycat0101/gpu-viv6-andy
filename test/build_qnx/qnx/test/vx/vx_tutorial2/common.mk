...
define PINFO
PINFO DESCRIPTION="vx tutorial 2"
endef
...
SOURCE_OBJECTS += $(test_root)/test/ovx/vx_tutorial2/vx_tutorial2.o

EXTRA_SRCVPATH += $(test_root)/test/ovx/vx_tutorial2
...
LDOPTS += -lLLVM_viv -lOpenVX -lOpenVXU -lCLC

include $(qnx_build_dir)/math.mk

INSTALLDIR=$(firstword $(INSTALLDIR_$(OS)) samples/ovx/vx_tutorial2/)

target_dir=$(INSTALL_ROOT_$(OS))/$(CPU)$(filter le be, $(VARIANT_LIST))$(CPUVARDIR_SUFFIX)/$(INSTALLDIR)

POST_BUILD+= && $(CP_HOST) $(test_root)/test/ovx/vx_tutorial2/*.bmp $(target_dir)/
